...
#define ckfn_sys_get_stride() \
    (func_entry(sys_export_func, HI_ID_SYS)->pfn_sys_get_stride != HI_NULL)
...
#define ckfn_sys_get_chip_version() \
    (func_entry(sys_export_func, HI_ID_SYS)->pfn_sys_get_chip_version != HI_NULL)
...
#define ckfn_sys_get_full_chip_id() \
    (func_entry(sys_export_func, HI_ID_SYS)->pfn_sys_get_full_chip_id != HI_NULL)
...
#define ckfn_sys_get_gps_info() \
    (func_entry(sys_export_func, HI_ID_SYS)->pfn_sys_get_gps_info != HI_NULL)
...
#define ckfn_sys_get_now_string() \
    (func_entry(sys_export_func, HI_ID_SYS)->pfn_sys_get_now_string != HI_NULL)
...
#define ckfn_sys_get_vb_cfg() \
    (func_entry(sys_export_func, HI_ID_SYS)->pfn_sys_get_vb_cfg != HI_NULL)
...
#define ckfn_sys_get_vdec_buffer_cfg() \
    (func_entry(sys_export_func, HI_ID_SYS)->pfn_sys_get_vdec_buffer_cfg != HI_NULL)
...
#define ckfn_sys_get_cmp_seg_cfg() \
    (func_entry(sys_export_func, HI_ID_SYS)->pfn_sys_get_cmp_seg_cfg != HI_NULL)
...
#define ckfn_sys_get_cmp_bayer_cfg() \
    (func_entry(sys_export_func, HI_ID_SYS)->pfn_sys_get_cmp_bayer_cfg != HI_NULL)
...
#define ckfn_sys_get_cmp_tile16x8_cfg() \
    (func_entry(sys_export_func, HI_ID_SYS)->pfn_sys_get_cmp_tile16x8_cfg != HI_NULL)
...
#define ckfn_sys_get_cmp_tde_cfg() \
    (func_entry(sys_export_func, HI_ID_SYS)->pfn_sys_get_cmp_tde_cfg != HI_NULL)
