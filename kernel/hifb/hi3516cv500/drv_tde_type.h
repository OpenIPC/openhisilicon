...
typedef hi_void (*tde_func_cb)(hi_void *, hi_void *);
...
typedef enum {
    HI_TDE_COLOR_FMT_RGB444 = 0, /*
                                  * <For the RGB444 format,
                                  * red occupies four bits, green occupies four bits,
                                  * and blue occupies four bits. Other formats may be deduced by
                                  * analogy.
                                  */
...
typedef struct {
    ...
    hi_tde_surface *fg_surface;
    hi_tde_surface *dst_surface;
    hi_tde_surface *mask_surface;
    hi_tde_rect *bg_rect;
    hi_tde_rect *fg_rect;
    hi_tde_rect *mask_rect;
    hi_tde_rect *dst_rect;
} hi_tde_triple_src;
...
typedef enum {
    ...
    HI_TDE_COLOR_KEY_MODE_FOREGROUND, /*
                                       ...
                                       * and perform this operation after the CLUT for
                                       * color correction.
                                       */
