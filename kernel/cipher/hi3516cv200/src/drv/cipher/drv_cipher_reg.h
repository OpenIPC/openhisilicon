...
#define  REG_BASE_PHY_ADDR_RNG 		         (0x20280000)
#define  REG_BASE_PHY_ADDR_EFUSE 		     (0x20100000)
#endif
...
#define  CIPHER_HASH_REG_BASE_ADDR              (HI_U32)(HI_U32)IO_ADDRESS(REG_BASE_PHY_ADDR_SHA)
...
#define CIPHER_RSA_REG_BASE_RSA		            (HI_U32)IO_ADDRESS(REG_BASE_PHY_ADDR_RSA)
...
#define  REG_RNG_BASE_ADDR 					(HI_U32)IO_ADDRESS(REG_BASE_PHY_ADDR_RNG)
