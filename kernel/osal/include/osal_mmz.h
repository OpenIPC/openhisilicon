...
extern mmz_mmz_t *mmz_mmz_create(const char *name, unsigned long gfp, unsigned long phys_start,
                                 unsigned long nbytes);
extern mmz_mmz_t *mmz_mmz_create_v2(const char *name, unsigned long gfp, unsigned long phys_start,
...
extern mmz_mmb_t *mmz_mmb_alloc_v2(const char *name, unsigned long size, unsigned long align,
...
extern mmz_mmb_t *mmz_mmb_getby_phys_2(unsigned long addr, unsigned long *Outoffset);
extern mmz_mmb_t *mmz_mmb_getby_kvirt(void *virt);
extern unsigned long usr_virt_to_phys(unsigned long virt);

extern int mmz_map_mmz_check_phys(unsigned long addr_start, unsigned long addr_len);
...
extern mmz_mmb_t *mmz_mmb_alloc_in(const char *name, unsigned long size, unsigned long align,
                                   mmz_mmz_t *_user_mmz);
extern mmz_mmb_t *mmz_mmb_alloc_in_v2(const char *name, unsigned long size, unsigned long align,
                                      mmz_mmz_t *_user_mmz, unsigned int order);
