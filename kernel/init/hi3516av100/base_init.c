/*
 * Init wrapper for hi3516a_base blob module (hi3516av100 / V2A family).
 */
#include <linux/module.h>
#include <linux/kernel.h>
#include <linux/sysctl.h>

extern int _av100_hi3516a_base_init(void);
extern void _av100_hi3516a_base_exit(void);
