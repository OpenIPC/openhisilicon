...
extern int _av100_hi3516a_vou_init(void);
extern void _av100_hi3516a_vou_exit(void);

#define DECLARE_BLOB_FUNC(sym) extern int sym(void)

DECLARE_BLOB_FUNC(VOU_GraphicsCheckDDRDectectZone);	EXPORT_SYMBOL(VOU_GraphicsCheckDDRDectectZone);
DECLARE_BLOB_FUNC(VOU_GraphicsClearDDRDectectZone);	EXPORT_SYMBOL(VOU_GraphicsClearDDRDectectZone);
...
DECLARE_BLOB_FUNC(VOU_GraphicsGetDDRZoneCfg);		EXPORT_SYMBOL(VOU_GraphicsGetDDRZoneCfg);
...
DECLARE_BLOB_FUNC(VOU_GraphicsGetIntfType);		EXPORT_SYMBOL(VOU_GraphicsGetIntfType);
...
DECLARE_BLOB_FUNC(VOU_GraphicsGetMDDRStatus);		EXPORT_SYMBOL(VOU_GraphicsGetMDDRStatus);
DECLARE_BLOB_FUNC(VOU_GraphicsOpenLayer);		EXPORT_SYMBOL(VOU_GraphicsOpenLayer);
DECLARE_BLOB_FUNC(VOU_GraphicsSetCallback);		EXPORT_SYMBOL(VOU_GraphicsSetCallback);
...
DECLARE_BLOB_FUNC(VOU_GraphicsSetMDDRDetectZone);	EXPORT_SYMBOL(VOU_GraphicsSetMDDRDetectZone);
DECLARE_BLOB_FUNC(VOU_GraphicsSetRegUp);		EXPORT_SYMBOL(VOU_GraphicsSetRegUp);

static int __init vou_mod_init(void) { return _av100_hi3516a_vou_init(); }
static void __exit vou_mod_exit(void) { _av100_hi3516a_vou_exit(); }
