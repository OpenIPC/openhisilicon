/*
 * Init wrapper for hi3516a_tde blob module (hi3516av100 / V2A family).
 */
#include <linux/module.h>
#include <linux/kernel.h>

extern int _av100_hi3516a_tde_init(void);
extern void _av100_hi3516a_tde_exit(void);
...
{
	return _av100_hi3516a_tde_init();
}
static void __exit tde_mod_exit(void)
{
	_av100_hi3516a_tde_exit();
}
