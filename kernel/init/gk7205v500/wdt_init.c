...
MODULE_PARM_DESC(default_margin, "Watchdog default_margin in seconds. (0<default_margin<80, default=" __MODULE_STRING(DOG_TIMER_MARGIN) ")");
...
int __init wdt_driver_init(void)
{
    return osal_platform_driver_register(&wdg_driver);
}
