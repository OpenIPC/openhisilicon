...
extern int _cv200_hi3518e_vou_init(void);
extern void _cv200_hi3518e_vou_exit(void);
...
static int __init vou_mod_init(void)
{
	return _cv200_hi3518e_vou_init();
}

static void __exit vou_mod_exit(void)
{
	_cv200_hi3518e_vou_exit();
}
