...
extern GK_U64 CMPI_MmzMalloc(GK_CHAR *pMmzName, const GK_CHAR *pBufName, GK_UL ulSize);
...
extern GK_S32 CMPI_MmzMallocNocache(GK_CHAR *cpMmzName, const GK_CHAR *pBufName,
                                    GK_U64 *pu64PhyAddr, GK_VOID **ppVirAddr, GK_UL ulLen);
...
static inline GK_BOOL read_user_linear_space_valid(GK_U8 *pu8AddrStart, GK_U32 u32Len)
{
    GK_U8 u8Check;
...
static inline GK_BOOL write_user_linear_space_valid(GK_U8 *pu8AddrStart, GK_U32 u32Len)
{
    GK_U8 u8Check = 0;
    GK_U8 *pu8AddrEnd = GK_NULL;
