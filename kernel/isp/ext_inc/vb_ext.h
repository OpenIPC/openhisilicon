...
*****************************************************************************/
extern GK_S32 VB_CreatePool(GK_U32 *pu32PoolId, GK_U32 u32BlkCnt,
			    GK_U64 u64BlkSize, GK_CHAR *pcMmzName,
...
/*****************************************************************************
 ...
 Return Value : GK_S32         : 0 -- success; !0 : failure
*****************************************************************************/
extern GK_S32 VB_CreatePoolExt(GK_U32 *pu32PoolId, GK_U32 u32BlkCnt,
			       VB_CREATE_EX_INFO_S *pstVbRegInfo);
...
*****************************************************************************/
extern GK_S32 VB_AddBlkToPool(GK_U32 u32PoolId, GK_U64 u64PhysAddr,
			      GK_U64 u64Size, GK_U32 u32Uid);
...
/*****************************************************************************
 ...
 Return Value : GK_S32
                ...
                failure : Not 0
*****************************************************************************/
extern GK_S32 VB_GetPoolId(GK_U64 u64BlkSize, GK_U32 *pu32PoolId,
			   GK_CHAR *pcMmzName, GK_S32 s32Owner);
...
/*****************************************************************************
 ...
 Return Value : VB_BLKHANDLE
                ...
                failure : VB_INVALID_HANDLE
*****************************************************************************/
extern VB_BLKHANDLE VB_GetBlkBySize(GK_U64 u64BlkSize, GK_U32 u32Uid,
				    GK_CHAR *pcMmzName);
...
/*****************************************************************************
 ...
 Return Value : VB_BLKHANDLE
                ...
                failure : VB_INVALID_HANDLE
*****************************************************************************/
extern VB_BLKHANDLE VB_GetBlkBySizeAndModule(GK_U64 u64BlkSize, GK_U32 u32Uid,
					     GK_CHAR *pcMmzName);
...
/*****************************************************************************
 ...
 Return Value : VB_BLKHANDLE
                ...
                failure : VB_INVALID_HANDLE
*****************************************************************************/
extern VB_BLKHANDLE VB_GetBlkBySizeAndPoolId(GK_U32 u32PoolId,
					     GK_U64 u64BlkSize, GK_U32 u32Uid);
...
/*****************************************************************************
 ...
 Return Value : GK_U32
******************************************************************************/
extern GK_S32 VB_InquirePoolUserCnt(GK_U32 u32PoolId, GK_U32 u32Uid,
				    GK_U32 *pu32Cnt);
...
*****************************************************************************/
extern GK_VOID VB_CopySupplement(VIDEO_FRAME_S *pstDstVFrame,
				 const VIDEO_FRAME_S *pstSrcVFrame);

typedef struct VB_EXPORT_FUNC_S {
	GK_S32(*pfnVB_CreatePool)
	(GK_U32 *pu32PoolId, GK_U32 u32BlkCnt, GK_U64 u64BlkSize,
	...
	VB_BLKHANDLE(*pfnVB_GetBlkBySize)
	(GK_U64 u64BlkSize, GK_U32 u32Uid, GK_CHAR *pcMmzName);
	VB_BLKHANDLE(*pfnVB_GetBlkBySizeAndModule)
	(GK_U64 u64BlkSize, GK_U32 u32Uid, GK_CHAR *pcMmzName);
	VB_BLKHANDLE(*pfnVB_GetBlkBySizeAndPoolId)
	(GK_U32 u32PoolId, GK_U64 u64BlkSize, GK_U32 u32Uid);
	GK_S32(*pfnVB_GetPoolId)
	(GK_U64 u64BlkSize, GK_U32 *pu32PoolId, GK_CHAR *pcMmzName,
	 GK_S32 s32Owner);
	...
	GK_S32(*pfnVB_UserAdd)
	(GK_U32 u32PoolId, GK_U64 u64PhyAddr, GK_U32 u32Uid);
	GK_S32(*pfnVB_UserSub)
	(GK_U32 u32PoolId, GK_U64 u64PhyAddr, GK_U32 u32Uid);
	...
	GK_S32(*pfnVB_InquirePool)
	(GK_U32 u32PoolId, VB_POOL_STATUS_S *pstPoolStatus);
	GK_S32(*pfnVB_InquirePoolUserCnt)
	(GK_U32 u32PoolId, GK_U32 u32Uid, GK_U32 *pu32Cnt);
	VIDEO_SUPPLEMENT_S *(*pfnVB_Handle2Supplement)(VB_BLKHANDLE Handle);
	GK_BOOL (*pfnVB_IsSupplementSupport)(GK_U32 u32Mask);
	GK_VOID(*pfnVB_CopySupplement)
	(VIDEO_FRAME_S *pstDstVFrame, const VIDEO_FRAME_S *pstSrcVFrame);
} VB_EXPORT_FUNC_S;

#define CKFN_VB_CreatePool() \
	(FUNC_ENTRY(VB_EXPORT_FUNC_S, MOD_ID_VB)->pfnVB_CreatePool != NULL)
#define CALL_VB_CreatePool(pu32PoolId, u32BlkCnt, u64BlkSize, pcMmzName, \
			   pBufName, enVbRemapMode)                      \
	FUNC_ENTRY(VB_EXPORT_FUNC_S, MOD_ID_VB)                          \
		->pfnVB_CreatePool(pu32PoolId, u32BlkCnt, u64BlkSize,    \
...
#define CALL_VB_GetBlkByPoolId(u32PoolId, u32Uid) \
	FUNC_ENTRY(VB_EXPORT_FUNC_S, MOD_ID_VB)   \
		->pfnVB_GetBlkByPoolId(u32PoolId, u32Uid)
...
#define CALL_VB_GetBlkBySize(u64BlkSize, u32Uid, pcMmzName) \
	FUNC_ENTRY(VB_EXPORT_FUNC_S, MOD_ID_VB)             \
		->pfnVB_GetBlkBySize(u64BlkSize, u32Uid, pcMmzName)

#define CKFN_VB_GetBlkBySizeAndModule()          \
	(FUNC_ENTRY(VB_EXPORT_FUNC_S, MOD_ID_VB) \
		 ->pfnVB_GetBlkBySizeAndModule != NULL)
#define CALL_VB_GetBlkBySizeAndModule(u64BlkSize, u32Uid, pcMmzName) \
	FUNC_ENTRY(VB_EXPORT_FUNC_S, MOD_ID_VB)                      \
		->pfnVB_GetBlkBySizeAndModule(u64BlkSize, u32Uid, pcMmzName)

#define CKFN_VB_GetBlkBySizeAndPoolId()          \
	(FUNC_ENTRY(VB_EXPORT_FUNC_S, MOD_ID_VB) \
		 ->pfnVB_GetBlkBySizeAndPoolId != NULL)
#define CALL_VB_GetBlkBySizeAndPoolId(u32PoolId, u64BlkSize, u32Uid) \
	FUNC_ENTRY(VB_EXPORT_FUNC_S, MOD_ID_VB)                      \
		->pfnVB_GetBlkBySizeAndPoolId(u32PoolId, u64BlkSize, u32Uid)
...
#define CALL_VB_GetPoolId(u64BlkSize, pu32PoolId, pcMmzName, s32Owner) \
	FUNC_ENTRY(VB_EXPORT_FUNC_S, MOD_ID_VB)                        \
		->pfnVB_GetPoolId(u64BlkSize, pu32PoolId, pcMmzName, s32Owner)
...
#define CALL_VB_PutBlk(u32PoolId, u64PhyAddr)   \
	FUNC_ENTRY(VB_EXPORT_FUNC_S, MOD_ID_VB) \
		->pfnVB_PutBlk(u32PoolId, u64PhyAddr)
...
#define CALL_VB_UserAdd(u32PoolId, u64PhyAddr, u32Uid) \
	FUNC_ENTRY(VB_EXPORT_FUNC_S, MOD_ID_VB)        \
		->pfnVB_UserAdd(u32PoolId, u64PhyAddr, u32Uid)
...
#define CALL_VB_UserSub(u32PoolId, u64PhyAddr, u32Uid) \
	FUNC_ENTRY(VB_EXPORT_FUNC_S, MOD_ID_VB)        \
		->pfnVB_UserSub(u32PoolId, u64PhyAddr, u32Uid)
...
#define CKFN_VB_InquireOneUserCnt()                                          \
	(FUNC_ENTRY(VB_EXPORT_FUNC_S, MOD_ID_VB)->pfnVB_InquireOneUserCnt != \
	 NULL)
#define CALL_VB_InquireOneUserCnt(Handle, u32Uid) \
	FUNC_ENTRY(VB_EXPORT_FUNC_S, MOD_ID_VB)   \
		->pfnVB_InquireOneUserCnt(Handle, u32Uid)

#define CKFN_VB_InquireTotalUserCnt()                                          \
	(FUNC_ENTRY(VB_EXPORT_FUNC_S, MOD_ID_VB)->pfnVB_InquireTotalUserCnt != \
	 NULL)
#define CALL_VB_InquireTotalUserCnt(Handle)     \
	FUNC_ENTRY(VB_EXPORT_FUNC_S, MOD_ID_VB) \
		->pfnVB_InquireTotalUserCnt(Handle)
...
#define CALL_VB_InquireBlkCnt(u32Uid, bIsCommPool) \
	FUNC_ENTRY(VB_EXPORT_FUNC_S, MOD_ID_VB)    \
		->pfnVB_InquireBlkCnt(u32Uid, bIsCommPool)
...
#define CALL_VB_IsBlkValid(u32PoolId, u64PhyAddr) \
	FUNC_ENTRY(VB_EXPORT_FUNC_S, MOD_ID_VB)   \
		->pfnVB_IsBlkValid(u32PoolId, u64PhyAddr)
...
#define CALL_VB_InquirePool(u32PoolId, pstPoolStatus) \
	FUNC_ENTRY(VB_EXPORT_FUNC_S, MOD_ID_VB)       \
		->pfnVB_InquirePool(u32PoolId, pstPoolStatus)

#define CKFN_VB_InquirePoolUserCnt()                                          \
	(FUNC_ENTRY(VB_EXPORT_FUNC_S, MOD_ID_VB)->pfnVB_InquirePoolUserCnt != \
	 NULL)
#define CALL_VB_InquirePoolUserCnt(u32PoolId, u32Uid, pu32Cnt) \
	FUNC_ENTRY(VB_EXPORT_FUNC_S, MOD_ID_VB)                \
		->pfnVB_InquirePoolUserCnt(u32PoolId, u32Uid, pu32Cnt)

#define CKFN_VB_Handle2Supplement()                                          \
	(FUNC_ENTRY(VB_EXPORT_FUNC_S, MOD_ID_VB)->pfnVB_Handle2Supplement != \
	 NULL)
...
#define CKFN_VB_IsSupplementSupport()                                          \
	(FUNC_ENTRY(VB_EXPORT_FUNC_S, MOD_ID_VB)->pfnVB_IsSupplementSupport != \
	 NULL)
#define CALL_VB_IsSupplementSupport(u32Mask)    \
	FUNC_ENTRY(VB_EXPORT_FUNC_S, MOD_ID_VB) \
		->pfnVB_IsSupplementSupport(u32Mask)
...
#define CALL_VB_CopySupplement(pstDstVFrame, pstSrcVFrame) \
	FUNC_ENTRY(VB_EXPORT_FUNC_S, MOD_ID_VB)            \
		->pfnVB_CopySupplement(pstDstVFrame, pstSrcVFrame)
#endif /* __VB_EXT_H__ */
