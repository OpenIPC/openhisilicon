...
typedef struct BIND_SENDER_INFO_S {
    ...
    GK_U32 u32MaxDevCnt;
    GK_U32 u32MaxChnCnt;
    GK_S32 (*pGiveBindCallBack)(GK_S32 s32DevId, GK_S32 s32ChnId, MPP_BIND_DEST_S *pstBindSend);
} BIND_SENDER_INFO_S;
...
typedef struct BIND_RECEIVER_INFO_S {
    ...
    GK_U32 u32MaxDevCnt;
    GK_U32 u32MaxChnCnt;
    GK_S32 (*pCallBack)(GK_S32 s32DevId, GK_S32 s32ChnId, GK_BOOL bBlock, MPP_DATA_TYPE_E enDataType, GK_VOID *pvData);
    GK_S32 (*pResetCallBack)(GK_S32 s32DevId, GK_S32 s32ChnId, GK_VOID *pvData);
...
typedef struct SYS_EXPORT_FUNC_S {
    ...
    (MOD_ID_E enModId, GK_S32 s32DevId,
     GK_S32 s32ChnId, GK_VOID *pPrivate);

    GK_S32 (*pfnGetBindbySrc)(MPP_CHN_S *pstSrcChn, MPP_BIND_DEST_S *pstBindSrc);
    ...
    GK_S32 (*pfnGetMemDdr)(MPP_CHN_S *pstChn, MPP_SYS_DDR_NAME_S *pstMemDdr);
    ...
    (MOD_ID_E enModId, GK_VOID *pstScaleCoefOpt, GK_VOID *pvRate, GK_VOID *pvCfg);
    ...
    GK_VOID (*pfnSYSGetCmpCfg)(GK_VOID *pstVFrame, GK_VOID *pstYCmpCfg, GK_VOID *pstCCmpCfg, void *pstCmpModeExParam);

    GK_VOID (*pfnSYSGetVBCfg)(GK_VOID *pstVBBaseInfo, GK_VOID *pstVBCalConfig);
    GK_VOID (*pfnSYSGetVdecBufferCfg)(PAYLOAD_TYPE_E enType, GK_VOID *pstVBBaseInfo, GK_VOID *pstVBCalConfig);

    GK_VOID (*pfnSYSGetCmpSegCfg)(GK_VOID *pstSysCmpIn, GK_VOID *pstYCmpCfg, GK_VOID *pstCCmpCfg);
    GK_VOID (*pfnSYSGetCmpBayerCfg)(GK_VOID *pstSysCmpIn, GK_VOID *pstBayerCmpCfg, GK_VOID *pstBayerDcmpCfg);
    GK_VOID (*pfnSYSGetCmp3DNRCfg)(GK_VOID *pstSysCmpIn, GK_VOID *pstYCmpCfg, GK_VOID *pstCCmpCfg);
    GK_VOID (*pfnSYSGetCmpTILE16x8Cfg)(GK_VOID *pstSysCmpIn, GK_VOID *pstCmpOut);
    GK_VOID (*pfnSYSGetCmpMUV1Cfg)(GK_VOID *pstSysCmpIn, GK_VOID *pstCmpOut);
    GK_VOID (*pfnSYSGetDcmpMUV1Cfg)(GK_VOID *pstSysCmpIn, GK_VOID *pstCmpOut);
