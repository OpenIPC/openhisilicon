...
#define VREG_DRV_RELEASE_ALL \
	_IOW(IOC_TYPE_ISP, IOC_NR_VREG_RELEASE_ALL, DRV_VREG_ARGS_S)
#define VREG_DRV_GETADDR \
	_IOWR(IOC_TYPE_ISP, IOC_NR_VREG_GETADDR, DRV_VREG_ARGS_S)
