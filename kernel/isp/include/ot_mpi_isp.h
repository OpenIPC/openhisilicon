...
GK_S32 MPI_ISP_GetAEStitchStatistics(VI_PIPE ViPipe,
...
GK_S32 MPI_ISP_GetMeshShadingGainLutAttr(
...
GK_S32
MPI_ISP_GetRadialShadingAttr(VI_PIPE ViPipe,
...
GK_S32
MPI_ISP_SetIspEdgeMarkAttr(VI_PIPE ViPipe,
...
GK_S32 MPI_ISP_GetCSCAttr(VI_PIPE ViPipe, ISP_CSC_ATTR_S *pstCSCFAttr);
...
GK_S32 MPI_ISP_IrAutoRunOnce(VI_PIPE ViPipe, ISP_IR_AUTO_ATTR_S *pstIrAttr);
