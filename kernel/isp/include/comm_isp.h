...
typedef struct ISP_PIPE_DIFF_ATTR_S {
	GK_S32 as32Offset
		[ISP_BAYER_CHN_NUM]; /* RW;Range:[-4095,4095];Format:12.0; Black level differences between the offset value */
	GK_U32 au32Gain
		[ISP_BAYER_CHN_NUM]; /* RW;Range:[0x80,0x400];Format:4.8; The gain difference ratio */
	GK_U16 au16ColorMatrix
		[CCM_MATRIX_SIZE]; /* RW;Range:[0x0,0xFFFF];Format:8.8; Color correction matrix variance ratio */
...
typedef struct ISP_PUB_ATTR_S {
	...
	ISP_BAYER_FORMAT_E
	enBayer; /* RW; Range:[0,3] ;Format:2.0;the format of the input Bayer image */
...
typedef struct ISP_FUSION_ATTR_S {
	GK_U16 au16FusionThr
		[4]; /* RW;Range:[0x0,0x3FFF];Format:14.0;The threshold of the 4 frame */
} ISP_FUSION_ATTR_S;

typedef struct ISP_WDR_BNR_ATTR_S {
	ISP_BNR_MODE_E
	enBnrMode; /* RW;Range:[0x0,0x1];Format:1.0; GK_TRUE:enable the bnr of wdr;GK_FALSE:disable the bnr of wdr */
	...
	GK_U8 au8NoiseFloor
		[NoiseSet_EleNum]; /* RW;Range:[0x0,0xFF];Format:8.0,Only used for GK7608V200/GK7606V100   */
	...
	GK_U8 au8GsigmaGain
		[3]; /* RW;Range:[0x0,0xFF];Format:8.0,Only used for GK7608V200/GK7606V100  */
	GK_U8 au8RBsigmaGain
		[3]; /* RW;Range:[0x0,0xFF];Format:8.0,Only used for GK7608V200/GK7606V100  */
} ISP_WDR_BNR_ATTR_S;
...
typedef struct ISP_WDR_FS_ATTR_S {
	...
	ISP_WDR_BNR_ATTR_S
	stBnr; /* Not support for  V100/ V200/ V300/GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
	ISP_FUSION_ATTR_S stFusion;
	ISP_WDR_WBGAIN_POSITION_E
	enWDRWbgainPosition; /* RW; Range: [0x0, 0x1]; WDR Gain with or without WB Gain. Only used for GK7608V200 */
} ISP_WDR_FS_ATTR_S;
...
typedef struct ISP_DRC_ATTR_S {
	GK_BOOL bEnable;
	ISP_DRC_CURVE_SELECT_E
	enCurveSelect; /* RW; Range:[0x0, 0x2]; Select tone mapping curve type */
	...
	GK_U16 au16ColorCorrectionLut
		[ISP_DRC_CC_NODE_NUM]; /* RW; Range:[0x0, 0x400]; Format:4.12; LUT of color correction coefficients */
	GK_U16 au16ToneMappingValue
		[ISP_DRC_TM_NODE_NUM]; /* RW; Range:[0x0, 0xffff]; Format:16.0; LUT of user-defined curve */
	...
	ISP_DRC_CUBIC_POINT_ATTR_S astCubicPoint
		[ISP_DRC_CUBIC_POINT_NUM]; /* Only used for GK7608V200 */
...
typedef struct ISP_LDCI_AUTO_ATTR_S {
	...
	GK_U16 au16BlcCtrl
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW;Range: [0x0, 0x1FF];Format:9.0;auto mode, Restrain dark region */
...
typedef struct ISP_CA_LUT_S {
	GK_U32 au32YRatioLut
		[ISP_CA_YRATIO_LUT_LENGTH]; /* RW;Range:[0,2047];Format:1.11; */
	GK_S32 as32ISORatio
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW;Range:[0,2047];Format:1.10; */
} ISP_CA_LUT_S;

typedef struct ISP_CP_LUT_S {
	GK_U8 au8CPLutY
		[ISP_CA_YRATIO_LUT_LENGTH]; /* RW;Range:[0,255];Format:8.0;Not support for  V100/ V200/ V300/GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
	GK_U8 au8CPLutU
		[ISP_CA_YRATIO_LUT_LENGTH]; /* RW;Range:[0,255];Format:8.0;Not support for  V100/ V200/ V300/GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
	GK_U8 au8CPLutV
		[ISP_CA_YRATIO_LUT_LENGTH]; /* RW;Range:[0,255];Format:8.0;Not support for  V100/ V200/ V300/GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
...
typedef struct ISP_CA_ATTR_S {
	GK_BOOL bEnable; /* RW;Range:[0x0,0x1];Format:1.0; */
	ISP_CA_TYPE_E
	eCaCpEn; /* Not support for  V100/ V200/ V300/GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
	ISP_CA_LUT_S stCA; /*  */
	ISP_CP_LUT_S
	stCP; /* Not support for  V100/ V200/ V300/GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
} ISP_CA_ATTR_S;
...
typedef struct CSC_MATRX_S {
	GK_S16 as16CSCIdc
		[3]; /* RW; Range:[-1024, 1023]; Format: 11.0; Input dc component for csc matrix */
	GK_S16 as16CSCOdc
		[3]; /* RW; Range:[-1024, 1023]; Format: 11.0; Output dc component for csc matrix */
	GK_S16 as16CSCCoef
		[9]; /* RW; Range:[-4096, 4095]; Format: 5.10; 3x3 coefficients for csc matrix */
} CSC_MATRX_S;
...
typedef struct ISP_CSC_ATTR_S {
	...
	COLOR_GAMUT_E
	enColorGamut; /* RW; Range: [0, 4]; Color gamut type; COLOR_GAMUT_BT2020 only used for GK7608V200 */
...
typedef struct ISP_CLUT_LUT_S {
	GK_U32 au32lut
		[ISP_CLUT_LUT_LENGTH]; /* RW; Range: GK7608V200 = [0, 4294967295] | GK7606V100 = [0x0, 1073741823]|  V100 = [0x0, 1073741823]|
...
typedef struct ISP_DP_STATIC_CALIBRATE_S {
	...
	ISP_STATIC_DP_TYPE_E
	enStaticDPType; /* RW; Range: [0, 1];Format 1.0;Select static bright/dark defect-pixel calibration,Not support for GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
	...
	GK_U32 au32Table
		[STATIC_DP_COUNT_MAX]; /* R;  [0,0x1FFF1FFF];Format 29.0;Static defect-pixel calibraiton table,0~12 bits represents the X coordinate of the defect pixel, 16~28 bits represent the Y coordinate of the defect pixel.
                                                  Not support for GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
	...
	GK_U16 u16Count; /* R; Range:GK7608V200 = [0, 8192] | GK7606V100 = [0, 8192]  V100 = [0, 6144]|  V200 = [0, 6144]|
                                     ...
                                     Not support for GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
	ISP_STATUS_E
	enStatus; /* R; Range: [0, 2];Format 2.0;Status of static defect-pixel calibraiton,Not support for GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
...
typedef struct ISP_DP_STATIC_ATTR_S {
	...
	GK_U16 u16DarkCount; /* RW; Range:GK7608V200 = [0, 8192] | GK7606V100 = [0, 8192]|  V100 = [0, 6144]|  V200 = [0, 6144]|
                                       ...
                                       Not support for GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
	GK_U32 au32BrightTable
		[STATIC_DP_COUNT_MAX]; /* RW; Range: [0x0, 0x1FFF1FFF];Format 29.0;0~12 bits represents the X coordinate of the defect pixel, 16~28 bits represent the Y coordinate of the defect pixel
...
typedef struct ISP_DP_DYNAMIC_AUTO_ATTR_S {
	GK_U16 au16Strength
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range: [0, 255];Format:8.0;Dynamic DPC strength. */
	GK_U16 au16BlendRatio
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range: [0, 128];Format:9.0;Blending ratio required for DPC */
...
typedef struct ISP_DP_DYNAMIC_ATTR_S {
	...
	ISP_OP_TYPE_E
	enOpType; /* RW; Range: [0, 1];Format 1.0;Working mode of dynamic DPC */
...
typedef struct ISP_SHADING_LUT_S {
	GK_U16 au16RGain
		[ISP_LSC_GRID_POINTS]; /* RW; Range:[0,1023];Member used to store the calibration data of the R channel required for LSC. */
	GK_U16 au16GrGain
		[ISP_LSC_GRID_POINTS]; /* RW; Range:[0,1023];Member used to store the calibration data of the Gr channel required for LSC. */
	GK_U16 au16GbGain
		[ISP_LSC_GRID_POINTS]; /* RW; Range:[0,1023];Member used to store the calibration data of the Gb channel required for LSC. */
	GK_U16 au16BGain
		[ISP_LSC_GRID_POINTS]; /* RW; Range:[0,1023];Member used to store the calibration data of the B channel required for LSC. */
} ISP_SHADING_GAIN_LUT_S;

typedef struct ISP_BNR_LSC_GAIN_LUT_S {
	GK_U16 au16RGain
		[ISP_RLSC_POINTS]; /* RW; Range:[0,65535];Member used to store the calibration data of the R channel required for BNR_LSC.Not support for GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
	GK_U16 au16GrGain
		[ISP_RLSC_POINTS]; /* RW; Range:[0,65535];Member used to store the calibration data of the Gr channel required for BNR_LSC.Not support for GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
	GK_U16 au16GbGain
		[ISP_RLSC_POINTS]; /* RW; Range:[0,65535];Member used to store the calibration data of the Gb channel required for BNR_LSC.Not support for GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
	GK_U16 au16BGain
		[ISP_RLSC_POINTS]; /* RW; Range:[0,65535];Member used to store the calibration data of the B channel required for BNR_LSC.Not support for GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
...
typedef struct ISP_SHADING_LUT_ATTR_S {
	...
	GK_U16 au16XGridWidth
		[(ISP_LSC_GRID_COL - 1) /
		 2]; /* RW; Range:GK7608V200=[4, 1988]| GK7606V100=[4, 1988]| V100=[4, 1092]| V200=[4, 1092]|
	...
	ISP_BNR_LSC_GAIN_LUT_S
	stBNRLscGainLut; /* Not support for GK7608V200/GK7606V100 */
} ISP_SHADING_LUT_ATTR_S;

typedef struct ISP_MLSC_CALIBRATION_CFG_S {
	ISP_BAYER_FORMAT_E
	enBayer; /* RW; Range: [0, 3];Format ENUM;Shows bayer pattern */
	ISP_BAYER_RAWBIT_E
	enRawBit; /* RW; Range: {8,10,12,14,16};Format ENUM;Shows input raw bitwidth */
...
typedef struct ISP_MESH_SHADING_TABLE_S {
	...
	GK_U16 au16XGridWidth
		[(ISP_LSC_GRID_COL - 1) /
		 2]; /* RW; Range:GK7608V200=[4, 16323]| GK7606V100=[4, 16323]| V100=[4, 16323]| V200=[4, 16323]| V300=[4, 16323] |
	...
	GK_U16 au16YGridWidth
		[(ISP_LSC_GRID_ROW - 1) /
		 2]; /* RW; GK7608V200=[4, 16323]| GK7606V100=[4, 16323]| V100=[4, 16323]| V200=[4, 16323]| V300=[4, 16323]|
                                                            GK7205V200 = [4,255]|GK7205V300 =[4,255]| GK7202V300 = [0,255 ]|GK7605V100 = [0,255 ];
	...
	ISP_BNR_LSC_GAIN_LUT_S
	stBNRLscGainLut; /* Not support for GK7608V200/GK7606V100/GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
...
typedef struct ISP_RADIAL_SHADING_LUT_S {
	GK_U16 au16RGain
		[ISP_RLSC_POINTS]; /* RW; Range:[0,65535];Member used to store the calibration data of the R channel required for RLSC.Only used for GK7608V200/GK7606V100 */
	GK_U16 au16GrGain
		[ISP_RLSC_POINTS]; /* RW; Range:[0,65535];Member used to store the calibration data of the Gr channel required for RLSC.Only used for GK7608V200/GK7606V100 */
	GK_U16 au16GbGain
		[ISP_RLSC_POINTS]; /* RW; Range:[0,65535];Member used to store the calibration data of the Gb channel required for RLSC.Only used for GK7608V200/GK7606V100 */
	GK_U16 au16BGain
		[ISP_RLSC_POINTS]; /* RW; Range:[0,65535];Member used to store the calibration data of the B channel required for RLSC.Only used for GK7608V200/GK7606V100 */
} ISP_RADIAL_SHADING_GAIN_LUT_S;

/* Only used for GK7608V200/GK7606V100 */
typedef struct ISP_RADIAL_SHADING_LUT_ATTR_S {
	OPERATION_MODE_E
	enLightMode; /* RW; Range:[0, 1];Format:1.0; GK_TRUE: manual mode; GK_FALSE: auto mode.Only used for GK7608V200/GK7606V100 */
	...
	ISP_RADIAL_SHADING_GAIN_LUT_S
	astRLscGainLut[3]; /* Only used for GK7608V200/GK7606V100 */
} ISP_RADIAL_SHADING_LUT_ATTR_S;

typedef struct ISP_NR_MANUAL_ATTR_S {
	GK_U8 au8ChromaStr
		[ISP_BAYER_CHN_NUM]; /* RW;Range:[0x0,0x3];Format:2.0;Strength of Chrmoa noise reduction for R/Gr/Gb/B channel,Not support for GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
	...
	GK_U16 au16CoarseStr
		[ISP_BAYER_CHN_NUM]; /* RW;Range:[0x0,0x360];Format:10.0; Coarse Strength of noise reduction */
} ISP_NR_MANUAL_ATTR_S;

typedef struct ISP_NR_AUTO_ATTR_S {
	GK_U8 au8ChromaStr
		[ISP_BAYER_CHN_NUM]
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW;Range:[0x0,0x3];Format:2.0; Strength of chrmoa noise reduction for R/Gr/Gb/B channel,Not support for GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
	GK_U8 au8FineStr
	...
	GK_U16 au16CoarseStr
		[ISP_BAYER_CHN_NUM]
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW;Range:[0x0,0x360];Format:10.0; Coarse Strength of noise reduction */
} ISP_NR_AUTO_ATTR_S;
...
typedef struct ISP_NR_WDR_ATTR_S {
	...
	GK_U8 au8FusionFrameStr
		[WDR_MAX_FRAME_NUM]; /* RW;Range:[0x0,0x50];Format:7.0; Strength of each frame in wdr mode. Only used for  V100/ V200/ V300/GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
} ISP_NR_WDR_ATTR_S;
...
typedef struct ISP_NR_ATTR_S {
	...
	GK_U16 au16CoringRatio
		[ISP_BAYERNR_LUT_LENGTH]; /* RW;Range:[0x0,0x3ff];Format:12.0; Strength of reserving the random noise according to luma */
...
typedef struct ISP_DE_AUTO_ATTR_S {
	GK_U16 au16GlobalGain
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW;Range:[0x0,0x100];Format:1.8; Only used for  V100/ V200/ V300 */
	GK_U16 au16GainLF
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW;Range:[0x0,0x20];Format:2.4; Only used for  V100/ V200/ V300 */
	GK_U16 au16GainHF
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW;Range:[0x0,0x20];Format:2.4; Only used for  V100/ V200/ V300 */
} ISP_DE_AUTO_ATTR_S;
...
typedef struct ISP_DE_ATTR_S {
	...
	GK_U16 au16LumaGainLut
		[ISP_DE_LUMA_GAIN_LUT_N]; /* RW;Range:[0x0,0x100];Format:1.8; Only used for  V100/ V200/ V300 */
...
typedef struct ISP_RGBIR_ATTR_S {
	...
	ISP_IRBAYER_FORMAT_E
	enInPattern; /* RW;Range:[0x0,0x7];Format:3.0; IR pattern of the input signal,Only support GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
	ISP_BAYER_FORMAT_E
	enOutPattern; /* RW;Range:[0x0,0x3];Format:2.0; Bayer pattern of the output signal,Only support GK7205V200/GK7205V300/GK7202V300/GK7605V100 */

	GK_U16 au16ExpCtrl
		[ISP_EXP_CTRL_NUM]; /* RW;Range:[0, 2047];Format:11.0; Over expose control parameter,Only support GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
	GK_U16 au16Gain
		[ISP_EXP_CTRL_NUM]; /* RW;Range:[0, 511];Format:9.0; Over expose control parameter,Only support GK7205V200/GK7205V300/GK7202V300/GK7605V100 */

	ISP_IR_CVTMAT_MODE_E enIRCvtMatMode;
	GK_S16 as16CvtMatrix
		[ISP_CVTMAT_NUM]; /* RW;Range:[-32768, 32767];Format:s15.0; RGBIR to Bayer image Convert matrix coefficients(need calibration),Only support GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
} ISP_RGBIR_ATTR_S;
...
typedef struct ISP_GAMMA_ATTR_S {
	...
	GK_U16 u16Table
		[GAMMA_NODE_NUM]; /* RW; Range:[0, 4095]; Format:12.0;Gamma LUT nodes value */

	ISP_GAMMA_CURVE_TYPE_E
	enCurveType; /* RW; Range:[0, 3]; Format:2.0;Gamma curve type */
} ISP_GAMMA_ATTR_S;
...
typedef struct ISP_PREGAMMA_ATTR_S {
	...
	GK_U32 au32Table
		[PREGAMMA_NODE_NUM]; /* RW; Range:GK7608V200 = [0, 0x100000] | GK7606V100 = [0, 0x100000] |  V100 = [0, 0xFFFFF] | V200 = [0, 0xFFFFF] |
...
typedef struct ISP_SHARPEN_MANUAL_ATTR_S {
	GK_U8 au8LumaWgt
		[ISP_SHARPEN_LUMA_NUM]; /* RW; Range: GK7608V200 =[0,127]|GK7606V100=[0,127]| V100 = [0, 127]| V200 =[0, 127]|
...
typedef struct ISP_SHARPEN_AUTO_ATTR_S {
	GK_U8 au8LumaWgt
		...
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range:GK7608V200 =[0,127]|GK7606V100=[0,127]| V100 = [0, 127]|
	...
	GK_U8 au8SkinGain
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range: [0, 31]; Format:5.0;Sharpen Gain for Skin Area */
	GK_U16 au16MaxSharpGain
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range: [0, 0x7FF]; Format:8.3; Maximum sharpen gain */
	GK_U8 au8WeakDetailGain
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range: [0, 127]; Format:7.0; Only support for GK7205V200/GK7205V300/GK7202V300/GK7605V100; sharpen Gain for weakdetail */
...
typedef struct ISP_CR_ATTR_S {
	...
	GK_U16 au16Strength
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range: [0,256];Crosstalk strength value. */
	GK_U16 au16Threshold
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range: GK7608V200 = [0, 16383] | GK7606V100 = [0, 16383]| V100 = [0, 16383]| V200 =[0, 16383] |
                                                                                                   V300 =[0, 16383]|GK7205V200 = [0,65535]|
                                                                                                  GK7205V300 = [0,65535]|GK7202V300 = [0,65535]|GK7605V100 = [0,65535]; Crosstalk threshold. */
	GK_U16 au16NpOffset
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range: GK7608V200 = [512, 16383] | GK7606V100 = [512, 16383]| V100 = [512, 16383]|
...
typedef struct ISP_DEMOSAIC_AUTO_ATTR_S {
	GK_U8 au8NonDirStr
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range:[0x0, 0xFF]; Format:4.4; Non-direction strength */
	GK_U8 au8NonDirMFDetailEhcStr
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range:GK7608V200 = [0x0, 0x10] |GK7606V100 = [0x0, 0x7f] | V100= [0x0, 0x7f]|
                                                                   V200= [0x0, 0x7f]| V300= [0x0, 0x7f] |
                                                                  GK7205V200= [0x0, 0x7f]|GK7205V300 = [0x0, 0x7f] |GK7202V300= [0x0, 0x7f]|GK7605V100 = [0x0, 0x7f];
                                                                  Format:3.4; Non-direction medium frequent detail enhance  strength */
	GK_U8 au8NonDirHFDetailEhcStr
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range:[0x0,0x10];  Format:2.2; Non-direction high frequent detail enhance  strength */
	GK_U8 au8DetailSmoothRange
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range:GK7608V200 = [0x1, 0x8] |GK7606V100 = [0x1, 0x7] | V100 = [0x1, 0x7]|
                                                                   V200 = [0x1, 0x7]| V300 = [0x1, 0x7] |
                                                                  GK7205V200= [0x1, 0x7]|GK7205V300 = [0x, 0x7] |GK7202V300= [0x1, 0x7]|GK7605V100= [0x1, 0x7] ;
                                                                  Format:4.0; Detail smooth range */
	GK_U16 au16DetailSmoothStr
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW;Range:[0x0,0x100]; Format:9.0;   Strength of detail smooth, Only used for GK7608V200 */
	GK_U8 au8ColorNoiseThdF
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW;Range:[0x0,0xFF]; Format:8.0;   Frequency Threshold used for ColorNoise */
	GK_U8 au8ColorNoiseStrF
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW;Range:[0x0,0x8]; Format:4.0;   Frequency Strength used for ColorNoise */
	GK_U8 au8ColorNoiseThdY
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW;Range:[0x0,0xF];Format:4.0; Range of color denoise luma*/
	GK_U8 au8ColorNoiseStrY
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW;Range:[0x0,0x3F];Format:6.0; Strength of color denoise luma*/
...
typedef struct ISP_BLACK_LEVEL_S {
	ISP_OP_TYPE_E enOpType;
	GK_U16 au16BlackLevel
		[ISP_BAYER_CHN_NUM]; /* RW; Range: [0x0, 0xFFF];Format:12.0;Black level values that correspond to the black levels of the R,Gr, Gb, and B components respectively. */
} ISP_BLACK_LEVEL_S;
...
typedef struct ISP_FPN_FRAME_INFO_S {
	...
	GK_U32 u32Offset
		[VI_MAX_SPLIT_NODE_NUM]; /* RW;Range:[0,0xFFF];Format:12.0;FPN frame u32Offset (agv pixel value) */
	GK_U32 u32FrmSize; /* RW;FPN frame size (exactly frm size or compress len) */
	VIDEO_FRAME_INFO_S
	stFpnFrame; /* FPN frame info, 8bpp,10bpp,12bpp,16bpp. Compression or not */
...
typedef struct ISP_DEPURPLESTR_AUTO_ATTR_S {
	GK_U8 au8DePurpleCrStr
		[ISP_EXP_RATIO_STRENGTH_NUM]; /* RW;Range: [0,8];Format:4.0;Correction strength of the R channel */
	GK_U8 au8DePurpleCbStr
		[ISP_EXP_RATIO_STRENGTH_NUM]; /* RW;Range: [0,8];Format:4.0;Correction strength of the B channel */
...
typedef struct ISP_LOCAL_CAC_ATTR_S {
	...
	GK_U16 u16RDetThr
		[ISP_LCAC_DET_NUM]; /* RW;Range: [0,4095];Format:12.0;Component R detection threshold, actual threshold change with PurpleDetRange */
	GK_U16 u16GDetThr
		[ISP_LCAC_DET_NUM]; /* RW;Range: [0,4095];Format:12.0;Component G detection threshold, actual threshold change with PurpleDetRange */
	GK_U16 u16BDetThr
		[ISP_LCAC_DET_NUM]; /* RW;Range: [0,4095];Format:12.0;Component B detection threshold, actual threshold change with PurpleDetRange */
	GK_U16 u16LumaDetThr
		[ISP_LCAC_DET_NUM]; /* RW;Range: [0,4095];Format:12.0;Component Luma detection threshold, actual threshold change with PurpleDetRange */
	GK_S16 s16CbCrRatio
		[ISP_LCAC_DET_NUM]; /* RW;Range: [-2048,2047];Format:S12.0; Cb/Cr ratio threshold, actual threshold change with PurpleDetRange */
	ISP_OP_TYPE_E
	enOpType; /* RW;Range: [0,1];Format:1.0;Purple fringing correction working mode */
...
typedef struct ISP_INNER_STATE_INFO_S {
	...
	GK_U16 au16CoarseStr
		[ISP_BAYER_CHN_NUM]; /* RW;Range:[0x0,0x3ff];Format:10.0; Coarse Strength of noise reduction */
	GK_U8 au8WDRFrameStr
		[WDR_MAX_FRAME_NUM]; /* RW;Range:[0x0,0x50];Format:7.0; Coarse strength of each frame in wdr mode */
	GK_U8 au8ChromaStr
		[ISP_BAYER_CHN_NUM]; /* RW;Range:[0x0,0x3];Format:2.0;Strength of Chrmoa noise reduction for R/Gr/Gb/B channel, V100/ V200/ V300
	...
	GK_U32 u32WDRExpRatioActual
		[3]; /* RW; Range:[0x40, 0x4000]; Format:26.6; 0x40 means 1 times.
	...
	GK_U16 au16BLActual
		[ISP_BAYER_CHN_NUM]; /* RW; Range: [0x0, 0xFFF];Format:12.0;Actual Black level values that correspond to the black levels of the R,Gr, Gb, and B components respectively. */
...
typedef struct ISP_AE_HIST_CONFIG_S {
	...
	ISP_AE_HIST_SKIP_E enHistSkipY; /* RW; Range:[0,6]; Format:4.0;
                                                                    ...
                                                                    3rd pixel; 3=every 4th pixel; 4=every 5th pixel; 5=every 8th pixel ; 6+=every 9th pixel */
	ISP_AE_HIST_OFFSET_X_E
	enHistOffsetX; /* RW; Range:[0,1]; Format:1.0; 0= start from the first column; 1=start from second column */
	ISP_AE_HIST_OFFSET_Y_E
	enHistOffsetY; /* RW; Range:[0,1]; Format:1.0; 0= start from the first row; 1= start from second row */
...
typedef struct ISP_AE_STATISTICS_CFG_S {
	ISP_AE_SWITCH_E
	enAESwitch; /* RW; Range:[0,2]; Format:2.0;The position of AE histogram in ISP BE pipeline */
	ISP_AE_HIST_CONFIG_S stHistConfig;
	ISP_AE_FOUR_PLANE_MODE_E
	enFourPlaneMode; /* RW; Range:[0,1]; Format:2.0;Four Plane Mode Enable */
	ISP_AE_STAT_MODE_E
	enHistMode; /* RW; Range:[0,1]; Format:2.0;AE Hist Rooting Mode */
	ISP_AE_STAT_MODE_E
	enAverMode; /* RW; Range:[0,1]; Format:2.0;AE Aver Rooting Mode */
	ISP_AE_STAT_MODE_E
	enMaxGainMode; /* RW; Range:[0,1]; Format:2.0;Max Gain Rooting Mode */
	ISP_AE_CROP_S stCrop;
	GK_U8 au8Weight
		[AE_ZONE_ROW]
		[AE_ZONE_COLUMN]; /* RW; Range:[0x0, 0xF]; Format:4.0; AE weighting table */
...
typedef enum ISP_AF_STATISTICS_POS_E {
	ISP_AF_STATISTICS_AFTER_DGAIN =
		0, // The AF module is placed in the raw field for statistics,AF after DGain
...
typedef struct ISP_AF_RAW_CFG_S {
	...
	ISP_BAYER_FORMAT_E
	enPattern; /* RW; Range: [0x0, 0x3]; Format:2.0;raw domain pattern */
} ISP_AF_RAW_CFG_S;
...
typedef struct ISP_AF_CFG_S {
	...
	ISP_AF_PEAK_MODE_E
	enPeakMode; /* RW; Range: [0,1]; AF peak value statistic mode. */
	ISP_AF_SQU_MODE_E
	enSquMode; /* RW; Range: [0,1]; AF statistic square accumulate. */
	ISP_AF_CROP_S stCrop; /* RW; AF input image crop */
	ISP_AF_STATISTICS_POS_E
	enStatisticsPos; /* RW; Range: [0,2]; AF statistic position, it can be set to yuv or raw */
	ISP_AF_RAW_CFG_S
	stRawCfg; /* RW; When AF locate at RAW domain, these para should be cfg. */
...
typedef struct ISP_AF_H_PARAM_S {
	...
	GK_S16 as16IIRGain
		[IIR_GAIN_NUM]; /* RW; Range: [-511, 511]. IIR gain,gain0 range:[0,255]. */
...
typedef struct ISP_AF_FV_PARAM_S {
	...
	GK_U16 au16AccShiftH
		[ACC_SHIFT_H_NUM]; /* RW; Range: [0x0, 0xF]; IIR statistic shift. */
	GK_U16 au16AccShiftV
		[ACC_SHIFT_V_NUM]; /* RW; Range: [0x0, 0xF]; FIR statistic shift. */
...
typedef struct ISP_AE_STATISTICS_S {
	GK_U32 au32FEHist1024Value
		[ISP_CHN_MAX_NUM]
		[HIST_NUM]; /* R; Range: [0x0, 0xFFFFFFFF]; Format:32.0; Global 1024 bins histogram of FE */
	GK_U16 au16FEGlobalAvg
		[ISP_CHN_MAX_NUM]
		[BAYER_PATTERN_NUM]; /* R; Range: [0x0, 0xFFFF]; Format:16.0; Global average value of FE,Not support GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
	GK_U16 au16FEZoneAvg
		[ISP_CHN_MAX_NUM][AE_ZONE_ROW][AE_ZONE_COLUMN]
		[BAYER_PATTERN_NUM]; /* R; Range: [0x0, 0xFFFF]; Format:16.0; Zone average value of FE, Not support for  V100/ V200/ V300's Fe1 and Fe3,
                                                                                                                                                           Not support GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
	GK_U32 au32BEHist1024Value
		[HIST_NUM]; /* R; Range: [0x0, 0xFFFFFFFF]; Format:32.0; Global 1024 bins histogram of BE */
	GK_U16 au16BEGlobalAvg
		[BAYER_PATTERN_NUM]; /* R; Range: [0x0, 0xFFFF]; Format:16.0; Global average value of BE */
	GK_U16 au16BEZoneAvg
		[AE_ZONE_ROW][AE_ZONE_COLUMN]
		[BAYER_PATTERN_NUM]; /* R; Range: [0x0, 0xFFFF]; Format:16.0; Zone average value of BE */
...
typedef struct ISP_AE_STITCH_STATISTICS_S {
	GK_U32 au32FEHist1024Value
		[ISP_CHN_MAX_NUM]
		[HIST_NUM]; /* R; Range: [0x0, 0xFFFFFFFF]; Format:32.0; Global 1024 bins histogram of FE.Not support for  V100/ V200/ V300/GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
	GK_U16 au16FEGlobalAvg
		[ISP_CHN_MAX_NUM]
		[BAYER_PATTERN_NUM]; /* R; Range: [0x0, 0xFFFF]; Format:16.0; Global average value of FE.Not support for  V100/ V200/ V300/GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
	GK_U16 au16FEZoneAvg
		[VI_MAX_PIPE_NUM][ISP_CHN_MAX_NUM][AE_ZONE_ROW][AE_ZONE_COLUMN]
		[BAYER_PATTERN_NUM]; /* R; Range: [0x0, 0xFFFF]; Format:16.0; Zone average value of FE.Not support for  V100/ V200/ V300/GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
	GK_U32 au32BEHist1024Value
		[HIST_NUM]; /* R; Range: [0x0, 0xFFFFFFFF]; Format:32.0; Global 1024 bins histogram of BE.Not support for  V100/ V200/ V300/GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
	GK_U16 au16BEGlobalAvg
		[BAYER_PATTERN_NUM]; /* R; Range: [0x0, 0xFFFF]; Format:16.0; Global average value of BE.Not support for  V100/ V200/ V300/GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
	GK_U16 au16BEZoneAvg
		[VI_MAX_PIPE_NUM][AE_ZONE_ROW][AE_ZONE_COLUMN]
		[BAYER_PATTERN_NUM]; /* R; Range: [0x0, 0xFFFF]; Format:16.0; Zone average value of BE.Not support for  V100/ V200/ V300/GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
} ISP_AE_STITCH_STATISTICS_S;

typedef struct ISP_MG_STATISTICS_S {
	GK_U16 au16ZoneAvg
		[MG_ZONE_ROW][MG_ZONE_COLUMN]
		[BAYER_PATTERN_NUM]; /* R; Range: [0x0, 0xFF]; Format:8.0; Zone average value */
...
typedef struct ISP_WB_STATISTICS_CFG_S {
	ISP_AWB_SWITCH_E
	enAWBSwitch; /* RW; Range: [0x0, 0x2]; Position of AWB statistics in pipeline */
...
typedef struct ISP_WB_STITCH_STATISTICS_S {
	...
	GK_U16 au16ZoneAvgR
		[AWB_ZONE_STITCH_MAX]; /* R; Range: [0x0, 0xFFFF];Zone Average R  for Stitich mode */
	GK_U16 au16ZoneAvgG
		[AWB_ZONE_STITCH_MAX]; /* R; Range: [0x0, 0xFFFF];Zone Average G  for Stitich mode */
	GK_U16 au16ZoneAvgB
		[AWB_ZONE_STITCH_MAX]; /* R; Range: [0x0, 0xFFFF];Zone Average B  for Stitich mode */
	GK_U16 au16ZoneCountAll
		[AWB_ZONE_STITCH_MAX]; /* R; Range: [0x0, 0xFFFF];normalized number of Gray points  for Stitich mode */
...
typedef struct ISP_WB_STATISTICS_S {
	...
	GK_U16 au16ZoneAvgR
		[AWB_ZONE_NUM]; /* R; Range: [0x0, 0xFFFF];Zone Average R */
	GK_U16 au16ZoneAvgG
		[AWB_ZONE_NUM]; /* R; Range: [0x0, 0xFFFF];Zone Average G */
	GK_U16 au16ZoneAvgB
		[AWB_ZONE_NUM]; /* R; Range: [0x0, 0xFFFF];Zone Average B */
	GK_U16 au16ZoneCountAll
		[AWB_ZONE_NUM]; /* R; Range: [0x0, 0xFFFF];normalized number of Gray points */
...
typedef struct ISP_FE_FOCUS_STATISTICS_S {
	ISP_FOCUS_ZONE_S stZoneMetrics
		[WDR_CHN_MAX][AF_ZONE_ROW]
		[AF_ZONE_COLUMN]; /* R; The zoned measure of contrast */
...
typedef struct ISP_AF_STATISTICS_S {
	ISP_FE_FOCUS_STATISTICS_S
	stFEAFStat; /* Not support for  V100/ V200/ V300/GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
	ISP_BE_FOCUS_STATISTICS_S stBEAFStat; /*  */
	ISP_FOCUS_GRID_INFO_S
	stFEAFGridInfo; /* Not support for  V100/ V200/ V300/GK7205V200/GK7205V300/GK7202V300/GK7605V100 */
...
typedef struct ISP_PIRIS_ATTR_S {
	...
	GK_U16 au16StepFNOTable
		[AI_MAX_STEP_FNO_NUM]; /* RW; Range:[1, 1024]; Format:16.0; Step-F number mapping table. F1.0 is expressed as 1024, F32 is expressed as 1, it's related to the specific iris */
	ISP_IRIS_F_NO_E
	enMaxIrisFNOTarget; /* RW; Range:[0, 10]; Format:4.0; Max F number of Piris's aperture, it's related to the specific iris */
	ISP_IRIS_F_NO_E
	enMinIrisFNOTarget; /* RW; Range:[0, 10]; Format:4.0; Min F number of Piris's aperture, it's related to the specific iris */
...
typedef struct ISP_MI_ATTR_S {
	...
	ISP_IRIS_F_NO_E
	enIrisFNO; /* RW; Range:[0, 10]; Format:4.0; the F number of P-iris */
} ISP_MI_ATTR_S;
...
typedef enum ISP_FSWDR_MODE_E {
	...
	ISP_FSWDR_AUTO_LONG_FRAME_MODE =
		0x2, /* Auto long frame mode, only effective in LINE_WDR, When running in this mode, normal WDR and long frame mode would auto switch */
	ISP_FSWDR_MODE_BUTT
} ISP_FSWDR_MODE_E;
...
typedef struct ISP_AE_ATTR_S {
	/* base parameter */
	ISP_AE_RANGE_S
	stExpTimeRange; /* RW; Range:[0x0, 0xFFFFFFFF]; Format:32.0; sensor exposure time (unit: us ), it's related to the specific sensor */
	ISP_AE_RANGE_S
	stAGainRange; /* RW; Range:[0x400, 0xFFFFFFFF]; Format:22.10; sensor analog gain (unit: times, 10bit precision), it's related to the specific sensor */
	ISP_AE_RANGE_S
	stDGainRange; /* RW; Range:[0x400, 0xFFFFFFFF]; Format:22.10;  sensor digital gain (unit: times, 10bit precision), it's related to the specific sensor */
	ISP_AE_RANGE_S
	stISPDGainRange; /* RW; Range:[0x400, 0x40000]; Format:22.10;  ISP digital gain (unit: times, 10bit precision), it's related to the ISP digital gain range */
	ISP_AE_RANGE_S
	stSysGainRange; /* RW; Range:[0x400, 0xFFFFFFFF]; Format:22.10;  system gain (unit: times, 10bit precision), it's related to the specific sensor and ISP Dgain range */
	...
	ISP_AE_STRATEGY_E
	enAEStrategyMode; /* RW; Range:[0, 1]; Format:1.0; Support Highlight prior or Lowlight prior */
	...
	ISP_AE_MODE_E
	enAEMode; /* RW; Range:[0, 1]; Format:1.0; AE mode(slow shutter/fix framerate)(onvif) */
	...
	ISP_FSWDR_MODE_E
	enFSWDRMode; /* RW; Range:[0, 2]; Format:2.0; FSWDR running mode */
...
typedef struct ISP_EXPOSURE_ATTR_S {
	...
	ISP_PRIOR_FRAME_E
	enPriorFrame; /* RW; Range:[0, 3]; Format:1.0; AE prior frame */
...
typedef struct ISP_AE_ROUTE_NODE_S {
	...
	ISP_IRIS_F_NO_E
	enIrisFNO; /* RW; Range:[0, 10]; Format:4.0; the F number of the iris's aperture, only support for Piris */
...
typedef struct ISP_EXP_INFO_S {
	...
	GK_U32 au32AE_Hist1024Value
		[HIST_NUM]; /* R; Range:[0x0, 0xFFFFFFFF]; Format:32.0; 1024 bins histogram for channel 1 */
...
typedef struct ISP_WDR_EXPOSURE_ATTR_S {
	ISP_OP_TYPE_E
	enExpRatioType; /* RW; Range:[0, 1]; Format:1.0; OP_TYPE_AUTO: The ExpRatio used in ISP is generated by firmware; OP_TYPE_MANUAL: The ExpRatio used in ISP is set by u32ExpRatio */
	GK_U32 au32ExpRatio
		[EXP_RATIO_NUM]; /* RW; Range:[0x40, 0xFFF]; Format:26.6; 0x40 means 1 times.
                                            When enExpRatioType is OP_TYPE_AUTO, u32ExpRatio is invalid.
                                            When enExpRatioType is OP_TYPE_MANUAL, u32ExpRatio is quotient of long exposure time / short exposure time. */
...
typedef struct ISP_HDR_EXPOSURE_ATTR_S {
	ISP_OP_TYPE_E
	enExpHDRLvType; /* RW; Range:[0, 1]; Format:1.0; OP_TYPE_AUTO: The ExpHDRLv used in ISP is generated by firmware; OP_TYPE_MANUAL: The ExpHDRLv used in ISP is set by u32ExpHDRLv */
...
typedef struct ISP_SMART_EXPOSURE_ATTR_S {
	...
	ISP_OP_TYPE_E
	enSmartExpType; /* RW; Range:[0, 1]; Format:1.0; OP_TYPE_AUTO: The ExpCoef used in ISP is generated by firmware; OP_TYPE_MANUAL: The ExpCoef used in ISP is set by u32ExpCoef */
...
typedef struct ISP_AWB_IN_OUT_ATTR_S {
	...
	ISP_OP_TYPE_E enOpType;
	ISP_AWB_INDOOR_OUTDOOR_STATUS_E
	enOutdoorStatus; /* RW;User should config indoor or outdoor status in Manual Mode */
...
typedef struct ISP_AWB_CBCR_TRACK_ATTR_S {
	...
	GK_U16 au16CrMax
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range:[0x0, 0xFFF]; au16CrMax[i] >= au16CrMin[i] */
	GK_U16 au16CrMin[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range:[0x0, 0xFFF] */
	GK_U16 au16CbMax
		[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range:[0x0, 0xFFF]; au16CbMax[i] >= au16CbMin[i] */
...
typedef struct ISP_AWB_LUM_HISTGRAM_ATTR_S {
	...
	ISP_OP_TYPE_E
	enOpType; /* In auto mode, the weight distribution follows Gaussian distribution */
	GK_U8 au8HistThresh
		[AWB_LUM_HIST_NUM]; /* RW; Range:[0x0, 0xFF]; Format:8.0; In manual mode, user define luma thresh, thresh[0] = 0, thresh[5] = 0xFF,  thresh[i] >=  thresh[i-1] */
	GK_U16 au16HistWt
		[AWB_LUM_HIST_NUM]; /* RW; Range:[0x0, 0xFFFF]; Format:16.0; user can define luma weight in both manual and auto mode. */
...
typedef struct ISP_AWB_ATTR_EX_S {
	...
	GK_U16 au16MultiCTBin
		[AWB_MULTI_CT_NUM]; /* RW; Range:[0, 0XFFFF]; Format:16.0;AWB Support divide the color temperature range by 8 bins */
	GK_U16 au16MultiCTWt
		[AWB_MULTI_CT_NUM]; /* RW; Range:[0x0, 0x400];Weight for different color temperature, same value of 8 means CT weight does't work, */
...
typedef struct ISP_AWB_ATTR_S {
	...
	GK_U16 au16StaticWB
		[ISP_BAYER_CHN_NUM]; /* RW; Range:[0x0, 0xFFF]; Format:12.0;Calibration Information */
	GK_S32 as32CurvePara
		[AWB_CURVE_PARA_NUM]; /* RW; Format:32.0;Calibration Information,limited Range:as32CurvePara[3] != 0, as32CurvePara[4]==128 */
	...
	GK_U8 au8ZoneWt
		[AWB_ZONE_ORIG_ROW *
		 AWB_ZONE_ORIG_COLUMN]; /* RW; Range: [0, 255]; Format:8.0;Zone Wt Table */
} ISP_AWB_ATTR_S;

/* Attr for SPC AWB */
#define SPECAWB_FACTTBL_ELMNUM (7) /* Table number. */
#define SPECAWB_FACTTBL_SIZE \
	(64) /* Table size for weight for light source detection. */
...
typedef struct ISP_SPECAWB_FACTTBL_ELEMENT_S {
	...
	GK_U8 u8FactTbl
		...
		[SPECAWB_FACTTBL_SIZE]; /* RW;Range:[0, 0xFF]; Weight for light source detection. */
} ISP_SPECAWB_FACTTBL_ELEMENT_S;

typedef struct ISP_SPECAWB_ATTR_S {
	ISP_SPECKCWB_S
	stWBCenter; /* RW;WB gain value at the center of the table: The table index is calculated as a relative value from this gain. */
	ISP_SPECKCWB_S
	stWBMin; /* RW;Minimum value of WB gain that the table covers. */
	ISP_SPECKCWB_S
	stWBMax; /* RW;Maximum value of WB gain that the table covers. */
	ISP_SPECKCWB_S
	stLogFact; /* RW;Range covered by the table: 1/exp(stLogFact) to exp(stLogFact). For example, if it is 1.0, WBDelta will be 1/e to e. However, e = 2.71828 ... (base of natural logarithm) */
	...
	ISP_SPECKCWB_S
	stWBNeutral; /* RW;WB gain returned when AWB calculation can not be performed. */
	...
	ISP_SPECKCWBS16_S stWBCnvTbl
		[SPECAWB_FACTTBL_SIZE]
		[SPECAWB_FACTTBL_SIZE]; /* RW; WB gain conversion table (incomplete chromatic adaptation table). */
	GK_U8 u8ElementNum; /* RW; Range:[7];Number of connected ISP_SPECAWB_FACTTBL_ELEMENT. */
	ISP_SPECAWB_FACTTBL_ELEMENT_S
	stFactElement[SPECAWB_FACTTBL_ELMNUM]; /* RW; Weight Table */
	ISP_SPECAWB_KELVIN_DBB_MAP_S
	stKelvinDBBTbl[SPECAWB_FACTTBL_SIZE]
		      [SPECAWB_FACTTBL_SIZE]; /* RW;KelvinDbb table. */
	ISP_SPECAWB_BBL_TBL_S
	stBlackBodyTbl[SPECAWB_BBL_SIZE]; /* RW;BlackBody table. */
...
typedef struct ISP_COLORMATRIX_MANUAL_S {
	...
	GK_U16 au16CCM
		[CCM_MATRIX_SIZE]; /* RW; Range: [0x0, 0xFFFF]; Format:8.8; Manul CCM matrix, */
...
typedef struct ISP_COLORMATRIX_PARAM_S {
	...
	GK_U16 au16CCM
		[CCM_MATRIX_SIZE]; /* RW; Range: [0x0, 0xFFFF]; Format:8.8; CCM matrixes for different color temperature */
...
typedef struct ISP_WB_INFO_S {
	...
	GK_U16 au16CCM
		[CCM_MATRIX_SIZE]; /* R; Range: [0x0, 0xFFFF];Format:16.0;Current color correction matrix */
	...
	ISP_AWB_INDOOR_OUTDOOR_STATUS_E
	enInOutStatus; /* R; indoor or outdoor status */
...
typedef struct DNG_RAW_FORMAT_S {
	...
	GK_U8 au8CfaPlaneColor
		[CFACOLORPLANE]; /* RO;Format:8.0; Indicate the planer numbers of raw data; 0:red 1:green 2: blue */
	DNG_CFALAYOUT_TYPE_E
	enCfaLayout; /* RO;Range:[1,9]; Describes the spatial layout of the CFA */
	DNG_BLCREPEATDIM_S
	stBlcRepeatDim; /* Specifies repeat pattern size for the BlackLevel */
	...
	DNG_REPEATPATTERNDIM_S
	stCfaRepeatPatternDim; /* Specifies the pixel number of repeat color planer in each direction */
	GK_U8 au8CfaPattern
		[ISP_BAYER_CHN]; /* RO;Format:8.0; Indicate the bayer start order; 0:red 1:green 2: blue */
} DNG_RAW_FORMAT_S;
...
typedef struct DNG_IMAGE_STATIC_INFO_S {
	...
	DNG_SRATIONAL_S astColorMatrix1
		[CCM_MATRIX_SIZE]; /* defines a transformation matrix that converts XYZ values to reference camera native color space values, under the first calibration illuminant. */
	DNG_SRATIONAL_S astColorMatrix2
		[CCM_MATRIX_SIZE]; /* defines a transformation matrix that converts XYZ values to reference camera native color space values, under the second calibration illuminant. */
	DNG_SRATIONAL_S astCameraCalibration1
		[CCM_MATRIX_SIZE]; /* defines a calibration matrix that transforms reference camera native space values to individual camera native space values under the first calibration illuminant */
	DNG_SRATIONAL_S astCameraCalibration2
		[CCM_MATRIX_SIZE]; /* defines a calibration matrix that transforms reference camera native space values to individual camera native space values under the second calibration illuminant */
	DNG_SRATIONAL_S astForwadMatrix1
		[CCM_MATRIX_SIZE]; /* defines a matrix that maps white balanced camera colors to XYZ D50 colors */
	DNG_SRATIONAL_S astForwadMatrix2
		[CCM_MATRIX_SIZE]; /* defines a matrix that maps white balanced camera colors to XYZ D50 colors */
...
typedef struct ISP_DNG_COLORPARAM_S {
	ISP_DNG_WBGAIN_S
	stWbGain1; /* the calibration White balance gain of colorcheker in low colortemper light source */
	ISP_DNG_WBGAIN_S
	stWbGain2; /* the calibration White balance gain of colorcheker in high colortemper light source */
