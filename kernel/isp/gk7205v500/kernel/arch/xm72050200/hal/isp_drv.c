...
extern XMEDIA_BOOL         g_IntBothalf;
extern XMEDIA_BOOL         g_UseBothalf;
extern XMEDIA_BOOL         g_LdciTprFltEn[ISP_MAX_PIPE_NUM];

void  *reg_vicap_base_va = XMEDIA_NULL;
void  *reg_vicap_ch_base_va[ISP_MAX_PIPE_NUM] = {XMEDIA_NULL};
void  *reg_ispfe_base_va[ISP_MAX_PIPE_NUM]    = {XMEDIA_NULL};
void  *reg_ispbe_base_va[ISP_MAX_BE_NUM]      = {XMEDIA_NULL};
void  *reg_viproc_base_va[ISP_MAX_BE_NUM]     = {XMEDIA_NULL};

#define ENABLE_CLOCK 1

XMEDIA_U32 g_DrcCurLumaLut[ISP_DRC_SHP_LOG_CONFIG_NUM][ISP_DRC_EXP_COMP_SAMPLE_NUM - 1] = {
...
static XMEDIA_U16 Sqrt32(XMEDIA_U32 u32Arg)
{
    XMEDIA_U32 u32Mask = (XMEDIA_U32)1 << 15;
    XMEDIA_U16 u16Res = 0;
    XMEDIA_U32 i = 0;
...
XMEDIA_S32 ISP_DRV_SetInputSel(S_ISPBE_REGS_TYPE *pstIspBeRegs, XMEDIA_U32 *pu32InputSel)
{
...
static __inline XMEDIA_S32 ISP_DRV_SetIspDgain(S_ISPBE_REGS_TYPE *pstIspBeRegs, XMEDIA_U32 u32IspDgain)
{
...
static __inline XMEDIA_S32 ISP_DRV_SetIsp4Dgain0(S_ISPBE_REGS_TYPE *pstIspBeRegs, XMEDIA_U32 u32Isp4Dgain0)
{
...
static __inline XMEDIA_S32 ISP_DRV_SetIsp4Dgain1(S_ISPBE_REGS_TYPE *pstIspBeRegs, XMEDIA_U32 u32Isp4Dgain1)
{
...
static __inline XMEDIA_S32 ISP_DRV_SetWdrExporratio0(S_ISPBE_REGS_TYPE *pstIspBeRegs, XMEDIA_U32 uisp_wdr_exporatio0)
{
...
static __inline XMEDIA_S32 ISP_DRV_SetWdrExpoValue0(S_ISPBE_REGS_TYPE *pstIspBeRegs, XMEDIA_U32 uisp_wdr_expovalue0)
{
...
static __inline XMEDIA_S32 ISP_DRV_SetWdrExpoValue1(S_ISPBE_REGS_TYPE *pstIspBeRegs, XMEDIA_U32 uisp_wdr_expovalue1)
{
    U_ISP_WDR_EXPOVALUE o_isp_wdr_expovalue0;
    ISP_CHECK_POINTER(pstIspBeRegs);
...
static __inline XMEDIA_S32 ISP_DRV_SetWdrBlcComp0(S_ISPBE_REGS_TYPE *pstIspBeRegs, XMEDIA_U32 uisp_wdr_blc_comp0)
{
...
static __inline XMEDIA_S32 ISP_DRV_SetWdrMaxRatio(S_ISPBE_REGS_TYPE *pstIspBeRegs, XMEDIA_U32 uisp_wdr_maxratio)
{
...
static __inline XMEDIA_S32 ISP_DRV_SetWdrLongThr(S_ISPBE_REGS_TYPE *pstIspBeRegs, XMEDIA_U32 uisp_wdr_long_thr)
{
...
static __inline XMEDIA_S32 ISP_DRV_SetWdrShortThr(S_ISPBE_REGS_TYPE *pstIspBeRegs, XMEDIA_U32 uisp_wdr_short_thr)
{
    U_ISP_WDR_WGTIDX_THR o_isp_wdr_wgtidx_thr;
    ISP_CHECK_POINTER(pstIspBeRegs);
...
static __inline XMEDIA_S32 ISP_DRV_SetWdrMdtEn(S_ISPBE_REGS_TYPE *pstIspBeRegs, XMEDIA_U32 uisp_wdr_mdt_en)
{
...
static __inline XMEDIA_S32 ISP_DRV_SetWdrWgtSlope(S_ISPBE_REGS_TYPE *pstIspBeRegs, XMEDIA_U32 uisp_wdr_weight_slope)
{
...
static __inline XMEDIA_S32 ISP_DRV_SetWdrFusionMode(S_ISPBE_REGS_TYPE *pstIspBeRegs, XMEDIA_U32 uisp_wdr_fusion_mode)
{
    U_ISP_WDR_CTRL o_isp_wdr_ctrl;
    ISP_CHECK_POINTER(pstIspBeRegs);
...
static __inline XMEDIA_S32 ISP_DRV_SetLdciStatEvratio(S_ISPBE_REGS_TYPE *pstIspBeRegs, XMEDIA_U32 uisp_ldci_stat_evratio)
{
...
static __inline XMEDIA_S32 ISP_DRV_SetDrcPrevLuma0(S_ISPBE_REGS_TYPE *pstIspBeRegs, XMEDIA_U32 uisp_drc_prev_luma_0)
{
...
static __inline XMEDIA_S32 ISP_DRV_SetDrcPrevLuma1(S_ISPBE_REGS_TYPE *pstIspBeRegs, XMEDIA_U32 uisp_drc_prev_luma_1)
{
...
static __inline XMEDIA_S32 ISP_DRV_SetDrcPrevLuma2(S_ISPBE_REGS_TYPE *pstIspBeRegs, XMEDIA_U32 uisp_drc_prev_luma_2)
{
...
static __inline XMEDIA_S32 ISP_DRV_SetDrcPrevLuma3(S_ISPBE_REGS_TYPE *pstIspBeRegs, XMEDIA_U32 uisp_drc_prev_luma_3)
{
...
static __inline XMEDIA_S32 ISP_DRV_SetDrcPrevLuma4(S_ISPBE_REGS_TYPE *pstIspBeRegs, XMEDIA_U32 uisp_drc_prev_luma_4)
{
...
static __inline XMEDIA_S32 ISP_DRV_SetDrcPrevLuma5(S_ISPBE_REGS_TYPE *pstIspBeRegs, XMEDIA_U32 uisp_drc_prev_luma_5)
{
...
static __inline XMEDIA_S32 ISP_DRV_SetDrcPrevLuma6(S_ISPBE_REGS_TYPE *pstIspBeRegs, XMEDIA_U32 uisp_drc_prev_luma_6)
{
...
static __inline XMEDIA_S32 ISP_DRV_SetDrcPrevLuma7(S_ISPBE_REGS_TYPE *pstIspBeRegs, XMEDIA_U32 uisp_drc_prev_luma_7)
{
...
static __inline XMEDIA_S32 ISP_DRV_SetDrcShpCfg(S_ISPBE_REGS_TYPE *pstIspBeRegs, XMEDIA_U32 uisp_drc_shp_log, XMEDIA_U32 uisp_drc_shp_exp)
{
...
static __inline XMEDIA_S32 ISP_DRV_SetDrcDivDenomLog(S_ISPBE_REGS_TYPE *pstIspBeRegs, XMEDIA_U32 uisp_drc_div_denom_log)
{
...
static __inline XMEDIA_S32 ISP_DRV_SetDrcDenomExp(S_ISPBE_REGS_TYPE *pstIspBeRegs, XMEDIA_U32 uisp_drc_denom_exp)
{
...
XMEDIA_S32 ISP_DRV_SetLdciWriteSttAddr(S_VIPROC_REGS_TYPE *apstViprocReg, XMEDIA_U64 u64WriteAddr)
{
...
XMEDIA_S32 ISP_DRV_SetLdciReadSttAddr(S_VIPROC_REGS_TYPE *apstViprocReg, XMEDIA_U64 u64ReadAddr)
{
    ISP_CHECK_POINTER(apstViprocReg);
...
/* Fe Blc */
static __inline XMEDIA_VOID isp_drv_fe_dg_offset_write(S_ISPFE_REGS_TYPE *fe_reg, xmedia_u16 *dg_blc)
{
    ISP_CHECK_POINTER_VOID(fe_reg);
    ISP_CHECK_POINTER_VOID(dg_blc);

    fe_reg->ISP_DG2_BLC_OFFSET1.u32 = ((xmedia_u32)dg_blc[BAYER_CHN_R] << 16) + dg_blc[BAYER_CHN_GR]; /* bit16~30: r_blc */
    fe_reg->ISP_DG2_BLC_OFFSET2.u32 = ((xmedia_u32)dg_blc[BAYER_CHN_B] << 16) + dg_blc[BAYER_CHN_GB]; /* bit16~30: b_blc */
}

static __inline XMEDIA_VOID isp_drv_fe_wb_offset_write(S_ISPFE_REGS_TYPE *fe_reg, xmedia_u16 *wb_blc)
{
    ISP_CHECK_POINTER_VOID(fe_reg);
    ISP_CHECK_POINTER_VOID(wb_blc);

    fe_reg->ISP_WB1_BLC_OFFSET1.u32 = ((xmedia_u32)wb_blc[BAYER_CHN_R] << 16) + wb_blc[BAYER_CHN_GR]; /* bit16~30: r_blc */
    fe_reg->ISP_WB1_BLC_OFFSET2.u32 = ((xmedia_u32)wb_blc[BAYER_CHN_B] << 16) + wb_blc[BAYER_CHN_GB]; /* bit16~30: b_blc */
}

static __inline XMEDIA_VOID isp_drv_fe_ae_offset_write(S_ISPFE_REGS_TYPE *fe_reg, xmedia_u16 *ae_blc)
{
    ISP_CHECK_POINTER_VOID(fe_reg);
    ISP_CHECK_POINTER_VOID(ae_blc);

    fe_reg->ISP_AE1_OFFSET_R_GR.u32 = ((xmedia_u32)ae_blc[BAYER_CHN_GR] << 16) + ae_blc[BAYER_CHN_R]; /* bit16~30:gr_blc */
    fe_reg->ISP_AE1_OFFSET_GB_B.u32 = ((xmedia_u32)ae_blc[BAYER_CHN_B] << 16) + ae_blc[BAYER_CHN_GB]; /* bit16~30:b_blc */
}

static __inline XMEDIA_VOID isp_drv_fe_blc_offset_write(S_ISPFE_REGS_TYPE *fe_reg, xmedia_u16 *fe_blc)
{
    ISP_CHECK_POINTER_VOID(fe_reg);
    ISP_CHECK_POINTER_VOID(fe_blc);

    fe_reg->ISP_BLC1_OFFSET1.u32 = ((xmedia_u32)fe_blc[BAYER_CHN_R] << 16) + fe_blc[BAYER_CHN_GR]; /* bit16~30: r_blc */
    fe_reg->ISP_BLC1_OFFSET2.u32 = ((xmedia_u32)fe_blc[BAYER_CHN_B] << 16) + fe_blc[BAYER_CHN_GB]; /* bit16~30: b_blc */
}

static __inline XMEDIA_VOID isp_drv_fe_rc_offset_write(S_ISPFE_REGS_TYPE *fe_reg, xmedia_u16 *rc_blc)
{
    ISP_CHECK_POINTER_VOID(fe_reg);
    ISP_CHECK_POINTER_VOID(rc_blc);

    fe_reg->ISP_RC_BLC0.u32 = ((xmedia_u32)rc_blc[BAYER_CHN_GR] << 16) + rc_blc[BAYER_CHN_R]; /* bit16~30: gr_blc */
    fe_reg->ISP_RC_BLC1.u32 = ((xmedia_u32)rc_blc[BAYER_CHN_GB] << 16) + rc_blc[BAYER_CHN_B]; /* bit16~30: gb_blc */
}

static __inline XMEDIA_VOID isp_drv_be_f0_4dg_offset_write(S_ISPBE_REGS_TYPE *be_reg, xmedia_u16 *f0_4dg_blc)
{
    ISP_CHECK_POINTER_VOID(be_reg);

    be_reg->ISP_4DG_0_BLC_OFFSET1.u32 = ((xmedia_u32)f0_4dg_blc[BAYER_CHN_R] << 16) + /* bit16~30: r_blc */
                                        f0_4dg_blc[BAYER_CHN_GR];

    be_reg->ISP_4DG_0_BLC_OFFSET2.u32 = ((xmedia_u32)f0_4dg_blc[BAYER_CHN_B] << 16) + /* bit16~30: b_blc */
                                        f0_4dg_blc[BAYER_CHN_GB];
}

static __inline XMEDIA_VOID isp_drv_be_f1_4dg_offset_write(S_ISPBE_REGS_TYPE *be_reg, xmedia_u16 *f1_4dg_blc)
{
    ISP_CHECK_POINTER_VOID(be_reg);

    be_reg->ISP_4DG_1_BLC_OFFSET1.u32 = ((xmedia_u32)f1_4dg_blc[BAYER_CHN_R] << 16) + /* bit16~30: r_blc */
                                        f1_4dg_blc[BAYER_CHN_GR];

    be_reg->ISP_4DG_1_BLC_OFFSET2.u32 = ((xmedia_u32)f1_4dg_blc[BAYER_CHN_B] << 16) + /* bit16~30: b_blc */
                                        f1_4dg_blc[BAYER_CHN_GB];
}

static __inline XMEDIA_VOID isp_drv_wdr_out_blc_write(S_ISPBE_REGS_TYPE *be_reg, xmedia_u16 out_blc)
{
...
static __inline XMEDIA_VOID isp_drv_be_f0_wdr_offset_write(S_ISPBE_REGS_TYPE *be_reg, xmedia_u16 *f0_wdr_blc)
{
    ISP_CHECK_POINTER_VOID(be_reg);

    be_reg->ISP_WDR_F0_INBLC0.u32 = ((xmedia_u32)f0_wdr_blc[BAYER_CHN_R] << 16) +  /* bit16~30: r_blc */
                                    f0_wdr_blc[BAYER_CHN_GR];

    be_reg->ISP_WDR_F0_INBLC1.u32 = ((xmedia_u32)f0_wdr_blc[BAYER_CHN_GB] << 16) + /* bit16~30: gb_blc */
                                    f0_wdr_blc[BAYER_CHN_B];
}

static __inline XMEDIA_VOID isp_drv_be_f1_wdr_offset_write(S_ISPBE_REGS_TYPE *be_reg, xmedia_u16 *f1_wdr_blc)
{
    ISP_CHECK_POINTER_VOID(be_reg);

    be_reg->ISP_WDR_F1_INBLC0.u32 = ((xmedia_u32)f1_wdr_blc[BAYER_CHN_R] << 16) +  /* bit16~30: r_blc */
                                    f1_wdr_blc[BAYER_CHN_GR];

    be_reg->ISP_WDR_F1_INBLC1.u32 = ((xmedia_u32)f1_wdr_blc[BAYER_CHN_GB] << 16) + /* bit16~30: gb_blc */
                                    f1_wdr_blc[BAYER_CHN_B];
}

static __inline XMEDIA_VOID isp_drv_be_bnr_rlmt_offset_write(S_ISPBE_REGS_TYPE *be_reg, xmedia_u16 bnr_rlmt_blc)
{
...
static __inline XMEDIA_VOID isp_drv_be_lsc_offset_write(S_ISPBE_REGS_TYPE *be_reg, xmedia_u16 *lsc_blc)
{
    ISP_CHECK_POINTER_VOID(be_reg);

    be_reg->ISP_LSC_BLC0.u32  = ((xmedia_u32)lsc_blc[BAYER_CHN_GR] << 16) + lsc_blc[BAYER_CHN_R]; /* bit16~30: gr_blc */
    be_reg->ISP_LSC_BLC1.u32  = ((xmedia_u32)lsc_blc[BAYER_CHN_GB] << 16) + lsc_blc[BAYER_CHN_B]; /* bit16~30: gb_blc */
}

static __inline XMEDIA_VOID isp_drv_be_dgain_offset_write(S_ISPBE_REGS_TYPE *be_reg, xmedia_u16 *dg_blc)
{
    ISP_CHECK_POINTER_VOID(be_reg);

    be_reg->ISP_DG_BLC_OFFSET1.u32  = ((xmedia_u32)dg_blc[BAYER_CHN_R] << 16) + dg_blc[BAYER_CHN_GR]; /* bit16~30: r_blc */
    be_reg->ISP_DG_BLC_OFFSET2.u32  = ((xmedia_u32)dg_blc[BAYER_CHN_B] << 16) + dg_blc[BAYER_CHN_GB]; /* bit16~30: b_blc */
}

static __inline XMEDIA_VOID isp_drv_be_ae_offset_write(S_ISPBE_REGS_TYPE *be_reg, xmedia_u16 *ae_blc)
{
    ISP_CHECK_POINTER_VOID(be_reg);

    be_reg->ISP_AE_OFFSET_R_GR.u32 = ((xmedia_u32)ae_blc[BAYER_CHN_GR] << 16) + ae_blc[BAYER_CHN_R]; /* bit16~30:gr_blc */
    be_reg->ISP_AE_OFFSET_GB_B.u32 = ((xmedia_u32)ae_blc[BAYER_CHN_B] << 16) + ae_blc[BAYER_CHN_GB]; /* bit16~30:b_blc */
}

static __inline XMEDIA_VOID isp_drv_be_la_offset_write(S_ISPBE_REGS_TYPE *be_reg, xmedia_u16 *la_blc)
{
    ISP_CHECK_POINTER_VOID(be_reg);
...
static __inline XMEDIA_VOID isp_drv_be_wb_offset_write(S_ISPBE_REGS_TYPE *be_reg, xmedia_u16 *wb_blc)
{
    ISP_CHECK_POINTER_VOID(be_reg);

    be_reg->ISP_WB_BLC_OFFSET1.u32  = ((xmedia_u32)wb_blc[BAYER_CHN_R] << 16) + wb_blc[BAYER_CHN_GR]; /* bit16~30: r_blc */
    be_reg->ISP_WB_BLC_OFFSET2.u32  = ((xmedia_u32)wb_blc[BAYER_CHN_B] << 16) + wb_blc[BAYER_CHN_GB]; /* bit16~30: b_blc */
}

static __inline XMEDIA_VOID isp_drv_be_rgbir_offset_write(S_ISPBE_REGS_TYPE *be_reg, xmedia_u16 *rgbir_blc)
{
    ISP_CHECK_POINTER_VOID(be_reg);
...
XMEDIA_S32 ISP_DRV_BeRemap(void)
{
    XMEDIA_U32 IspBePhyPipe = 0;

    for (IspBePhyPipe = 0; IspBePhyPipe < ISP_MAX_BE_NUM; IspBePhyPipe++) {
        reg_ispbe_base_va[IspBePhyPipe] = (void *)osal_ioremap(ISP_BE_REG_BASE(IspBePhyPipe), (XMEDIA_U32)VI_ISP_BE_REG_SIZE);

        if (reg_ispbe_base_va[IspBePhyPipe] == XMEDIA_NULL) {
            osal_printk("Remap ISP BE[%d] failed!\n", IspBePhyPipe);
            return XMEDIA_FAILURE;
        }

        reg_viproc_base_va[IspBePhyPipe] = (void *)osal_ioremap(ISP_VIPROC_REG_BASE(IspBePhyPipe), (XMEDIA_U32)VIPROC_REG_SIZE);
...
XMEDIA_VOID ISP_DRV_BeUnmap(void)
{
    XMEDIA_U32 IspBePhyPipe = 0;
...
XMEDIA_S32 ISP_DRV_VicapRemap(void)
{
    reg_vicap_base_va = (void *)osal_ioremap(CAP_REG_BASE, (XMEDIA_U32)CAP_REG_SIZE_ALIGN);

    if (reg_vicap_base_va == XMEDIA_NULL) {
...
XMEDIA_VOID ISP_DRV_VicapUnmap(void)
{
...
XMEDIA_S32 ISP_DRV_FeRemap(void)
{
    XMEDIA_U8   i;
    VI_PIPE ViPipe;

    for (ViPipe = 0; ViPipe < ISP_MAX_PHY_PIPE_NUM; ViPipe++) {
        reg_ispfe_base_va[ViPipe] = (void *)osal_ioremap(ISP_FE_REG_BASE(ViPipe), (XMEDIA_U32)VI_ISP_FE_REG_SIZE);

        if (reg_ispfe_base_va[ViPipe] == XMEDIA_NULL) {
            osal_printk("Remap ISP[%d] FE failed!\n", ViPipe);
            return XMEDIA_FAILURE;
        }

        reg_vicap_ch_base_va[ViPipe] = (void *)osal_ioremap(ISP_VICAP_CH_REG_BASE(ViPipe), (XMEDIA_U32)VICAP_CH_REG_SIZE_ALIGN);

        if (reg_vicap_ch_base_va[ViPipe] == XMEDIA_NULL) {
    ...
    for (ViPipe = 0; ViPipe < ISP_MAX_PIPE_NUM; ViPipe++) {
        ...
        g_astIspDrvCtx[ViPipe].stStitchAttr.bStitchEnable      = XMEDIA_FALSE;
        ...
        g_astIspDrvCtx[ViPipe].stSnapAttr.bLoadCCM         = XMEDIA_TRUE;
        g_astIspDrvCtx[ViPipe].stSnapAttr.stProParam.enOperationMode = OPERATION_MODE_AUTO;

        g_astIspDrvCtx[ViPipe].bRunOnceOk      = XMEDIA_FALSE;
        g_astIspDrvCtx[ViPipe].bRunOnceFlag    = XMEDIA_FALSE;
        g_astIspDrvCtx[ViPipe].bYUVRunOnceOk   = XMEDIA_FALSE;
        g_astIspDrvCtx[ViPipe].bYUVRunOnceFlag = XMEDIA_FALSE;
        g_astIspDrvCtx[ViPipe].pstUseNode      = XMEDIA_NULL;
        ...
        g_astIspDrvCtx[ViPipe].bEdge          = XMEDIA_FALSE;
        g_astIspDrvCtx[ViPipe].bVdStart       = XMEDIA_FALSE;
        g_astIspDrvCtx[ViPipe].bVdEnd         = XMEDIA_FALSE;
        g_astIspDrvCtx[ViPipe].bVdBeEnd       = XMEDIA_FALSE;
        g_astIspDrvCtx[ViPipe].bMemInit       = XMEDIA_FALSE;
        g_astIspDrvCtx[ViPipe].bIspInit       = XMEDIA_FALSE;
        g_astIspDrvCtx[ViPipe].bIspRunFlag    = XMEDIA_FALSE;
...
XMEDIA_VOID ISP_DRV_FeUnmap(void)
{
    VI_PIPE ViPipe;
...
XMEDIA_S32 ISP_DRV_GetViprocRegsAttr(VI_PIPE ViPipe, S_VIPROC_REGS_TYPE *apstViprocReg[], ISP_BE_REGS_ATTR_S *pstBlkAttr)
{
    XMEDIA_U8  k;
    XMEDIA_S8  s8BlockId = 0;
    XMEDIA_U8  u8BlkDev  = 0;
    XMEDIA_U8  u8BlkNum  = 1;
...
XMEDIA_S32 ISP_DRV_SetOnlineSttAddr(VI_PIPE ViPipe, XMEDIA_U64 u64PhyBaseAddr)
{
    XMEDIA_U8   k;
    XMEDIA_U8   u8BlkDev = 0;
    XMEDIA_U8   u8BlkNum = 1;
    XMEDIA_U32  s32Ret   = XMEDIA_SUCCESS;
    XMEDIA_U64  u64SttSize = 0;
    XMEDIA_U64  u64PhyAddr = 0;
...
XMEDIA_S32 ISP_DRV_SetFeSttAddr(VI_PIPE ViPipeBind, XMEDIA_U64 u64PhyAddr)
{
    S_ISP_VICAP_CH_REGS_TYPE *pstFeSttAddrReg = XMEDIA_NULL;
...
XMEDIA_S32 ISP_DRV_RegConfigChnSel(S_ISPBE_REGS_TYPE *apstBeReg[], ISP_DRV_CTX_S *pstDrvCtx, XMEDIA_U8 u8BlkNum, XMEDIA_U8 u8BlkDev)
{
    XMEDIA_U8   k;
...
XMEDIA_S32 ISP_DRV_RegConfigDe(VI_PIPE ViPipe, S_ISPBE_REGS_TYPE *apstBeReg[], ISP_SYNC_CFG_BUF_NODE_S *pstCfgNode)
{
    return XMEDIA_SUCCESS;
}

static XMEDIA_VOID isp_drv_online_be_blc_reg(S_ISPBE_REGS_TYPE *be_reg[], isp_be_blc_dyna_cfg *be_blc_reg_cfg,
                                         ISP_BE_REGS_ATTR_S *be_regs_attr)
{
    XMEDIA_U8 k, blk_dev, blk_num;
...
XMEDIA_S32 isp_drv_reg_config_be_blc(VI_PIPE vi_pipe, S_ISPBE_REGS_TYPE *be_reg[], ISP_DRV_CTX_S *drv_ctx,
                                 ISP_SYNC_CFG_BUF_NODE_S *cfg_node, ISP_BE_REGS_ATTR_S *be_regs_attr)
{
    ...
    if (cfg_node->be_blc_reg_cfg.bReshDyna != XMEDIA_TRUE) {
        return XMEDIA_SUCCESS;
    }
...
static XMEDIA_VOID isp_drv_set_fe_blc_reg(S_ISPFE_REGS_TYPE *fe_reg, isp_fe_blc_dyna_cfg *fe_blc_reg_cfg)
{
    ISP_CHECK_POINTER_VOID(fe_reg);
    ISP_CHECK_POINTER_VOID(fe_blc_reg_cfg);

    if (fe_blc_reg_cfg->bReshDyna == XMEDIA_TRUE) {
...
XMEDIA_S32 isp_drv_reg_config_fe_blc(VI_PIPE vi_pipe, ISP_DRV_CTX_S *drv_ctx)
{
    XMEDIA_U8 k, fe_cfg_node_idx, cfg_node_vc, chn_num_max;
    VI_PIPE vi_pipe_bind;
    S_ISPFE_REGS_TYPE     *fe_reg   = XMEDIA_NULL;
    ISP_SYNC_CFG_BUF_NODE_S *cfg_node = XMEDIA_NULL;

    ISP_CHECK_PIPE(vi_pipe);
    ISP_CHECK_VIR_PIPE(vi_pipe);
    ISP_CHECK_POINTER(drv_ctx);

    if (drv_ctx->stWDRAttr.bMastPipe == XMEDIA_FALSE) {
        return XMEDIA_SUCCESS;
    }
...
XMEDIA_S32 isp_drv_reg_config_be_regup(VI_PIPE vi_pipe)
{
    XMEDIA_U8   k;
    XMEDIA_U8   blk_dev, blk_num;
    XMEDIA_S32  ret;
    ISP_BE_REGS_ATTR_S be_regs_attr = {0};
    S_VIPROC_REGS_TYPE *viproc_reg[ISP_STRIPING_MAX_NUM] = { XMEDIA_NULL };
    ...
    for (k = 0; k < blk_num; k++) {
        viproc_reg[k + blk_dev]->VIPROC_ISPBE_REGUP.bits.ispbe_reg_up = XMEDIA_TRUE;
    }

    return XMEDIA_SUCCESS;
}

XMEDIA_S32 ISP_DRV_RegConfigWdr(VI_PIPE ViPipe, S_ISPBE_REGS_TYPE *apstBeReg[], ISP_DRV_CTX_S *pstDrvCtx, ISP_FSWDR_SYNC_CFG_S *pstWDRRegCfg, XMEDIA_U8 u8BlkNum, XMEDIA_U8 u8BlkDev, XMEDIA_U32 *u32Ratio)
{
    XMEDIA_U8   k;
    XMEDIA_U8   u8LFMode          = 0;
    XMEDIA_U32  au32ExpoValue[3]  = {0};
    XMEDIA_U32  au32BlcComp[3]    = {0};
    XMEDIA_S32  u32MaxRatio       = 0;
    XMEDIA_U16  u16LongThr        = 0xFFF;
    XMEDIA_U16  u16ShortThr       = 0xFFF;
    XMEDIA_BOOL bWDRMdtEn         = 0;
...
XMEDIA_S32 ISP_DRV_RegConfigLdci(S_ISPBE_REGS_TYPE *apstBeReg[], ISP_DRV_CTX_S *pstDrvCtx, XMEDIA_U8 u8BlkNum, XMEDIA_U8 u8BlkDev)
{
    XMEDIA_U8   k;
    XMEDIA_U32  u32LdciComp = 0x1000;
    XMEDIA_U32  u32LdciCompIndex = 2;
...
XMEDIA_S32 ISP_DRV_RegConfigDrc(VI_PIPE ViPipe, S_ISPBE_REGS_TYPE *apstBeReg[], ISP_DRV_CTX_S *pstDrvCtx, ISP_DRC_REG_CFG_2_S *pstDRCRegCfg, XMEDIA_U8 u8BlkNum, XMEDIA_U8 u8BlkDev, XMEDIA_U32 *u32Ratio)
{
    XMEDIA_U8  i, k;
    XMEDIA_U8  u8CfgDlyMax;
    XMEDIA_U32 u32DrcDivDenomLog;
    XMEDIA_U32 u32DrcDenomExp;
    XMEDIA_U32 u32DrcExpRatio = 0x1000;
    XMEDIA_U32 au32DrcPrevLuma[SYNC_DRC_PRELUMA_NUM] = {0};
    XMEDIA_BOOL bUpdateLogParam = XMEDIA_FALSE;

    XMEDIA_U32 au32DrcDivDenomLog[16] = {
        52429, 55188,  58254,  61681,  65536,  69905,  74898, 80659, \
        87379, 95319, 104843, 116472, 130980, 149557, 174114, 207870
    };

    XMEDIA_U32 au32DrcDenomExp[16] = {
        1310720, 1245184, 1179648, 1114113, 1048577, 983043, 917510, 851980, \
        786455,  720942,  655452,  590008,  524657, 459488, 394682, 330589
    };

    static XMEDIA_U8 u8DrcShpLog[ISP_MAX_PIPE_NUM][ISP_STRIPING_MAX_NUM] = \
    {[0 ... ISP_MAX_PIPE_NUM - 1] = {8, 8}};
    static XMEDIA_U8 u8DrcShpExp[ISP_MAX_PIPE_NUM][ISP_STRIPING_MAX_NUM] = \
    {[0 ... ISP_MAX_PIPE_NUM - 1] = {8, 8}};
    ...
    if (u8DrcShpLog[ViPipe][u8BlkDev] != pstDRCRegCfg->u8ShpLog ||  \
        ...
        u8DrcShpExp[ViPipe][u8BlkDev] = pstDRCRegCfg->u8ShpExp;
        bUpdateLogParam = XMEDIA_TRUE;
    } else {
        bUpdateLogParam = XMEDIA_FALSE;
    }
    ...
    if (bUpdateLogParam && (!pstDRCRegCfg->bIsOfflineRepeatMode)) {
        for (i = 0; i < SYNC_DRC_PRELUMA_NUM - 1; i++) {
            au32DrcPrevLuma[i] = (XMEDIA_U32)((XMEDIA_S32)g_DrcCurLumaLut[u8DrcShpLog[ViPipe][u8BlkDev]][i] + pstDRCRegCfg->as32PrevLumaDelta[i]);
        }
    } else {
        for (i = 0; i < SYNC_DRC_PRELUMA_NUM - 1; i++) {
    ...
    if ((u32DrcExpRatio != 0x1000) && (!pstDRCRegCfg->bIsOfflineRepeatMode)) {
        for (i = 0; i < SYNC_DRC_PRELUMA_NUM; i++) {
            au32DrcPrevLuma[i] = (XMEDIA_U32)(((XMEDIA_U64)u32DrcExpRatio * au32DrcPrevLuma[i]) >> DRC_COMP_SHIFT);
        }
    }
...
XMEDIA_S32 ISP_DRV_RegConfigDgain(S_ISPBE_REGS_TYPE *apstBeReg[], XMEDIA_U32  u32IspDgain, XMEDIA_U8 u8BlkNum, XMEDIA_U8 u8BlkDev)
{
    XMEDIA_U8 k;
...
XMEDIA_S32 ISP_DRV_ConfigCCM(ISP_DRV_CTX_S *pstDrvCtx, XMEDIA_U16 *au16CCM)
{
    XMEDIA_U8 i;
...
XMEDIA_S32 ISP_DRV_RegConfig4Dgain(VI_PIPE ViPipe, S_ISPBE_REGS_TYPE *apstBeReg[], ISP_DRV_CTX_S *pstDrvCtx, XMEDIA_U32 *au32WDRGain, XMEDIA_U8 u8BlkNum, XMEDIA_U8 u8BlkDev, XMEDIA_U32 *au32WDRWBGain, XMEDIA_U32 *au32WBViGain)
{
...
XMEDIA_S32 ISP_DRV_FE_AE_Global_StatisticsRead(ISP_STAT_S *pstStat, S_ISP_FE_STT_REGS_TYPE *pstFeSttReg, XMEDIA_U32 k)
{
    XMEDIA_S32 i, j;
...
XMEDIA_S32 ISP_DRV_FE_AE_Local_StatisticsRead(ISP_STAT_S *pstStat, S_ISP_FE_STT_REGS_TYPE *pstFeSttReg, XMEDIA_U32 k)
{
    return XMEDIA_SUCCESS;
}

XMEDIA_S32 ISP_DRV_FE_APB_StatisticsRead(ISP_STAT_S *pstStat, S_ISPFE_REGS_TYPE *pstFeReg, VI_PIPE ViPipeBind, XMEDIA_U32 k, ISP_STAT_KEY_U unStatkey)
{
    ISP_CHECK_POINTER(pstStat);
...
XMEDIA_S32 ISP_DRV_FE_AE_STT_StatisticsRead(ISP_STAT_S *pstStat, S_ISP_FE_STT_REGS_TYPE *pstFeSttReg, XMEDIA_U32 k)
{
    XMEDIA_S32 i, j;
    XMEDIA_U32 u32AveMem = 0;
    ...
    for (i = 0; i < AE_ZONE_ROW; i++) {
        for (j = 0; j < AE_ZONE_COLUMN; j++) {
            pstStat->stFEAeStat3.au16ZoneAvg[k][i][j][0] = (XMEDIA_U16)((u32AveMem & 0xFFFF0000) >> 16);
            pstStat->stFEAeStat3.au16ZoneAvg[k][i][j][1] = (XMEDIA_U16)((u32AveMem & 0xFFFF));

            pstStat->stFEAeStat3.au16ZoneAvg[k][i][j][2] = (XMEDIA_U16)((u32AveMem & 0xFFFF0000) >> 16);
            pstStat->stFEAeStat3.au16ZoneAvg[k][i][j][3] = (XMEDIA_U16)((u32AveMem & 0xFFFF));
        }
    }
...
XMEDIA_S32 ISP_DRV_FE_AF_STT_StatisticsRead(ISP_STAT_S *pstStat, S_ISPFE_REGS_TYPE *pstFeReg, S_ISP_FE_STT_REGS_TYPE *pstFeSttReg, VI_PIPE ViPipeBind, XMEDIA_U32 k)
{
    return XMEDIA_SUCCESS;
}

XMEDIA_S32 ISP_DRV_FE_SwitchSttAddr(VI_PIPE ViPipeBind, XMEDIA_U8 u8WdrIndex, ISP_DRV_CTX_S *pstDrvCtx)
{
    ...
    if (pstDrvCtx->stFeSttAttr.stFeSttBuf[u8WdrIndex].bFirstFrame == XMEDIA_TRUE) {
        ...
        u32CurReadFlag = 1;
        pstDrvCtx->stFeSttAttr.stFeSttBuf[u8WdrIndex].bFirstFrame = XMEDIA_FALSE;
    }
...
XMEDIA_S32 ISP_DRV_FE_STT_StatisticsRead(ISP_STAT_S *pstStat, S_ISPFE_REGS_TYPE *pstFeReg, ISP_DRV_CTX_S *pstDrvCtx, VI_PIPE ViPipeBind, XMEDIA_U32 k, ISP_STAT_KEY_U unStatkey)
{
    XMEDIA_S32 s32Ret;
    XMEDIA_U32 u32CurReadFlag;
    S_ISP_FE_STT_REGS_TYPE *pstFeSttReg = XMEDIA_NULL;
...
XMEDIA_S32  ISP_DRV_FE_StitchStatisticsRead(VI_PIPE ViPipe, ISP_STAT_INFO_S *pstStatInfo)
{
    return XMEDIA_SUCCESS;
}

/* read BE statistics information from phy:online */
XMEDIA_S32 ISP_DRV_BE_COMM_StatisticsRead(ISP_STAT_S *pstStat, S_ISPBE_REGS_TYPE *apstBeReg[], XMEDIA_U8 u8BlkDev)
{
    ISP_CHECK_POINTER(pstStat);
...
XMEDIA_S32 ISP_DRV_BE_AE_STT_StatisticsRead(ISP_STAT_S *pstStat, S_ISP_ONLINE_STT_REGS_TYPE *apstBeOnlineStt[], XMEDIA_U8 u8BlkNum, XMEDIA_U8 u8BlkDev)
{
    XMEDIA_U8  k;
    XMEDIA_U8  u8BlockOffset    = 0;
    XMEDIA_U8  u8BlockZoneWidth = 0;
    XMEDIA_U32 i, j;
    XMEDIA_U32 u32AveMem;
    ...
    for (k = 0; k < u8BlkNum; k++) {
        ...
        for (i = 0; i < AE_ZONE_ROW; i++) {
            ...
            for (j = 0; j < u8BlockZoneWidth; j++) {
                ...
                pstStat->stBEAeStat3.au16ZoneAvg[i][j + u8BlockOffset][0] = (XMEDIA_U16)((u32AveMem & 0xFFFF0000) >> 16);
                pstStat->stBEAeStat3.au16ZoneAvg[i][j + u8BlockOffset][1] = (XMEDIA_U16)((u32AveMem & 0xFFFF));

                u32AveMem = apstBeOnlineStt[k + u8BlkDev]->ISP_AE_AVER_GB_B[i * u8BlockZoneWidth + j].u32;
                pstStat->stBEAeStat3.au16ZoneAvg[i][j + u8BlockOffset][2] = (XMEDIA_U16)((u32AveMem & 0xFFFF0000) >> 16);
                pstStat->stBEAeStat3.au16ZoneAvg[i][j + u8BlockOffset][3] = (XMEDIA_U16)((u32AveMem & 0xFFFF));
            }
        }
...
XMEDIA_S32 ISP_DRV_BE_AE_STT_GlobalStatisticsRead(ISP_STAT_S *pstStat, S_ISP_ONLINE_STT_REGS_TYPE *apstBeOnlineStt[], XMEDIA_U8 u8BlkNum, XMEDIA_U8 u8BlkDev)
{
    XMEDIA_U32 i, k;
...
XMEDIA_S32 ISP_DRV_BE_AE_STT_LocalStatisticsRead(ISP_STAT_S *pstStat, S_ISP_ONLINE_STT_REGS_TYPE *apstBeOnlineStt[], XMEDIA_U8 u8BlkNum, XMEDIA_U8 u8BlkDev)
{
    XMEDIA_U32 i, j, k;
    XMEDIA_U8  u8BlockOffset    = 0;
    XMEDIA_U8  u8BlockZoneWidth = 0;
...
XMEDIA_S32 ISP_DRV_BE_MG_STT_StatisticsRead(ISP_STAT_S *pstStat, S_ISP_ONLINE_STT_REGS_TYPE *apstBeOnlineStt[], XMEDIA_U8 u8BlkNum, XMEDIA_U8 u8BlkDev)
{
    XMEDIA_U8  k;
    XMEDIA_U8  u8BlockOffset     = 0;
    XMEDIA_U8  u8BlockZoneWidth  = 0;
    ...
    for (k = 0; k < u8BlkNum; k++) {
        ...
        for (i = 0; i < MG_ZONE_ROW; i++) {
            ...
            for (j = 0; j < u8BlockZoneWidth; j++) {
                ...
                pstStat->stMgStat.au16ZoneAvg[i][j + u8BlockOffset][0] = (XMEDIA_U16)((u32AveMem & 0xFF000000) >> 24);
                pstStat->stMgStat.au16ZoneAvg[i][j + u8BlockOffset][1] = (XMEDIA_U16)((u32AveMem & 0xFF0000) >> 16);
                pstStat->stMgStat.au16ZoneAvg[i][j + u8BlockOffset][2] = (XMEDIA_U16)((u32AveMem & 0xFF00) >> 8);
                pstStat->stMgStat.au16ZoneAvg[i][j + u8BlockOffset][3] = (XMEDIA_U16)((u32AveMem & 0xFF));
            }
        }
...
XMEDIA_S32 ISP_DRV_BE_AWB_STT_StatisticsRead(ISP_STAT_S *pstStat, S_ISPBE_REGS_TYPE *apstBeReg[], S_ISP_ONLINE_STT_REGS_TYPE *apstBeOnlineStt[], XMEDIA_U8 u8BlkNum, XMEDIA_U8 u8BlkDev)
{
    XMEDIA_S32 i, j, k;
    XMEDIA_U8  u8BlockOffset = 0;
    XMEDIA_U32 u32Value;
    XMEDIA_U32 u32Zone;
    XMEDIA_U32 u32Col, u32Row;
    XMEDIA_U32 u32ZoneBin = 1;
    XMEDIA_U32 u32WholeCol = 0;
    XMEDIA_U16 RgainConv = 0x100;
    XMEDIA_U16 GgainConv = 0x100;
    XMEDIA_U16 BgainConv = 0x100;
    ...
    for (k = 0; k < u8BlkNum; k++) {
        XMEDIA_U8 AWBSwitch = 0;
        XMEDIA_U32 WbGainBfStat[ISP_BAYER_CHN_NUM] = {0x100, 0x100, 0x100, 0x100};
        XMEDIA_U32 MinGain, NormGain;
        ISP_CHECK_POINTER(apstBeOnlineStt[k + u8BlkDev]);
        ISP_CHECK_POINTER(apstBeReg[k + u8BlkDev]);
        u32Zone = apstBeReg[k + u8BlkDev]->ISP_AWB_ZONE.u32;
        ...
        for (i = 0; i < u32Row; i++) {
            for (j = 0; j < u32Col; j++) {
                XMEDIA_U16 u16WStartAddr = (i * u32WholeCol + j + u8BlockOffset) * u32ZoneBin;
                XMEDIA_U16 u16RStartAddr = (i * u32WholeCol + j) * u32ZoneBin * 2;
                XMEDIA_U16 m;

                for (m = 0; m < u32ZoneBin; m++) {
                    XMEDIA_U16 ReadRAvg, ReadGAvg, ReadBAvg;
...
XMEDIA_S32 ISP_DRV_BE_AF_STT_StatisticsRead(ISP_STAT_S *pstStat, S_ISP_ONLINE_STT_REGS_TYPE *apstBeOnlineStt[], XMEDIA_U8 u8BlkDev, XMEDIA_U32 u32Zone)
{
#ifdef CONFIG_ISP_AF_SUPPORT
    XMEDIA_U32 i, j;
    XMEDIA_U32 u32BEAfStatData = 0;
    XMEDIA_U32 u32Col = (u32Zone & 0x1F);
    XMEDIA_U32 u32Row = ((u32Zone & 0x1F00) >> 8);
    ...
    for (i = 0; i < u32Row; i++) {
        for (j = 0; j < u32Col; j++) {
            ...
            pstStat->stBEAfStat.stZoneMetrics[i][j].u16v1    = (XMEDIA_U16)((0xFFFF0000 & u32BEAfStatData) >> 16);
            pstStat->stBEAfStat.stZoneMetrics[i][j].u16h1    = (XMEDIA_U16)(0xFFFF & u32BEAfStatData);
            u32BEAfStatData = apstBeOnlineStt[u8BlkDev]->ISP_AF_STAT[(i * u32Col + j) * 4 + 1].u32;
            pstStat->stBEAfStat.stZoneMetrics[i][j].u16v2    = (XMEDIA_U16)((0xFFFF0000 & u32BEAfStatData) >> 16);
            pstStat->stBEAfStat.stZoneMetrics[i][j].u16h2    = (XMEDIA_U16)(0xFFFF & u32BEAfStatData);
            u32BEAfStatData = apstBeOnlineStt[u8BlkDev]->ISP_AF_STAT[(i * u32Col + j) * 4 + 2].u32;
            pstStat->stBEAfStat.stZoneMetrics[i][j].u16HlCnt = (XMEDIA_U16)((0xFFFF0000 & u32BEAfStatData) >> 16);
            pstStat->stBEAfStat.stZoneMetrics[i][j].u16y     = (XMEDIA_U16)(0xFFFF & u32BEAfStatData);
        }
    }
#endif
    return XMEDIA_SUCCESS;
...
XMEDIA_S32 ISP_DRV_BE_DEHAZE_STT_StatisticsRead(ISP_STAT_S *pstStat, S_ISP_ONLINE_STT_REGS_TYPE *apstBeOnlineStt[], XMEDIA_U8 u8BlkNum, XMEDIA_U8 u8BlkDev)
{
    XMEDIA_U32 i, j, m;
...
XMEDIA_S32 ISP_DRV_BE_FLICKER_STT_StatisticsRead(ISP_STAT_S *pstStat, S_ISP_ONLINE_STT_REGS_TYPE *apstBeOnlineStt[], XMEDIA_U8 u8BlkNum, XMEDIA_U8 u8BlkDev)
{

    return XMEDIA_SUCCESS;
}

XMEDIA_S32 ISP_DRV_BE_APB_StatisticsRead(ISP_STAT_S *pstStat, S_ISPBE_REGS_TYPE *apstBeReg[], XMEDIA_U8 u8BlkNum, XMEDIA_U8 u8BlkDev, ISP_STAT_KEY_U unStatkey)
{
    XMEDIA_U8 k = 0;
    /* AE */
    XMEDIA_U32 u32PixelWeight    = 0;
    XMEDIA_U32 u32PixelWeightTmp = 0;
    XMEDIA_U64 u64GlobalAvgSumR  = 0;
    XMEDIA_U64 u64GlobalAvgSumGr = 0;
    XMEDIA_U64 u64GlobalAvgSumGb = 0;
    XMEDIA_U64 u64GlobalAvgSumB  = 0;
    /* AWB */
    XMEDIA_U64 u64MeteringAwbAvgR = 0;
    XMEDIA_U64 u64MeteringAwbAvgG = 0;
    XMEDIA_U64 u64MeteringAwbAvgB = 0;
    XMEDIA_U32 u32MeteringAwbCountAll = 0;
    ...
    if (unStatkey.bit1BEAeGloStat) {
        for (k = 0; k < u8BlkNum; k++) {
            ...
            u64GlobalAvgSumR  += ((XMEDIA_U64)apstBeReg[k + u8BlkDev]->ISP_AE_TOTAL_R_AVER.u32)  * ((XMEDIA_U64)u32PixelWeightTmp);
            u64GlobalAvgSumGr += ((XMEDIA_U64)apstBeReg[k + u8BlkDev]->ISP_AE_TOTAL_GR_AVER.u32) * ((XMEDIA_U64)u32PixelWeightTmp);
            u64GlobalAvgSumGb += ((XMEDIA_U64)apstBeReg[k + u8BlkDev]->ISP_AE_TOTAL_GB_AVER.u32) * ((XMEDIA_U64)u32PixelWeightTmp);
            u64GlobalAvgSumB  += ((XMEDIA_U64)apstBeReg[k + u8BlkDev]->ISP_AE_TOTAL_B_AVER.u32)  * ((XMEDIA_U64)u32PixelWeightTmp);
        }
    ...
    if (unStatkey.bit1AwbStat1) {
        for (k = 0; k < u8BlkNum; k++) {
            ISP_CHECK_POINTER(apstBeReg[k + u8BlkDev]);
            u64MeteringAwbAvgR += (XMEDIA_U64)apstBeReg[k + u8BlkDev]->ISP_AWB_AVG_R.bits.isp_awb_avg_r * apstBeReg[k + u8BlkDev]->ISP_AWB_CNT_ALL.bits.isp_awb_count_all;
            u64MeteringAwbAvgG += (XMEDIA_U64)apstBeReg[k + u8BlkDev]->ISP_AWB_AVG_G.bits.isp_awb_avg_g * apstBeReg[k + u8BlkDev]->ISP_AWB_CNT_ALL.bits.isp_awb_count_all;
            u64MeteringAwbAvgB += (XMEDIA_U64)apstBeReg[k + u8BlkDev]->ISP_AWB_AVG_B.bits.isp_awb_avg_b * apstBeReg[k + u8BlkDev]->ISP_AWB_CNT_ALL.bits.isp_awb_count_all;
            u32MeteringAwbCountAll += apstBeReg[k + u8BlkDev]->ISP_AWB_CNT_ALL.bits.isp_awb_count_all;
        }

        pstStat->stAwbStat1.u16MeteringAwbAvgR = (XMEDIA_U16)(osal_div_u64(u64MeteringAwbAvgR, DIV_0_TO_1(u32MeteringAwbCountAll)));
        pstStat->stAwbStat1.u16MeteringAwbAvgG = (XMEDIA_U16)(osal_div_u64(u64MeteringAwbAvgG, DIV_0_TO_1(u32MeteringAwbCountAll)));
        pstStat->stAwbStat1.u16MeteringAwbAvgB = (XMEDIA_U16)(osal_div_u64(u64MeteringAwbAvgB, DIV_0_TO_1(u32MeteringAwbCountAll)));
        pstStat->stAwbStat1.u16MeteringAwbCountAll = (XMEDIA_U16)(u32MeteringAwbCountAll / DIV_0_TO_1(u8BlkNum));
    }

    return XMEDIA_SUCCESS;
}

XMEDIA_S32 ISP_DRV_BE_STT_StatisticsRead(VI_PIPE ViPipe, ISP_STAT_S *pstStat, S_ISPBE_REGS_TYPE *apstBeReg[], XMEDIA_U8 u8BlkNum, XMEDIA_U8 u8BlkDev, ISP_STAT_KEY_U unStatkey)
{
    XMEDIA_U8  k;
    XMEDIA_U32 u32CurReadFlag;
    ISP_DRV_CTX_S *pstDrvCtx = XMEDIA_NULL;
    ISP_BE_RW_ONLINE_STT_REG_S *pstBeOnlineSttReg = XMEDIA_NULL;
    S_ISP_ONLINE_STT_REGS_TYPE *apstBeOnlineStt[ISP_MAX_BE_NUM] = { XMEDIA_NULL };
    XMEDIA_VOID *pVirAddr = XMEDIA_NULL;
    ...
    if(pstDrvCtx->stBeOnlineSttBuf.bDrvGetFirtStatInfoFlag == XMEDIA_FALSE) {
        ...
        u32CurReadFlag = 1;
        pstDrvCtx->stBeOnlineSttBuf.bDrvGetFirtStatInfoFlag = XMEDIA_TRUE;
    }
...
XMEDIA_S32 ISP_DRV_BE_AE_OfflineStatisticsRead(ISP_STAT_S *pstStat, S_ISP_STT_REGS_TYPE *apstBeStt[],
                                           XMEDIA_U8 u8BlkNum)
{
    XMEDIA_U8  k;
    XMEDIA_U8  u8BlockOffset    = 0;
    ...
    for (k = 0; k < u8BlkNum; k++) {
        ...
        u64GlobalAvgSumR  += ((XMEDIA_U64)apstBeStt[k]->ISP_AE_TOTAL_R_AVER_RSTT.u32)  * ((XMEDIA_U64)u32PixelWeightTmp);
        u64GlobalAvgSumGr += ((XMEDIA_U64)apstBeStt[k]->ISP_AE_TOTAL_GR_AVER_RSTT.u32) * ((XMEDIA_U64)u32PixelWeightTmp);
        u64GlobalAvgSumGb += ((XMEDIA_U64)apstBeStt[k]->ISP_AE_TOTAL_GB_AVER_RSTT.u32) * ((XMEDIA_U64)u32PixelWeightTmp);
        u64GlobalAvgSumB  += ((XMEDIA_U64)apstBeStt[k]->ISP_AE_TOTAL_B_AVER_RSTT.u32)  * ((XMEDIA_U64)u32PixelWeightTmp);
...
XMEDIA_S32 ISP_DRV_BE_AE_Global_OfflineStatisticsRead(ISP_STAT_S *pstStat, S_ISP_STT_REGS_TYPE *apstBeStt[], XMEDIA_U8 u8BlkNum)
{
    XMEDIA_U32 i, k;
    XMEDIA_U64 u64GlobalAvgSumR  = 0;
    XMEDIA_U64 u64GlobalAvgSumGr = 0;
...
XMEDIA_S32 ISP_DRV_BE_AE_Local_OfflineStatisticsRead(ISP_STAT_S *pstStat, S_ISP_STT_REGS_TYPE *apstBeStt[], XMEDIA_U8 u8BlkNum)
{
    XMEDIA_U32 i, j, k;
    XMEDIA_U8  u8BlockOffset    = 0;
    XMEDIA_U8  u8BlockZoneWidth = 0;
...
XMEDIA_S32 ISP_DRV_BE_MG_OfflineStatisticsRead(ISP_STAT_S *pstStat, S_ISP_STT_REGS_TYPE *apstBeStt[], XMEDIA_U8 u8BlkNum)
{
    XMEDIA_U8  k;
    XMEDIA_U8  u8BlockOffset    = 0;
    XMEDIA_U8  u8BlockZoneWidth = 0;
...
XMEDIA_S32 ISP_DRV_BE_AWB_OfflineStatisticsRead(VI_PIPE ViPipe, ISP_STAT_S *pstStat,  S_ISP_STT_REGS_TYPE *apstBeStt[], XMEDIA_U8 u8BlkNum, XMEDIA_U8 u8BlkDev, ISP_STAT_KEY_U unStatkey)
{
    XMEDIA_S32 i, j, k;
    XMEDIA_U8  u8BlockOffset    = 0;
    XMEDIA_U8  u8BlockZoneWidth = 0;
    ...
    XMEDIA_U32 u32Col, u32Row;
    ISP_DRV_CTX_S *pstDrvCtx = XMEDIA_NULL;
    ISP_SYNC_CFG_BUF_NODE_S *pstNode = XMEDIA_NULL;
    XMEDIA_U32 WbGainBfStat[ISP_BAYER_CHN_NUM] = {0x100, 0x100, 0x100, 0x100};
    XMEDIA_U16 RgainConv = 0x100;
    XMEDIA_U16 GgainConv = 0x100;
    XMEDIA_U16 BgainConv = 0x100;
    ...
    for (k = 0; k < u8BlkNum; k++) {
        ...
        if (unStatkey.bit1AwbStat1) {
            u64MeteringAwbAvgR += (XMEDIA_U64)apstBeStt[k]->ISP_AWB_AVG_R_RSTT.bits.isp_awb_avg_r_stt *
                                  apstBeStt[k]->ISP_AWB_CNT_ALL_RSTT.bits.isp_awb_count_all_stt;
            u64MeteringAwbAvgG += (XMEDIA_U64)apstBeStt[k]->ISP_AWB_AVG_G_RSTT.bits.isp_awb_avg_g_stt *
                                  apstBeStt[k]->ISP_AWB_CNT_ALL_RSTT.bits.isp_awb_count_all_stt;
            u64MeteringAwbAvgB += (XMEDIA_U64)apstBeStt[k]->ISP_AWB_AVG_B_RSTT.bits.isp_awb_avg_b_stt *
                                  apstBeStt[k]->ISP_AWB_CNT_ALL_RSTT.bits.isp_awb_count_all_stt;
...
XMEDIA_S32 ISP_DRV_BE_AF_OfflineStatisticsRead(VI_PIPE ViPipe, ISP_STAT_S *pstStat, S_ISP_STT_REGS_TYPE *apstBeStt[], XMEDIA_U8 u8BlkNum)
{
#ifdef CONFIG_ISP_AF_SUPPORT
    XMEDIA_U8  k;
    XMEDIA_U8  u8ColIndex    = 0;
    XMEDIA_U8  u8BlockOffset = 0;
    XMEDIA_U32 i, j;
    XMEDIA_U32 u32Col;
    XMEDIA_U32 u32Row;
    ...
    for (k = 0; k < u8BlkNum; k++) {
        ...
        for (i = 0; i < u32Row; i++) {
            for (j = 0; j < u32Col; j++) {
                ...
                pstStat->stBEAfStat.stZoneMetrics[i][u8ColIndex].u16v1 = (XMEDIA_U16)((0xFFFF0000 & u32BEAfStatData) >> 16);
                pstStat->stBEAfStat.stZoneMetrics[i][u8ColIndex].u16h1 = (XMEDIA_U16)(0xFFFF & u32BEAfStatData);
                u32BEAfStatData = apstBeStt[k]->ISP_AF_STAT[(i * u32Col + j) * 4 + 1].u32;
                pstStat->stBEAfStat.stZoneMetrics[i][u8ColIndex].u16v2 = (XMEDIA_U16)((0xFFFF0000 & u32BEAfStatData) >> 16);
                pstStat->stBEAfStat.stZoneMetrics[i][u8ColIndex].u16h2 = (XMEDIA_U16)(0xFFFF & u32BEAfStatData);
                u32BEAfStatData = apstBeStt[k]->ISP_AF_STAT[(i * u32Col + j) * 4 + 2].u32;
                pstStat->stBEAfStat.stZoneMetrics[i][u8ColIndex].u16HlCnt = (XMEDIA_U16)((0xFFFF0000 & u32BEAfStatData) >> 16);
                pstStat->stBEAfStat.stZoneMetrics[i][u8ColIndex].u16y     = (XMEDIA_U16)(0xFFFF & u32BEAfStatData);
            }
        }
...
XMEDIA_S32 ISP_DRV_BE_Dehaze_OfflineStatisticsRead(ISP_STAT_S *pstStat, S_ISP_STT_REGS_TYPE *apstBeStt[], XMEDIA_U8 u8BlkNum)
{
    XMEDIA_U32 i, j, m;
...
XMEDIA_S32 ISP_DRV_DPC_OfflineCalibInfoRead(ISP_STAT_S *pstStat, S_ISP_STT_REGS_TYPE *apstBeStt[], XMEDIA_U8 u8BlkNum)
{

    return XMEDIA_SUCCESS;
}

XMEDIA_S32 ISP_DRV_Flicker_OfflineStatisticsRead(ISP_STAT_S *pstStat, S_ISP_STT_REGS_TYPE *apstBeStt[], XMEDIA_U8 u8BlkNum)
{

    return XMEDIA_SUCCESS;
}

XMEDIA_S32 ISP_DRV_LDCI_OfflineStatisticsRead(VI_PIPE ViPipe, ISP_STAT_S *pstStat)
{
    ISP_DRV_CTX_S *pstDrvCtx = XMEDIA_NULL;
...
XMEDIA_S32 ISP_DRV_BeOfflineAEStitchGlobalStatisticsRead(ISP_STAT_S *pstStat, ISP_DRV_CTX_S *pstDrvCtx)
{
    return XMEDIA_SUCCESS;
}

XMEDIA_S32 ISP_DRV_BeOfflineAEStitchLocalStatisticsRead(ISP_STAT_S *pstStat, ISP_DRV_CTX_S *pstDrvCtx)
{
    return XMEDIA_SUCCESS;
}

XMEDIA_S32 ISP_DRV_BeOfflineAWBStitchStatisticsRead(ISP_STAT_S *pstStat, S_ISPBE_REGS_TYPE *apstBeReg[], ISP_DRV_CTX_S *pstDrvCtx, XMEDIA_U8 u8BlkDev, ISP_STAT_KEY_U unStatkey)
{
    return XMEDIA_SUCCESS;
}

XMEDIA_S32 ISP_DRV_BE_StitchStatisticsRead(VI_PIPE ViPipe, ISP_STAT_INFO_S *pstStatInfo)
{
    return XMEDIA_SUCCESS;
}

XMEDIA_S32 ISP_DRV_FE_StitchNonStatisticsRead(VI_PIPE ViPipe, ISP_STAT_INFO_S *pstStatInfo)
{
    return XMEDIA_SUCCESS;
}

XMEDIA_S32 ISP_DRV_BeLutSttBufInit(VI_PIPE ViPipe)
{
    XMEDIA_U32 i;
    XMEDIA_S32 s32Ret;
    ...
    s32Ret = CMPI_MmzMallocNocache(XMEDIA_NULL, acName, &u64PhyAddr, (XMEDIA_VOID **)&pu8VirAddr, u64Size * 2 * ISP_MAX_BE_NUM);
    ...
    pstDrvCtx->stBeLut2SttAttr.bInit = XMEDIA_TRUE;

    for (i = 0; i < ISP_MAX_BE_NUM; i++) {
        pstDrvCtx->stBeLut2SttAttr.astBeLutSttBuf[i].astLutSttBuf[0].u64PhyAddr = u64PhyAddr + 2 * i * u64Size;
        pstDrvCtx->stBeLut2SttAttr.astBeLutSttBuf[i].astLutSttBuf[0].pVirAddr   = (XMEDIA_VOID *)(pu8VirAddr + 2 * i * u64Size);
        ...
        pstDrvCtx->stBeLut2SttAttr.astBeLutSttBuf[i].astLutSttBuf[1].pVirAddr   = (XMEDIA_VOID *)(pu8VirAddr + (2 * i + 1) * u64Size);
...
XMEDIA_S32 ISP_DRV_BeLutSttBufExit(VI_PIPE ViPipe)
{
    XMEDIA_U32 i;
    ...
    pstDrvCtx->stBeLut2SttAttr.bInit = XMEDIA_FALSE;
    ...
    for (i = 0; i < ISP_MAX_BE_NUM; i++) {
        ...
        pstDrvCtx->stBeLut2SttAttr.astBeLutSttBuf[i].astLutSttBuf[0].pVirAddr   = XMEDIA_NULL;
        ...
        pstDrvCtx->stBeLut2SttAttr.astBeLutSttBuf[i].astLutSttBuf[1].pVirAddr   = XMEDIA_NULL;
    }
...
XMEDIA_S32 ISP_DRV_BeOnlineSttBufInit(VI_PIPE ViPipe)
{
    XMEDIA_U32 i;
    XMEDIA_S32 s32Ret;
    XMEDIA_U8  *pu8VirAddr;
    ...
    s32Ret = CMPI_MmzMallocCached(XMEDIA_NULL, acName, &u64PhyAddr, (XMEDIA_VOID **)&pu8VirAddr, u64Size * 2);
    ...
    pstDrvCtx->stBeOnlineSttBuf.bInit = XMEDIA_TRUE;

    for (i = 0; i < 2; i++) {
        pstDrvCtx->stBeOnlineSttBuf.astBeSttBuf[i].u64PhyAddr = u64PhyAddr + i * u64Size;
        pstDrvCtx->stBeOnlineSttBuf.astBeSttBuf[i].pVirAddr   = (XMEDIA_VOID *)(pu8VirAddr + i * u64Size);
    ...
    pstDrvCtx->stBeOnlineSttBuf.bDrvGetFirtStatInfoFlag = XMEDIA_FALSE;
    return XMEDIA_SUCCESS;

fail0:
    pstDrvCtx->stBeOnlineSttBuf.bInit = XMEDIA_FALSE;

    for (i = 0; i < 2; i++) {
        pstDrvCtx->stBeOnlineSttBuf.astBeSttBuf[i].u64PhyAddr = 0;
        pstDrvCtx->stBeOnlineSttBuf.astBeSttBuf[i].pVirAddr   = XMEDIA_NULL;
...
XMEDIA_S32 ISP_DRV_BeOnlineSttBufExit(VI_PIPE ViPipe)
{
    XMEDIA_U32 i;
    XMEDIA_U64 u64PhyAddr;
    XMEDIA_VOID *pVirAddr;
...
XMEDIA_S32 ISP_DRV_FeSttAddrInit(VI_PIPE ViPipe)
{
    XMEDIA_U8   u8ChnNumMax, k;
    VI_PIPE ViPipeBind;
    ISP_DRV_CTX_S *pstDrvCtx = XMEDIA_NULL;
    S_ISP_VICAP_CH_REGS_TYPE *pstFeSttAddrReg = XMEDIA_NULL;
    ...
    for (k = 0; k < u8ChnNumMax; k++) {
        pstDrvCtx->stFeSttAttr.stFeSttBuf[k].bFirstFrame = XMEDIA_TRUE;
...
XMEDIA_S32 ISP_DRV_FeStitchSttAddrInit(VI_PIPE ViPipe)
{
    return XMEDIA_SUCCESS;
}

XMEDIA_S32 ISP_DRV_NormalFeSttBufInit(VI_PIPE ViPipe)
{
    XMEDIA_S32 s32Ret;
    XMEDIA_U32 i, j;
    XMEDIA_U8  *pu8VirAddr;
    XMEDIA_U64 u64PhyAddr, u64Size, u64SizeTemp;
    unsigned long u32Flags;
    XMEDIA_CHAR acName[MAX_MMZ_NAMELEN] = {0};
    ISP_DRV_CTX_S *pstDrvCtx        = XMEDIA_NULL;
    ...
    s32Ret = CMPI_MmzMallocNocache(XMEDIA_NULL, acName, &u64PhyAddr, (XMEDIA_VOID **)&pu8VirAddr, u64SizeTemp);
    ...
    pstDrvCtx->stFeSttAttr.bInit = XMEDIA_TRUE;

    for (i = 0; i < ISP_WDR_CHN_MAX; i++) {
        for (j = 0; j < 2; j++) {
            pstDrvCtx->stFeSttAttr.stFeSttBuf[i].astFeSttBuf[j].u64PhyAddr = u64PhyAddr + (2 * i + j) * u64Size;
            pstDrvCtx->stFeSttAttr.stFeSttBuf[i].astFeSttBuf[j].pVirAddr   = (XMEDIA_VOID *)(pu8VirAddr + (2 * i + j) * u64Size);
...
XMEDIA_S32 ISP_DRV_FeSttBufInit(VI_PIPE ViPipe)
{
    XMEDIA_S32 s32Ret;
    ISP_CHECK_PIPE(ViPipe);
    ISP_CHECK_VIR_PIPE(ViPipe);
...
XMEDIA_S32 ISP_DRV_FeSttBufExit(VI_PIPE ViPipe)
{
    XMEDIA_U32  i, j;
    XMEDIA_U64  u64PhyAddr = 0;
    XMEDIA_VOID *pVirAddr;
    ...
    if (pstDrvCtx->stWDRAttr.bMastPipe == XMEDIA_TRUE) {
        osal_spin_lock_irqsave(&g_stIspLock[ViPipe], &u32Flags);

        pstDrvCtx->stFeSttAttr.bInit = XMEDIA_FALSE;

        for (i = 0; i < ISP_WDR_CHN_MAX; i++) {
            for (j = 0; j < 2; j++) {
                pstDrvCtx->stFeSttAttr.stFeSttBuf[i].astFeSttBuf[j].u64PhyAddr = 0;
                pstDrvCtx->stFeSttAttr.stFeSttBuf[i].astFeSttBuf[j].u64Size    = 0;
                pstDrvCtx->stFeSttAttr.stFeSttBuf[i].astFeSttBuf[j].pVirAddr   = XMEDIA_NULL;
            }

            pstDrvCtx->stFeSttAttr.stFeSttBuf[i].u32CurWriteFlag = 0;
            pstDrvCtx->stFeSttAttr.stFeSttBuf[i].bFirstFrame     = XMEDIA_FALSE;
        }
...
XMEDIA_S32 ISP_DRV_BeOfflineSttBufInit(VI_PIPE ViPipe)
{
    XMEDIA_S32 s32Ret;
    XMEDIA_U32 i;
    ISP_DRV_CTX_S *pstDrvCtx = XMEDIA_NULL;
    ...
    s32Ret = CMPI_MmzMallocCached(XMEDIA_NULL, acName, &u64PhyAddr, (XMEDIA_VOID **)&pu8VirAddr, u64Size * ISP_STRIPING_MAX_NUM);
    ...
    pstDrvCtx->stBeOffSttAttr.bInit = XMEDIA_TRUE;

    for (i = 0; i < ISP_STRIPING_MAX_NUM; i++) {
        pstDrvCtx->stBeOffSttAttr.astBeSttBuf[i].u64PhyAddr = u64PhyAddr + i * u64Size;
        pstDrvCtx->stBeOffSttAttr.astBeSttBuf[i].pVirAddr   = (XMEDIA_VOID *)(pu8VirAddr + i * u64Size);
...
XMEDIA_S32 ISP_DRV_BeOfflineSttBufExit(VI_PIPE ViPipe)
{
    XMEDIA_U32 i;
    XMEDIA_U64 u64PhyAddr;
    XMEDIA_VOID *pVirAddr;
    ...
    pstDrvCtx->stBeOffSttAttr.bInit = XMEDIA_FALSE;

    for (i = 0; i < ISP_STRIPING_MAX_NUM; i++) {
        pstDrvCtx->stBeOffSttAttr.astBeSttBuf[i].u64PhyAddr = 0;
        pstDrvCtx->stBeOffSttAttr.astBeSttBuf[i].u64Size    = 0;
        pstDrvCtx->stBeOffSttAttr.astBeSttBuf[i].pVirAddr   = XMEDIA_NULL;
    }
...
XMEDIA_S32 ISP_DRV_BeSttBufInit(VI_PIPE ViPipe)
{
    ISP_DRV_CTX_S *pstDrvCtx = XMEDIA_NULL;
    ...
    if (IS_ONLINE_MODE(pstDrvCtx->stWorkMode.enIspRunningMode) ||  \
        ...
        if (ISP_DRV_BeOnlineSttBufInit(ViPipe) != XMEDIA_SUCCESS) {
            return XMEDIA_FAILURE;
        }

        if (ISP_DRV_BeLutSttBufInit(ViPipe) != XMEDIA_SUCCESS) {
            goto fail0;
        }
    } else if (IS_OFFLINE_MODE(pstDrvCtx->stWorkMode.enIspRunningMode) ||  \
               IS_STRIPING_MODE(pstDrvCtx->stWorkMode.enIspRunningMode)) {
        if (ISP_DRV_BeOfflineSttBufInit(ViPipe) != XMEDIA_SUCCESS) {
            return XMEDIA_FAILURE;
        }
    } else {
...
XMEDIA_S32 ISP_DRV_BeSttBufExit(VI_PIPE ViPipe)
{
    ISP_DRV_CTX_S *pstDrvCtx = XMEDIA_NULL;
    ...
    if (IS_ONLINE_MODE(pstDrvCtx->stWorkMode.enIspRunningMode)\
        || IS_SIDEBYSIDE_MODE(pstDrvCtx->stWorkMode.enIspRunningMode)) {
        if (ISP_DRV_BeOnlineSttBufExit(ViPipe) != XMEDIA_SUCCESS) {
            ISP_TRACE(MODULE_DBG_ERR, "pipe[%d] ISP_DRV_BeOnlineSttBufExit failed!\n", ViPipe);
            return XMEDIA_FAILURE;
        }

        if (ISP_DRV_BeLutSttBufExit(ViPipe) != XMEDIA_SUCCESS) {
            ISP_TRACE(MODULE_DBG_ERR, "pipe[%d] ISP_DRV_BeLutSttBufExit failed!\n", ViPipe);
            return XMEDIA_FAILURE;
        }
    } else if (IS_OFFLINE_MODE(pstDrvCtx->stWorkMode.enIspRunningMode)\
               || IS_STRIPING_MODE(pstDrvCtx->stWorkMode.enIspRunningMode)) {
        if (ISP_DRV_BeOfflineSttBufExit(ViPipe) != XMEDIA_SUCCESS) {
...
XMEDIA_S32 ISP_DRV_SttBufInit(VI_PIPE ViPipe)
{
    ISP_CHECK_PIPE(ViPipe);

    if (ISP_DRV_BeSttBufInit(ViPipe) != XMEDIA_SUCCESS) {
        return XMEDIA_FAILURE;
    }

    if (ISP_DRV_FeSttBufInit(ViPipe) != XMEDIA_SUCCESS) {
...
XMEDIA_S32 ISP_DRV_SttBufExit(VI_PIPE ViPipe)
{
    ISP_CHECK_PIPE(ViPipe);
    ISP_CHECK_EXIT_STATE(ViPipe);

    if (ISP_DRV_BeSttBufExit(ViPipe) != XMEDIA_SUCCESS) {
        ISP_TRACE(MODULE_DBG_ERR, "pipe[%d] ISP_DRV_BeSttBufExit failed!\n", ViPipe);
        return XMEDIA_FAILURE;
    }

    if (ISP_DRV_FeSttBufExit(ViPipe) != XMEDIA_SUCCESS) {
...
XMEDIA_S32 ISP_DRV_GetP2EnInfo(VI_PIPE ViPipe, XMEDIA_BOOL *pbP2En)
{
    ISP_CHECK_PIPE(ViPipe);
...
XMEDIA_S32 ISP_DRV_StaKernelGet(VI_PIPE ViPipe, ISP_DRV_AF_STATISTICS_S *pstFocusStat)
{
    unsigned long u32Flags;
    ISP_DRV_CTX_S *pstDrvCtx = XMEDIA_NULL;
...
XMEDIA_S32 ISP_DRV_StitchSyncCtrlInit(VI_PIPE ViPipe)
{
    return XMEDIA_SUCCESS;
}

XMEDIA_S32 ISP_DRV_GetStitchBeSyncPara(VI_PIPE ViPipe, ISP_BE_SYNC_PARA_S *pstBeSyncPara)
{
    return XMEDIA_SUCCESS;
}

XMEDIA_S32 ISP_DRV_ResetFeCfg(VI_PIPE ViPipe)
{
#if ENABLE_CLOCK
    XMEDIA_U8   k;
    XMEDIA_BOOL bReset = XMEDIA_TRUE;
    VI_PIPE ViPipeBind;
    MPP_CHN_S stMppChn;
    ISP_DRV_CTX_S *pstDrvCtx = XMEDIA_NULL;
...
XMEDIA_S32 ISP_DRV_UpdateLdciTprOfflineStat(VI_PIPE ViPipe, ISP_BE_WO_REG_CFG_S *pstBeCfg)
{
    XMEDIA_U8  i;
    XMEDIA_U64 u64PhyAddr;
    ISP_DRV_CTX_S *pstDrvCtx = XMEDIA_NULL;
...
XMEDIA_S32 ISP_DRV_UpdateLdciTprSttAddr(VI_PIPE ViPipe, ISP_BE_WO_REG_CFG_S *pstBeCfg)
{
    XMEDIA_U8  i;
    XMEDIA_U64 u64PhyAddr;
    ISP_DRV_CTX_S *pstDrvCtx = XMEDIA_NULL;
