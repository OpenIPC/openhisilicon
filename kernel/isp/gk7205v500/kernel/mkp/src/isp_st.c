...
XMEDIA_S32 ispSyncTskFIndAndExecute(VI_PIPE ViPipe, struct osal_list_head *head)
{
    struct osal_list_head *pos = XMEDIA_NULL;
    struct osal_list_head *next = XMEDIA_NULL;
...
*****************************************************************************/
XMEDIA_S32 isp_sync_task_register(VI_PIPE ViPipe, ISP_SYNC_TASK_NODE_S *pstNewNode)
{
    ISP_SYNC_TSK_CTX_S *pstSyncTsk = ISP_SYNC_TSK_GET_CTX(ViPipe);
...
*****************************************************************************/
XMEDIA_S32 isp_sync_task_unregister(VI_PIPE ViPipe, ISP_SYNC_TASK_NODE_S *pstDelNode)
{
    ISP_SYNC_TSK_CTX_S *pstSyncTsk = ISP_SYNC_TSK_GET_CTX(ViPipe);
    struct osal_list_head *pstTargetList;
    LIST_ENTRY_S *pstListEntry;
    struct osal_list_head *pos;
    XMEDIA_S32 bDelSuccess = XMEDIA_FAILURE;
