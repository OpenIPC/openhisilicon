...
#define ISP_RES_WIDTH_MAX                         3072,3072,3072,3072 // need change when pipe num is change
#define ISP_RES_HEIGHT_MAX                        3072,3072,3072,3072 // need change when pipe num is change

extern XMEDIA_U16 g_au16ResWMax[ISP_MAX_PIPE_NUM];
extern XMEDIA_U16 g_au16ResHMax[ISP_MAX_PIPE_NUM];
...
#define ISP_LSC_DEFAULT_MESH_SCALE             (4)    // 0.10bit
...
// #define ISP_CCM_RECOVER_EN_DEFAULT             (0x1)
