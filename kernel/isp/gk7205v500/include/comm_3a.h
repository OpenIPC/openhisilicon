...
typedef struct ISP_CTRL_PROC_WRITE_S {
    ...
    XMEDIA_U32   u32WriteLen;   /* The len count should contain '\0'. */
...
typedef struct ISP_AE_INFO_S {
    XMEDIA_U32  u32FrameCnt;    /* the counting of frame */
    ISP_SMART_INFO_S stSmartInfo;  /* Only used for XM72050200/XM72050300/XM72020300 */
...
typedef struct ISP_AE_RESULT_S {
    ...
    XMEDIA_U32  u32HmaxTimes; /* unit is ns */
    XMEDIA_U32  u32Vmax; /* unit is line */
