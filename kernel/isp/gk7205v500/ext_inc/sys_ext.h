...
typedef struct MPP_SYS_DDR_NAME_S {
    XMEDIA_U32 u32Num;
    XMEDIA_VOID *apMmzName[SYS_DDR_MAXNUM];
} MPP_SYS_DDR_NAME_S;
...
typedef struct BIND_SENDER_INFO_S {
    MOD_ID_E enModId;
    XMEDIA_U32 u32MaxDevCnt;
    XMEDIA_U32 u32MaxChnCnt;
    XMEDIA_S32 (*pGiveBindCallBack)(XMEDIA_S32 s32DevId, XMEDIA_S32 s32ChnId, MPP_BIND_DEST_S *pstBindSend);
} BIND_SENDER_INFO_S;
...
typedef struct BIND_RECEIVER_INFO_S {
    ...
    XMEDIA_U32 u32MaxDevCnt;
    XMEDIA_U32 u32MaxChnCnt;
    XMEDIA_S32 (*pCallBack)(XMEDIA_S32 s32DevId, XMEDIA_S32 s32ChnId, XMEDIA_BOOL bBlock, MPP_DATA_TYPE_E enDataType, XMEDIA_VOID *pvData);
    XMEDIA_S32 (*pResetCallBack)(XMEDIA_S32 s32DevId, XMEDIA_S32 s32ChnId, XMEDIA_VOID *pvData);
    XMEDIA_BOOL bSupportDelayData;
...
typedef struct VB_BASE_INFO_S {
    ...
    XMEDIA_U32 u32BufLine;
    XMEDIA_U32 u32Align;  /* 0:auto */
    DYNAMIC_RANGE_E enDynamicRange;
    COMPRESS_MODE_E enCompressMode;
    VIDEO_FORMAT_E enVideoFormat;
    XMEDIA_BOOL b3DNRBuffer;
} VB_BASE_INFO_S;
...
typedef enum SYS_FUNC_E {
    ...
    SYS_MIPI_RX_PIXEL_CLK_SET,
    SYS_MIPI_RX_PIXEL_CLK_GET,
...
typedef struct SYS_EXPORT_FUNC_S {
    XMEDIA_U64 (*pfnSYSGetTimeStamp)
    (XMEDIA_VOID);
    XMEDIA_U64 (*pfnSYSGetLocalTimeStamp)
    (XMEDIA_VOID);
    XMEDIA_VOID (*pfnSYSSyncTimeStamp)
    (XMEDIA_U64 u64Base, XMEDIA_BOOL bInit);
    XMEDIA_U32 (*pfnSysGetChipVersion)(XMEDIA_VOID);
    XMEDIA_S32 (*pfnSysGetStride)
    (XMEDIA_U32 u32Width, XMEDIA_U32 *pu32Stride);
    XMEDIA_S32 (*pfnSysDrvIoCtrl)
    (MPP_CHN_S *pstMppChn, SYS_FUNC_E enFuncId, XMEDIA_VOID *pIoArgs);

    XMEDIA_S32 (*pfnSysRegisterSender)
    (BIND_SENDER_INFO_S *pstInfo);
    XMEDIA_S32 (*pfnSysUnRegisterSender)
    (MOD_ID_E enModId);
    XMEDIA_S32 (*pfnSysRegisterReceiver)
    (BIND_RECEIVER_INFO_S *pstInfo);
    XMEDIA_S32 (*pfnSysUnRegisterReceiver)
    (MOD_ID_E enModId);
    XMEDIA_S32 (*pfnSysSendData)
    (MOD_ID_E enModId, XMEDIA_S32 s32DevId, XMEDIA_S32 s32ChnId, XMEDIA_U32 u32Flag,
     MPP_DATA_TYPE_E enDataType, XMEDIA_VOID *pvData);

    XMEDIA_S32 (*pfnSysResetData)
    (MOD_ID_E enModId, XMEDIA_S32 s32DevId,
     XMEDIA_S32 s32ChnId, XMEDIA_VOID *pPrivate);

    XMEDIA_S32 (*pfnGetBindbySrc)(MPP_CHN_S *pstSrcChn, MPP_BIND_DEST_S *pstBindSrc);
    XMEDIA_S32 (*pfnGetBindNumbySrc)(MPP_CHN_S *pstSrcChn, XMEDIA_U32 *pu32BindNum);
    XMEDIA_S32 (*pfnGetBindbyDest)(MPP_CHN_S *pstDestChn, MPP_CHN_S *pstSrcChn);
    XMEDIA_S32 (*pfnGetMmzName)(MPP_CHN_S *pstChn, XMEDIA_VOID **ppMmzName);
    XMEDIA_S32 (*pfnGetMemDdr)(MPP_CHN_S *pstChn, MPP_SYS_DDR_NAME_S *pstMemDdr);
    XMEDIA_S32 (*pfnGetSpinRec)(XMEDIA_U32 *u32SpinRec);

    XMEDIA_U32 (*pfnSysVRegRead)
    (XMEDIA_U32 u32Addr, XMEDIA_U32 u32Bytes);
    XMEDIA_S32 (*pfnSysVRegWrite)
    (XMEDIA_U32 u32Addr, XMEDIA_U32 u32Value, XMEDIA_U32 u32Bytes);
    XMEDIA_U32 (*pfnSysGetVRegAddr)
    (XMEDIA_VOID);
    XMEDIA_U32 (*pfnSysGetScaleCoef)
    (MOD_ID_E enModId, XMEDIA_VOID *pstScaleCoefOpt, XMEDIA_VOID *pvRate, XMEDIA_VOID *pvCfg);
    XMEDIA_U64 (*pfnSYSGetSchedClock)
    (XMEDIA_VOID);
    XMEDIA_S32 (*pfnSYSGetFullChipId)
    (XMEDIA_U32 *pu32ChipId);

    XMEDIA_U32 (*pfnSYSGetChipId)
    (XMEDIA_VOID);
    XMEDIA_U64 (*pfnSYSGetEfuseAddr)
    (XMEDIA_VOID);

    XMEDIA_S32 (*pfnSYSGetTimeZone)(XMEDIA_S32 *ps32TimeZone);
    XMEDIA_S32 (*pfnSYSGetNowString)(XMEDIA_U8 *pu8NowTime);
    GPS_INFO_S * (*pfnSYSGetGPSInfo)(XMEDIA_VOID);

    XMEDIA_VOID (*pfnSYSGetCmpCfg)(XMEDIA_VOID *pstVFrame, XMEDIA_VOID *pstYCmpCfg, XMEDIA_VOID *pstCCmpCfg, void *pstCmpModeExParam);

    XMEDIA_VOID (*pfnSYSGetVBCfg)(XMEDIA_VOID *pstVBBaseInfo, XMEDIA_VOID *pstVBCalConfig);
    XMEDIA_VOID (*pfnSYSGetVdecBufferCfg)(PAYLOAD_TYPE_E enType, XMEDIA_VOID *pstVBBaseInfo, XMEDIA_VOID *pstVBCalConfig);

    XMEDIA_VOID (*pfnSYSGetCmpSegCfg)(XMEDIA_VOID *pstSysCmpIn, XMEDIA_VOID *pstYCmpCfg, XMEDIA_VOID *pstCCmpCfg);
    XMEDIA_VOID (*pfnSYSGetCmpBayerCfg)(XMEDIA_VOID *pstSysCmpIn, XMEDIA_VOID *pstBayerCmpCfg, XMEDIA_VOID *pstBayerDcmpCfg);
    XMEDIA_VOID (*pfnSYSGetCmp3DNRCfg)(XMEDIA_VOID *pstSysCmpIn, XMEDIA_VOID *pstYCmpCfg, XMEDIA_VOID *pstCCmpCfg);
    XMEDIA_VOID (*pfnSYSGetCmpTILE16x8Cfg)(XMEDIA_VOID *pstSysCmpIn, XMEDIA_VOID *pstCmpOut);
    XMEDIA_VOID (*pfnSYSGetCmpMUV1Cfg)(XMEDIA_VOID *pstSysCmpIn, XMEDIA_VOID *pstCmpOut);
    XMEDIA_VOID (*pfnSYSGetDcmpMUV1Cfg)(XMEDIA_VOID *pstSysCmpIn, XMEDIA_VOID *pstCmpOut);
    XMEDIA_VOID (*pfnSYSGetCmpTDECfg)(XMEDIA_VOID *pstSysCmpIn, XMEDIA_VOID *pstCmpOut);

#ifdef CONFIG_TZASC_SUPPORT
    XMEDIA_S32 (*pfnSYSGetSecurityVersion)(SYS_SECURITY_VERSION_E *version);
#endif
} SYS_EXPORT_FUNC_S;
...
#define CKFN_SYS_GetLocalTimeStamp() \
    (NULL != FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSYSGetLocalTimeStamp)
...
#define CALL_SYS_SyncTimeStamp(u64Base, bInit) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSYSSyncTimeStamp(u64Base, bInit)
...
#define CALL_SYS_GetStride(u32Width, pu32Stride) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSysGetStride(u32Width, pu32Stride)

#define CKFN_SYS_GetChipVersion() \
    (NULL != FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSysGetChipVersion)
...
#define CALL_SYS_DrvIoCtrl(pstMppChn, enFuncId, pIoArgs) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSysDrvIoCtrl(pstMppChn, enFuncId, pIoArgs)

#define CKFN_SYS_RegisterSender() \
    (NULL != FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSysRegisterSender)
...
#define CKFN_SYS_UnRegisterSender() \
    (NULL != FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSysUnRegisterSender)
#define CALL_SYS_UnRegisterSender(enModId) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSysUnRegisterSender(enModId)

#define CKFN_SYS_RegisterReceiver() \
    (NULL != FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSysRegisterReceiver)
#define CALL_SYS_RegisterReceiver(pstInfo) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSysRegisterReceiver(pstInfo)

#define CKFN_SYS_UnRegisterReceiver() \
    (NULL != FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSysUnRegisterReceiver)
#define CALL_SYS_UnRegisterReceiver(enModId) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSysUnRegisterReceiver(enModId)
...
#define CALL_SYS_SendData(enModId, s32DevId, s32ChnId, u32Flag, enDataType, pvData) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSysSendData(enModId, s32DevId, s32ChnId, u32Flag, enDataType, pvData)
...
#define CALL_SYS_ResetData(enModId, s32DevId, s32ChnId, pPrivate) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSysResetData(enModId, s32DevId, s32ChnId, pPrivate)
...
#define CALL_SYS_GetBindbySrc(pstSrcChn, pstBindDest) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnGetBindbySrc(pstSrcChn, pstBindDest)
...
#define CALL_SYS_GetBindNumbySrc(pstSrcChn, pu32BindNum) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnGetBindNumbySrc(pstSrcChn, pu32BindNum)
...
#define CALL_SYS_GetBindbyDest(pstDestChn, pstSrcChn) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnGetBindbyDest(pstDestChn, pstSrcChn)
...
#define CALL_SYS_GetMmzName(pstSrcChn, ppMmzName) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnGetMmzName(pstSrcChn, ppMmzName)
...
#define CALL_SYS_GetMemDdr(pstSrcChn, pstMemDdr) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnGetMemDdr(pstSrcChn, pstMemDdr)
...
#define CALL_SYS_GetScaleCoef(enModId, pstScaleCoefOpt, pvRate, pvCfg) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSysGetScaleCoef(enModId, pstScaleCoefOpt, pvRate, pvCfg)
...
#define CALL_SYS_GetFullChipId(pu32ChipId) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSYSGetFullChipId(pu32ChipId)
...
#define CALL_SYS_GetTimeZone(ps32TimeZone) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSYSGetTimeZone(ps32TimeZone)
...
#define CALL_SYS_GetNowString(pu8NowTime) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSYSGetNowString(pu8NowTime)
...
#define CALL_SYS_GetCmpCfg(pstVideoFrame, pstYCmpCfg, pstCCmpCfg, pstCmpModeExParam) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSYSGetCmpCfg(pstVideoFrame, pstYCmpCfg, pstCCmpCfg, pstCmpModeExParam)
...
#define CALL_SYS_GetVBCfg(pstVBBaseInfo, pstVBCalConfig) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSYSGetVBCfg(pstVBBaseInfo, pstVBCalConfig)

#define CKFN_SYS_GetVdecBufferCfg() \
    (NULL != FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSYSGetVdecBufferCfg)
#define CALL_SYS_GetVdecBufferCfg(enType, pstVBBaseInfo, pstVBCalConfig) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSYSGetVdecBufferCfg(enType, pstVBBaseInfo, pstVBCalConfig)
...
#define CALL_SYS_GetCmpSegCfg(pstSysCmpIn, pstYCmpCfg, pstCCmpCfg) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSYSGetCmpSegCfg(pstSysCmpIn, pstYCmpCfg, pstCCmpCfg)

#define CKFN_SYS_GetCmpBayerCfg() \
    (NULL != FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSYSGetCmpBayerCfg)
#define CALL_SYS_GetCmpBayerCfg(pstSysCmpIn, pstBayerCmpCfg, pstBayerDcmpCfg) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSYSGetCmpBayerCfg(pstSysCmpIn, pstBayerCmpCfg, pstBayerDcmpCfg)
...
#define CALL_SYS_GetCmp3DNRCfg(pstSysCmpIn, pstYCmpCfg, pstCCmpCfg) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSYSGetCmp3DNRCfg(pstSysCmpIn, pstYCmpCfg, pstCCmpCfg)

#define CKFN_SYS_GetCmpTILE16x8Cfg() \
    (NULL != FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSYSGetCmpTILE16x8Cfg)
#define CALL_SYS_GetCmpTILE16x8Cfg(pstSysCmpIn, pstCmpOut) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSYSGetCmpTILE16x8Cfg(pstSysCmpIn, pstCmpOut)
...
#define CALL_SYS_GetCmpMUV1Cfg(pstSysCmpIn, pstCmpOut) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSYSGetCmpMUV1Cfg(pstSysCmpIn, pstCmpOut)

#define CKFN_SYS_GetDcmpMUV1Cfg() \
    (NULL != FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSYSGetDcmpMUV1Cfg)
#define CALL_SYS_GetDcmpMUV1Cfg(pstSysCmpIn, pstDcmpOut) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSYSGetDcmpMUV1Cfg(pstSysCmpIn, pstDcmpOut)
...
#define CALL_SYS_GetCmpTDECfg(pstSysCmpIn, pstCmpOut) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, MOD_ID_SYS)->pfnSYSGetCmpTDECfg(pstSysCmpIn, pstCmpOut)
