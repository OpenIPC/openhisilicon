...
typedef XMEDIA_S32 (*CMPI_PROC_READ)(struct osal_proc_dir_entry *entry);
typedef XMEDIA_S32 (*CMPI_PROC_WRITE)(char *buf, int count);

extern XMEDIA_S32 CMPI_LogInit(XMEDIA_U32);
extern XMEDIA_VOID CMPI_LogExit(XMEDIA_VOID);
