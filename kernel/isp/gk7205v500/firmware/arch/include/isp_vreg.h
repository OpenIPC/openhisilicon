 ...
 * ------------------------------------------------------------------ */
#define ISP_OFFSETOF(TYPE, MEMBER) ((XMEDIA_U32)(&((TYPE *)0)->MEMBER))
...
XMEDIA_S32 VReg_Init(VI_PIPE ViPipe, XMEDIA_U32 u32BaseAddr, XMEDIA_U32 u32Size);
XMEDIA_S32 VReg_Exit(VI_PIPE ViPipe, XMEDIA_U32 u32BaseAddr, XMEDIA_U32 u32Size);
XMEDIA_S32 VReg_ReleaseAll(VI_PIPE ViPipe);
XMEDIA_VOID *VReg_GetVirtAddr(XMEDIA_U32 u32BaseAddr);

XMEDIA_VOID *VReg_GetVirtAddrBase(XMEDIA_U32 u32BaseAddr);
XMEDIA_S32 VReg_Munmap(XMEDIA_U32 u32BaseAddr, XMEDIA_U32 u32Size);
XMEDIA_U32 IO_READ32(XMEDIA_U32 u32Addr);
XMEDIA_S32 IO_WRITE32(XMEDIA_U32 u32Addr, XMEDIA_U32 u32Value);
XMEDIA_S32 IO_WRITE32_Ex(XMEDIA_U32 u32Addr, XMEDIA_U32 u32Value);
XMEDIA_S32 IO_READ32_Ex(XMEDIA_U32 u32Addr, XMEDIA_U32 *pu32Value);
XMEDIA_U16 IO_READ16(XMEDIA_U32 u32Addr);
XMEDIA_S32 IO_WRITE16(XMEDIA_U32 u32Addr, XMEDIA_U32 u32Value);
XMEDIA_U8  IO_READ8(XMEDIA_U32 u32Addr);
XMEDIA_S32 IO_WRITE8(XMEDIA_U32 u32Addr, XMEDIA_U32 u32Value);
...
#define IO_MASK_BITXX                   (~((XMEDIA_UL)0x3))
