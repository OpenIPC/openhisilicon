...
static __inline XMEDIA_VOID isp_ae_weight_write(S_ISPBE_REGS_TYPE *pstBeReg, XMEDIA_U32 *upisp_ae_weight)
{
    XMEDIA_S32 i;
...
//  Input       : XMEDIA_U32 *upisp_demosaic_depurp_lut: 4 bits
//  Return      : XMEDIA_S32: 0-Error, 1-Success
// ******************************************************************************
static __inline XMEDIA_VOID isp_demosaic_depurp_lut_write(S_ISPBE_REGS_TYPE *pstBeReg, XMEDIA_U8 *upisp_demosaic_depurp_lut)
{
...
//  Input       : XMEDIA_U32 *upisp_nddm_gflut: 12 bits
//  Return      : XMEDIA_S32: 0-Error, 1-Success
// ******************************************************************************
static __inline XMEDIA_U8 isp_nddm_gflut_write(S_ISPBE_REGS_TYPE *pstBeReg, XMEDIA_U16 *upisp_nddm_gflut)
{
...
//  Input       : XMEDIA_U32 *upisp_expander_lut: 21 bits
//  Return      : XMEDIA_S32: 0-Error, 1-Success
// ******************************************************************************
static __inline XMEDIA_VOID isp_expander_lut_write(S_ISPBE_REGS_TYPE *pstBeReg, XMEDIA_U16 *upisp_expander_lut)
{
...
//  Input       : XMEDIA_U32 *upisp_drc_tmlut0_diff: 14 bits
//  Return      : XMEDIA_S32: 0-Error, 1-Success
// ******************************************************************************
static __inline XMEDIA_VOID isp_drc_tmlut0_diff_write(S_ISPBE_REGS_TYPE *pstBeReg, XMEDIA_U16 *upisp_drc_tmlut0_diff)
{
...
//  Input       : XMEDIA_U32 *upisp_drc_tmlut0_value: 16 bits
//  Return      : XMEDIA_S32: 0-Error, 1-Success
// ******************************************************************************
static __inline XMEDIA_VOID isp_drc_tmlut0_value_write(S_ISPBE_REGS_TYPE *pstBeReg, XMEDIA_U16 *upisp_drc_tmlut0_value)
{
    U_ISP_DRC_TMLUT0 o_isp_drc_tmlut0;
    XMEDIA_S32 i;
...
//  Input       : XMEDIA_U32 *upisp_drc_cclut: 12 bits
//  Return      : XMEDIA_S32: 0-Error, 1-Success
// ******************************************************************************
static __inline XMEDIA_VOID isp_drc_cclut_write(S_ISPBE_REGS_TYPE *pstBeReg, XMEDIA_U16 *upisp_drc_cclut)
{
...
static __inline XMEDIA_VOID isp_drc_pregamma_write(S_ISPBE_REGS_TYPE *pstBeReg, XMEDIA_U16 *uisp_drc_pregamma)
{
    XMEDIA_S32 i;
    for (i = 0; i < 257; i++) {
...
//  Input       : XMEDIA_U32 *upisp_dehaze_lut_wstt: 10 bits
//  Return      : XMEDIA_S32: 0-Error, 1-Success
// ******************************************************************************
static __inline XMEDIA_VOID isp_dehaze_lut_wstt_write(S_ISP_LUT_WSTT_TYPE *pstBeLutSttReg, XMEDIA_U16 u16BlkNum,
                                                  XMEDIA_U32 *upisp_dehaze_prestat_wstt, XMEDIA_U8 *upisp_dehaze_lut_wstt)
{
    XMEDIA_S32 i;
...
//  Input       : XMEDIA_U32 *upisp_gamma_lut_wstt: 12 bits
//  Return      : XMEDIA_S32: 0-Error, 1-Success
// ******************************************************************************
static __inline XMEDIA_VOID isp_gamma_lut_wstt_write(S_ISP_LUT_WSTT_TYPE *pstBeLutSttReg, XMEDIA_U16 *upisp_gamma_lut_wstt)
{
...
//  Input       : XMEDIA_U32 *upisp_sharpen_lut_wstt: 30 bits
//  Return      : XMEDIA_S32: 0-Error, 1-Success
// ******************************************************************************
static __inline XMEDIA_VOID isp_sharpen_lut_wstt_write(S_ISP_LUT_WSTT_TYPE *pstBeLutSttReg,
                                                   XMEDIA_U16 *upisp_sharpen_mfgaind_wstt,
                                                   XMEDIA_U16 *upisp_sharpen_mfgainud_wstt,
                                                   XMEDIA_U16 *upisp_sharpen_hfgaind_wstt,
                                                   XMEDIA_U16 *upisp_sharpen_hfgainud_wstt)
{
    XMEDIA_S32 i;
...
//  Input       : XMEDIA_U32 *upisp_lsc_lut_wstt: 20 bits
//  Return      : XMEDIA_S32: 0-Error, 1-Success
// ******************************************************************************
static __inline XMEDIA_VOID isp_mlsc_lut_wstt_write(S_ISP_LUT_WSTT_TYPE *pstBeLutSttReg, XMEDIA_U32 *upisp_lsc_rgain_wstt,
                                                XMEDIA_U32 *upisp_lsc_grgain_wstt, XMEDIA_U32 *upisp_lsc_gbgain_wstt,
                                                XMEDIA_U32 *upisp_lsc_bgain_wstt)
{
    XMEDIA_S32 i;
...
//  Input       : XMEDIA_U32 *upisp_ca_lut_wstt: 11 bits
//  Return      : XMEDIA_S32: 0-Error, 1-Success
// ******************************************************************************
static __inline XMEDIA_VOID isp_ca_lut_wstt_write(S_ISP_LUT_WSTT_TYPE *pstBeLutSttReg, XMEDIA_U16 *upisp_ca_lut_wstt)
{
...
static __inline XMEDIA_VOID isp_ldci_cgain_lut_wstt_write(S_ISP_LUT_WSTT_TYPE *pstBeLutSttReg,
                                                      XMEDIA_U32 *upisp_ldci_cgain_lut_wstt)
{
    XMEDIA_S32 i;
...
static __inline XMEDIA_VOID isp_ldci_he_lut_lut_wstt_write(S_ISP_LUT_WSTT_TYPE *pstBeLutSttReg,
                                                       XMEDIA_U32 *upisp_ldci_hepos_lut_wstt,
                                                       XMEDIA_U32 *upisp_ldci_heneg_lut_wstt)
{
    XMEDIA_S32 i;
...
static __inline XMEDIA_VOID isp_ldci_usm_lut_wstt_write(S_ISP_LUT_WSTT_TYPE *pstBeLutSttReg,
                                                    XMEDIA_U32 *upisp_ldci_usmpos_lut_wstt,
                                                    XMEDIA_U32 *upisp_ldci_usmneg_lut_wstt)
{
    XMEDIA_S32 i;
...
static __inline XMEDIA_VOID isp_bnr_lmt_even_wlut_write(S_ISP_LUT_WSTT_TYPE *pstBeLutSttReg, XMEDIA_U8 *isp_bnr_lmt_s_even,
                                                    XMEDIA_U8 *isp_bnr_lmt_even)
{
    XMEDIA_S32 i;
    for (i = 0; i < 65; i++) {
...
static __inline XMEDIA_VOID isp_bnr_lmt_odd_wlut_write(S_ISP_LUT_WSTT_TYPE *pstBeLutSttReg, XMEDIA_U8 *isp_bnr_lmt_s_odd,
                                                   XMEDIA_U8 *isp_bnr_lmt_odd)
{
    XMEDIA_S32 i;
    for (i = 0; i < 64; i++) {
...
static __inline XMEDIA_VOID isp_bnr_cor_even_wlut_write(S_ISP_LUT_WSTT_TYPE *pstBeLutSttReg, XMEDIA_U8 *isp_bnr_gcor_even,
                                                    XMEDIA_U16 *isp_bnr_cor_even)
{
    XMEDIA_S32 i;
    for (i = 0; i < 17; i++) {
...
static __inline XMEDIA_VOID isp_bnr_cor_odd_wlut_write(S_ISP_LUT_WSTT_TYPE *pstBeLutSttReg, XMEDIA_U8 *isp_bnr_gcor_odd,
                                                   XMEDIA_U16 *isp_bnr_cor_odd)
{
    XMEDIA_S32 i;
    for (i = 0; i < 16; i++) {
