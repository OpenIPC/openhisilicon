...
static __inline HI_U32 hi_area_stat_mem_array_data_read_af_v1h1(HI_U16 index) {
    ...
    IOWR_32DIRECT_VI(0x12288, addr);
    return IORD_32DIRECT_VI(HISI_AF_METERING_MEM_BASE_ADDR);
}
...
static __inline HI_VOID hi_area_stat_mem_array_data_af_raddr_write(HI_U32 data) {
    IOWR_32DIRECT_VI(0x12288, data);
}

static __inline HI_U32 hi_area_stat_mem_array_data_af_rdata_read(HI_VOID) {
...
static __inline HI_U32 hi_area_block_distribute_data_read_af(HI_VOID) {
    return IORD_32DIRECT_VI(0x12210);
}
