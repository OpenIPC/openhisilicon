...
#define HI_ISP_ACM_DITHER_OUTBITS  (8)
...
{	
	hi_isp_dmnr_dither_en_write(IspDev, HI_TRUE);
	hi_isp_acm_dither_en_write(IspDev, HI_TRUE);
	hi_isp_drc_moudle_dither_en_write(IspDev, HI_FALSE);

	hi_isp_dmnr_dither_out_bits_write(IspDev, HI_ISP_DMNR_DITHER_OUTBITS);
	hi_isp_acm_dither_out_bits_write(IspDev, HI_ISP_ACM_DITHER_OUTBITS);
	hi_isp_drc_dither_out_bits_write(IspDev, HI_ISP_DRC_DITHER_OUTBITS);

	hi_isp_dmnr_dither_round_write(IspDev, ISP_DITHER_ROUND_CUT);
	hi_isp_acm_dither_round_write(IspDev, ISP_DITHER_ROUND_CUT);
	hi_isp_drc_dither_round_write(IspDev, ISP_DITHER_ROUND_CUT);

	hi_isp_dmnr_dither_spatial_mode_write(IspDev, HI_FALSE);
	hi_isp_drc_dither_spatial_mode_write(IspDev, HI_FALSE);
	hi_isp_acm_dither_spatial_mode_write(IspDev, HI_FALSE);
