...
HI_S32 ISP_Sharpen_GetRegCfg(HI_U32 iso, HI_U32 expTime, ISP_DEV IspDev, ISP_SHARPEN_REG_CFG_S *pstSharpenReg)
{
   ...
   pstSharpenReg->u16SharpThd2  = LinearInter(iso, 
	...
	{
		pstSharpenReg->u16SharpThd1MulCoef = 4096 / DIV_0_TO_1(pstSharpenReg->u16SharpThd1 - pstSharpenReg->u16SharpThd2);
	}
	else
	{
	...
	{
		pstSharpenReg->u16EdgeThd1MulCoef = 4096 / DIV_0_TO_1(pstSharpenReg->u16EdgeThd1 - pstSharpenReg->u16EdgeThd2);
	}
	else
	{
	...
	{
		pstSharpenReg->u16OvershootThdMulCoef = (256 - pstSharpenReg->u8OvershootAmt) / DIV_0_TO_1(pstSharpenReg->u8OvershootThd1 - pstSharpenReg->u8OvershootThd2);
	}
	...
	{
		pstSharpenReg->u16UndershootThdMulCoef = (256 - pstSharpenReg->u8UndershootAmt) / DIV_0_TO_1(pstSharpenReg->u8UndershootThd1 - pstSharpenReg->u8UndershootThd2);
	}
