...
VREG_ARGS_S *VREG_DRV_Search(HI_U32 u32BaseAddr)
{
    HI_S32  i;
...
HI_S32 VREG_DRV_Init(HI_U32 u32BaseAddr, HI_U32 u32Size)
{
    ...
    pstVreg->u32VirtAddr = (HI_U32)CMPI_Remap_Nocache(pstVreg->u32PhyAddr, u32Size);
...
HI_S32 VREG_DRV_Exit(HI_U32 u32BaseAddr)
{
    ...
    CMPI_Unmap((void *)pstVreg->u32VirtAddr);
