...
typedef struct hiSYS_AQ_DEBUG_ATTR_S
{
	HI_BOOL 	bEnable;
	HI_S32		s32Port;
}SYS_AQ_DEBUG_ATTR_S;

typedef struct hiSYS_MOD_PARAM_S
{
	HI_BOOL 	bOpenAQT ;
}SYS_MOD_PARAM_S;
...
typedef enum hiIOC_NR_SYS_E
{
	...
	IOC_NR_SYS_GET_MOD_PARAM,
	
	IOC_NR_SYS_SET_AQ_DEBUG,
	IOC_NR_SYS_WAIT_AQ_DEBUG,
	IOC_NR_SYS_EXIT_AQ_DEBUG,
...
#define SYS_GET_MOD_PARAM      _IOR(IOC_TYPE_SYS, IOC_NR_SYS_GET_MOD_PARAM, SYS_MOD_PARAM_S)
#define SYS_SET_AQ_DEBUG       _IOW(IOC_TYPE_SYS, IOC_NR_SYS_SET_AQ_DEBUG, SYS_AQ_DEBUG_ATTR_S)
#define SYS_WAIT_AQ_DEBUG      _IOWR(IOC_TYPE_SYS, IOC_NR_SYS_WAIT_AQ_DEBUG, SYS_AQ_DEBUG_ATTR_S)
#define SYS_EXIT_AQ_DEBUG      _IO(IOC_TYPE_SYS, IOC_NR_SYS_EXIT_AQ_DEBUG)
