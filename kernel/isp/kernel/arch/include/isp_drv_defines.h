...
#define IO_WCH_ADDRESS(PhyPipe,x)           ((GK_UINTPTR_T)reg_vicap_ch_base_va[PhyPipe] + (x))
#define IO_FE_ADDRESS(ViPipe, x)            ((GK_UINTPTR_T)reg_ispfe_base_va[ViPipe] + (x))
#define IO_BE_ADDRESS(PhyPipe, x)           ((GK_UINTPTR_T)reg_ispbe_base_va[PhyPipe] + (x))
...
GK_S32 ISP_DRV_BE_AE_OfflineStatisticsRead(ISP_STAT_S *pstStat, S_ISP_STT_REGS_TYPE *apstBeStt[], GK_U8 u8BlkNum);
...
GK_S32 ISP_DRV_BeOfflineAEStitchStatisticsRead(ISP_STAT_S *pstStat, ISP_DRV_CTX_S *pstDrvCtx, ISP_STAT_KEY_U unStatkey);
...
GK_S32 isp_drv_reg_config_be_blc(VI_PIPE ViPipe, S_ISPBE_REGS_TYPE *be_reg[], ISP_DRV_CTX_S *drv_ctx,
...
GK_S32 ISP_DRV_GetViprocRegsAttr(VI_PIPE ViPipe, S_VIPROC_REGS_TYPE *apstViprocReg[],
