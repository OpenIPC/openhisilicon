...
{
    #ifndef HI_FPGA
    //unsigned int sensor_reset = (unsigned int)OSAL_IO_ADDRESS(SENSOR_RESET_CRG_ADDR);
    unsigned int sensor_reset = (unsigned int)osal_ioremap_nocache((unsigned long)SENSOR_RESET_CRG_ADDR, (unsigned long)0x4);
    if (NULL == sensor_reset)
    {
        return;
    }
    ...
    if (0 == dev)
    {
        mipi_write_reg32(sensor_reset, 0x1 << 27, 0x1 << 27);
    }
    #else
    //unsigned int sensor_reset = (unsigned int)OSAL_IO_ADDRESS(0x11360000);
    unsigned int sensor_reset = (unsigned int)osal_ioremap_nocache((unsigned long)0x11360000, (unsigned long)0x4);
    if (NULL == sensor_reset)
    {
        return;
    }
    ...
    if (0 == dev)
    {
        mipi_write_reg32(sensor_reset, 0x1 << 0, 0x1 << 0);
    }
#endif

    osal_iounmap((void*)sensor_reset);
}

void mipi_drv_unreset_sensor(COMBO_DEV dev)
{
    #ifndef HI_FPGA
    //unsigned int sensor_reg = (unsigned int)OSAL_IO_ADDRESS(SENSOR_RESET_CRG_ADDR);
    unsigned int sensor_reg = (unsigned int)osal_ioremap_nocache((unsigned long)SENSOR_RESET_CRG_ADDR, (unsigned long)0x4);
    if (NULL == sensor_reg)
    {
        return;
    }
    ...
    if (0 == dev)
    {
        mipi_write_reg32(sensor_reg, 0, 0x1 << 27);
    }
    #else
    //unsigned int sensor_reg = (unsigned int)OSAL_IO_ADDRESS(0x11360000);
    unsigned int sensor_reg = (unsigned int)osal_ioremap_nocache((unsigned long)0x11360000, (unsigned long)0x4);
    if (NULL == sensor_reg)
    {
        return;
    }
    ...
    if (0 == dev)
    {
        mipi_write_reg32(sensor_reg, 0, 0x1 << 0);
    }
#endif

    osal_iounmap((void*)sensor_reg);
}
...
{
    #ifndef HI_FPGA
    //unsigned int mipi_apb_reset = (unsigned int)OSAL_IO_ADDRESS(MIPI_RESET_CRG_ADDR);
    unsigned int mipi_apb_reset = (unsigned int)osal_ioremap_nocache((unsigned long)MIPI_RESET_CRG_ADDR, (unsigned long)0x4);
    if (NULL == mipi_apb_reset)
    {
        return;
    }
    ...
    if (0 == dev)
    {
        mipi_write_reg32(mipi_apb_reset, 0x1 << 12, 0x1 << 12);
    }
    #else
    //unsigned int mipi_apb_reset = (unsigned int)OSAL_IO_ADDRESS(0x11360008);
    unsigned int mipi_apb_reset = (unsigned int)osal_ioremap_nocache((unsigned long)0x11360008, (unsigned long)0x4);
    if (NULL == mipi_apb_reset)
    {
        return;
    }
    ...
    if (0 == dev)
    {
        mipi_write_reg32(mipi_apb_reset, 0x1 << 0, 0x1 << 0);
    }
    #endif

    osal_iounmap((void*)mipi_apb_reset);
}
...
{
    #ifndef HI_FPGA
    //unsigned int mipi_apb_unreset = (unsigned int)OSAL_IO_ADDRESS(MIPI_RESET_CRG_ADDR);
    unsigned int mipi_apb_unreset = (unsigned int)osal_ioremap_nocache((unsigned long)MIPI_RESET_CRG_ADDR, (unsigned long)0x4);
    if (NULL == mipi_apb_unreset)
    {
        return;
    }
    ...
    if (0 == dev)
    {
        mipi_write_reg32(mipi_apb_unreset, 0, 0x1 << 12);
    }
    #else
    //unsigned int mipi_apb_unreset = (unsigned int)OSAL_IO_ADDRESS(0x11360008);
    unsigned int mipi_apb_unreset = (unsigned int)osal_ioremap_nocache((unsigned long)0x11360008, (unsigned long)0x4);
    if (NULL == mipi_apb_unreset)
    {
        return;
    }
    ...
    if (0 == dev)
    {
        mipi_write_reg32(mipi_apb_unreset, 0, 0x1 << 0);
    }
    #endif

    osal_iounmap((void*)mipi_apb_unreset);
}
...
{
    #ifndef HI_FPGA
    //unsigned int mipi_core_reset = (unsigned int)OSAL_IO_ADDRESS(MIPI_RESET_CRG_ADDR);
    unsigned int mipi_core_reset = (unsigned int)osal_ioremap_nocache((unsigned long)MIPI_RESET_CRG_ADDR, (unsigned long)0x4);
    if (NULL == mipi_core_reset)
    {
        return;
    }
    ...
    if (0 == dev)
    {
        mipi_write_reg32(mipi_core_reset, 0x1 << 16, 0x1 << 16);
    }
    #else
    //unsigned int mipi_core_reset = (unsigned int)OSAL_IO_ADDRESS(0x11360004);
    unsigned int mipi_core_reset = (unsigned int)osal_ioremap_nocache((unsigned long)0x11360004, (unsigned long)0x4);
    if (NULL == mipi_core_reset)
    {
        return;
    }
    ...
    if (0 == dev)
    {
        mipi_write_reg32(mipi_core_reset, 0x1 << 8, 0x1 << 8);
    }
    #endif

    osal_iounmap((void*)mipi_core_reset);
}
...
{
    #ifndef HI_FPGA
    //unsigned int mipi_core_unreset = (unsigned int)OSAL_IO_ADDRESS(MIPI_RESET_CRG_ADDR);
    unsigned int mipi_core_unreset = (unsigned int)osal_ioremap_nocache((unsigned long)MIPI_RESET_CRG_ADDR, (unsigned long)0x4);
    if (NULL == mipi_core_unreset)
    {
        return;
    }
    ...
    if (0 == dev)
    {
        mipi_write_reg32(mipi_core_unreset, 0, 0x1 << 16);    // mipi0 core unreset
    }

    #else
    //unsigned int mipi_core_unreset = (unsigned int)OSAL_IO_ADDRESS(0x11360004);
    unsigned int mipi_core_unreset = (unsigned int)osal_ioremap_nocache((unsigned long)0x11360004, (unsigned long)0x4);
    if (NULL == mipi_core_unreset)
    {
        return;
    }
    ...
    if (0 == dev)
    {
        mipi_write_reg32(mipi_core_unreset, 0, 0x1 << 8);    // mipi0 core unreset
    }
    #endif

    osal_iounmap((void*)mipi_core_unreset);
}
...
void mipi_drv_set_sys_work_mode(COMBO_DEV devno, input_mode_t input_mode)
{
    ...
    //unsigned int sys_reg  = (unsigned int)OSAL_IO_ADDRESS(MIPI_PHY_MODE_ADDR);     // MISC register
    unsigned int sys_reg = (unsigned int)osal_ioremap_nocache((unsigned long)MIPI_PHY_MODE_ADDR, (unsigned long)0x4);
    if (NULL == sys_reg)
    {
        return;
    }
    ...
    {
        mipi_write_reg32(sys_reg, 0x0 << ctl_shift, ctl_mask << ctl_shift);
    }
    else if ((INPUT_MODE_CMOS == input_mode) || (INPUT_MODE_BT1120 == input_mode))
    {
        mipi_write_reg32(sys_reg, 0x2 << ctl_shift, ctl_mask << ctl_shift);
    }
    else
    {
        // LVDS, SubLVDS, HiSPi
        mipi_write_reg32(sys_reg, 0x1 << ctl_shift, ctl_mask << ctl_shift);
    }
    #else
    unsigned int ctl_mask = 0x3;
    unsigned int ctl_shift;
    //unsigned int sys_reg  = (unsigned int)OSAL_IO_ADDRESS(0x11360018);     // MISC register
    unsigned int sys_reg = (unsigned int)osal_ioremap_nocache((unsigned long)0x11360018, (unsigned long)0x4);
    if (NULL == sys_reg)
    {
        return;
    }
...
work_mode_t mipi_drv_get_sys_work_mode(COMBO_DEV devno)
{
    ...
    unsigned int ctl_mask = 0x3;
    unsigned int ctl_shift;
    //unsigned int sys_reg  = (unsigned int)OSAL_IO_ADDRESS(MIPI_PHY_MODE_ADDR);
    unsigned int sys_reg = (unsigned int)osal_ioremap_nocache((unsigned long)MIPI_PHY_MODE_ADDR, (unsigned long)0x4);
    if (NULL == sys_reg)
    {
    ...
    regval = mipi_read_reg32(sys_reg);
    ...
    unsigned int ctl_mask = 0x3;
    unsigned int ctl_shift;
    //unsigned int sys_reg  = (unsigned int)OSAL_IO_ADDRESS(0x11360018);
    unsigned int sys_reg = (unsigned int)osal_ioremap_nocache((unsigned long)0x11360018, (unsigned long)0x4);
    if (NULL == sys_reg)
    {
        return WORK_MODE_BUTT;
...
void mipi_drv_set_di_dt(COMBO_DEV devno, raw_data_type_e raw_data_type)
{
    ...
    else if (RAW_DATA_16BIT == raw_data_type)
    {
        temp_data_type = 0x2e;
    }
...
void mipi_drv_clear_cil_int(COMBO_LINK link_id, unsigned int intclr)
{
    ...
    if (0 == link_id)
    {
        gpMipiAllReg->MIPI_CHN0_INT_RAW.bits.int_phycil0_raw = 1;  // Write bit in the MIPI_CHN_INT_RAW
    }
}
...
void mipi_drv_clear_mipi_csi_int(COMBO_DEV devno, unsigned int intclr)
{
    ...
    pstCtrlReg->MIPI_PKT_INTR_ST.u32;  // read clear
    pstCtrlReg->MIPI_PKT_INTR2_ST.u32;
    pstCtrlReg->MIPI_FRAME_INTR_ST.u32;
    pstCtrlReg->MIPI_LINE_INTR_ST.u32;

    pstCtrlReg->MIPI_MAIN_INT_ST.u32;  // read clear

    if (0 == devno)
    {
        gpMipiAllReg->MIPI_CHN0_INT_RAW.bits.int_mipi_csi_raw = 1;
    }
}
...
void mipi_drv_clear_mipi_ctrl_int(COMBO_DEV devno, unsigned int clrint)
{
    ...
    if (0 == devno)
    {
        gpMipiAllReg->MIPI_CHN0_INT_RAW.bits.int_mipi_ctrl_raw = 1;
    }
}
...
void mipi_drv_clear_lvds_ctrl_int(COMBO_DEV devno, unsigned int clrint)
{
    ...
    if (0 == devno)
    {
        gpMipiAllReg->MIPI_CHN0_INT_RAW.bits.int_lvds_ctrl_raw = 1;
    }
}
...
void mipi_drv_clear_align_int(COMBO_DEV devno, unsigned int clrint)
{
    ...
    if (0 == devno)
    {
        gpMipiAllReg->MIPI_CHN0_INT_RAW.bits.int_data_align_raw = 1;
    }
}
...
void mipi_drv_set_output_msb(COMBO_LINK link_id, output_msb data)
{
    ...
    pstLinkReg->PHY_SYNC_DCT_LINK.u32 = phy_sync_dct.u32;
...
{
    U_CHN_PHY_EN chn_phy_en;

    chn_phy_en.u32 = gpMipiAllReg->stSysRegs.CHN_PHY_EN.u32;
    ...
    if (0 == devno)
    {
        if (1 == p_link_info->link_num)
        {
            if (flag)
            {
                chn_phy_en.bits.phy0_en = 1;
            }
            else
            {
                chn_phy_en.bits.phy0_en = 0;
            }
        }
    }

    gpMipiAllReg->stSysRegs.CHN_PHY_EN.u32 = chn_phy_en.u32;
}
...
{
    U_CHN_MEM_CTRL o_mipi_mem_cken;

    o_mipi_mem_cken.u32 = gpMipiAllReg->stSysRegs.CHN_MEM_CTRL.u32;
    o_mipi_mem_cken.bits.mem_ck_gt = en;
    gpMipiAllReg->stSysRegs.CHN_MEM_CTRL.u32 = o_mipi_mem_cken.u32;
}
...
int mipi_drv_set_lvds_image_size(COMBO_DEV devno, img_size_t* p_img_size)
{
    ...
    lvds_img_size.bits.lvds_imgwidth_lane = p_img_size->width;
            ...
            else if (LVDS_VSYNC_HCONNECT== vsync_type->sync_type)
            {
                ...
                else if (LVDS_FID_IN_DATA== fid_type->fid)
                {
                    if(fid_type->output_fil)
                    {
                        ...
                        lvds_wdr.bits.lvds_wdr_mode = 0xe;
                    }
                    else
                    {
                        lvds_wdr.bits.lvds_wdr_mode = 0x6;
...
static void inline set_lane_en(U_CHN_LANE_EN* p_lane_en, COMBO_LINK link_id, int lane_idx, HI_BOOL en)
{
    if (0 == link_id)
    {
        switch (lane_idx)
...
{
    int i;
    U_ALIGN_LANE_ID lane_id_link_chn;
    volatile U_ALIGN_LANE_ID *p_lane_id_link_chn = NULL;
    U_CHN_LANE_EN      lane_en;

    lane_en.u32 = gpMipiAllReg->stSysRegs.CHN_LANE_EN.u32;
    ...
    {
        set_lane_en(&lane_en, link_id, i, IS_VALID_ID(lane_id[i]));
    }

    /* set lane_id */
    p_lane_id_link_chn = &gpMipiAllReg->stComboDevRegs[devno].ALIGN_LANE_ID;
    ...
    gpMipiAllReg->stSysRegs.CHN_LANE_EN.u32 = lane_en.u32;
    p_lane_id_link_chn->u32 = lane_id_link_chn.u32;

    RTL_Verify_RegWrite(__FUNCTION__, (unsigned int *)&(gpMipiAllReg->stSysRegs.CHN_LANE_EN.u32),
            "LANE_EN", gpMipiAllReg->stSysRegs.CHN_LANE_EN.u32);
    return 0;
}
...
//  Input       : link_id, work_mode, lane_id array
//  Return      : void
//******************************************************************************
void mipi_drv_set_phy_mode(COMBO_LINK link_id, work_mode_t work_mode, short lane_id[LANE_NUM_PER_LINK])
{
    ...
    if (0 != phy_data_en)
    {
        ...
        // set data lane and clock lane enable, if some lanes is enable, then enable clk
        ...
        // Although most LVDS sensor's common voltage is equal to 900mv, but it works well
        // when the input mode is set to less than 900mv during the test and logical simulation.
    ...
    // if work_mode is CMOS, the phy_data_en may be 0, so this bit is set in the end
...
{
    U_CHN_PHYCFG_EN mipi_phycfg_en;
    U_CHN_PHYCFG_MODE mipi_phycfg_mode;
    unsigned short phycfg_mode;
    work_mode_t work_mode;

    mipi_phycfg_en.u32 = gpMipiAllReg->stSysRegs.CHN_PHYCFG_EN.u32;
    mipi_phycfg_mode.u32 = gpMipiAllReg->stSysRegs.CHN_PHYCFG_MODE.u32;
    ...
    if (0 == devno)
    {
        mipi_phycfg_mode.bits.chn0_phycfg_mode = phycfg_mode;
        mipi_phycfg_en.bits.chn0_phycfg_en = en;
    }

    gpMipiAllReg->stSysRegs.CHN_PHYCFG_MODE.u32 = mipi_phycfg_mode.u32;
    gpMipiAllReg->stSysRegs.CHN_PHYCFG_EN.u32 = mipi_phycfg_en.u32;

    RTL_Verify_RegWrite("set_phy_cfg_en", (unsigned int *)&(gpMipiAllReg->stSysRegs.CHN_PHYCFG_MODE.u32),
            "MIPI_PHYCFG_MODE", gpMipiAllReg->stSysRegs.CHN_PHYCFG_MODE.u32);
    RTL_Verify_RegWrite("set_phy_cfg_en", (unsigned int *)&(gpMipiAllReg->stSysRegs.CHN_PHYCFG_EN.u32),
            "MIPI_PHYCFG_EN", gpMipiAllReg->stSysRegs.CHN_PHYCFG_EN.u32);
}

void mipi_exception_handling(int devno)
{
    U_CHN_PHYCFG_MODE mipi0_phycfg_mode;
	U_CHN_PHYCFG_EN mipi0_phycfg_en;
	mipi0_phycfg_mode.u32 = gpMipiAllReg->stSysRegs.CHN_PHYCFG_MODE.u32;
	mipi0_phycfg_en.u32 = gpMipiAllReg->stSysRegs.CHN_PHYCFG_EN.u32;
	mipi0_phycfg_mode.bits.chn0_phycfg_mode = 0x4;
	mipi0_phycfg_en.bits.chn0_phycfg_en = 0x1;
	gpMipiAllReg->stSysRegs.CHN_PHYCFG_MODE.u32 = mipi0_phycfg_mode.u32;
	gpMipiAllReg->stSysRegs.CHN_PHYCFG_EN.u32 = mipi0_phycfg_en.u32;
}
...
{
    U_CHN_CLR_EN chn_clr_en;

    chn_clr_en.u32 = gpMipiAllReg->stSysRegs.CHN_CLR_EN.u32;

    chn_clr_en.bits.clr_en_lvds = en;
    chn_clr_en.bits.clr_en_align = en;

    gpMipiAllReg->stSysRegs.CHN_CLR_EN.u32 = chn_clr_en.u32;

    RTL_Verify_RegWrite("set_lvds_presync_clr_en", (unsigned int *)&(gpMipiAllReg->stSysRegs.CHN_CLR_EN.u32),
            "CHN_CLR_EN", gpMipiAllReg->stSysRegs.CHN_CLR_EN.u32);
}
...
{
    U_CHN_CIL_CTRL mipi_cil_ctrl;

    mipi_cil_ctrl.u32 = gpMipiAllReg->stSysRegs.CHN_CIL_CTRL.u32;

    if (0 == link_id)
    {
        mipi_cil_ctrl.bits.phycil0_cken = en;
    }

    gpMipiAllReg->stSysRegs.CHN_CIL_CTRL.u32 = mipi_cil_ctrl.u32;

    RTL_Verify_RegWrite("set_phy_ckgt_en", (unsigned int *)&(gpMipiAllReg->stSysRegs.CHN_CIL_CTRL.u32),
            "CHN_CIL_CTRL", gpMipiAllReg->stSysRegs.CHN_CIL_CTRL.u32);
}
