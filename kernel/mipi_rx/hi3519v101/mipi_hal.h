...
#define MIPI_CHN0_INT_MASK     (0x0000003f)     // disable ALIGN interrupt
#define MIPI_CHN1_INT_MASK     (0x0000003c)

#define MIPI_CTRL_INT_MASK     (0x00030003)

#define LVDS_CTRL0_INT_MASK    (0x00200000)
#define LVDS_CTRL1_INT_MASK    (0x00200000)
