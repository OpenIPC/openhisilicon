...
static void mipi_set_sys_work_mode(input_mode_t input_mode)
{
    ...
    iounmap((void __iomem *)sys_reg);
    iounmap((void __iomem *)mipi_asic_reg);
    /***************************************************************/
}
...
static void mipi_reset_sensor(void)
{
    ...
    iounmap((void __iomem *)sensor_reg);
}
...
void  hi_mipi_init(void)
{
    ...
    iounmap((void __iomem *)mipi_apb_reset);
}
