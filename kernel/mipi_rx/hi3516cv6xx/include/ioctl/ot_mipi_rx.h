...
#define OT_ERR_MIPIRX_INVALID_PORT_ID        OT_DEFINE_ERR(OT_ID_MIPIRX, OT_ERR_LEVEL_ERROR, OT_ERR_INVALID_DEV_ID)
#define OT_ERR_MIPIRX_INVALID_LANE_ID        OT_DEFINE_ERR(OT_ID_MIPIRX, OT_ERR_LEVEL_ERROR, OT_ERR_INVALID_LANE_ID)
#define OT_ERR_MIPIRX_ILLEGAL_PARAM          OT_DEFINE_ERR(OT_ID_MIPIRX, OT_ERR_LEVEL_ERROR, OT_ERR_ILLEGAL_PARAM)
#define OT_ERR_MIPIRX_NULL_PTR               OT_DEFINE_ERR(OT_ID_MIPIRX, OT_ERR_LEVEL_ERROR, OT_ERR_NULL_PTR)
#define OT_ERR_MIPIRX_NOT_SET_LANE_MODE      OT_DEFINE_ERR(OT_ID_MIPIRX, OT_ERR_LEVEL_ERROR, OT_ERR_NOT_CFG)
#define OT_ERR_MIPIRX_MODE_NOT_SUPPORT       OT_DEFINE_ERR(OT_ID_MIPIRX, OT_ERR_LEVEL_ERROR, OT_ERR_NOT_SUPPORT)
#define OT_ERR_MIPIRX_FAILED_MALLOC          OT_DEFINE_ERR(OT_ID_MIPIRX, OT_ERR_LEVEL_ERROR, OT_ERR_NO_MEM)
#define OT_ERR_MIPIRX_BAD_IOREMAP            OT_DEFINE_ERR(OT_ID_MIPIRX, OT_ERR_LEVEL_ERROR, OT_ERR_BAD_ADDR)
...
typedef struct {
    ...
    input_mode_t input_mode; /* input mode: MIPI/LVDS/SUBLVDS/HISPI */
