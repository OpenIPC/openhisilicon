...
td_s32 ot_mpi_vb_get_common_pool_id(ot_vb_common_pools_id *pools_id);
td_s32 ot_mpi_vb_get_mod_common_pool_id(ot_vb_uid vb_uid, ot_vb_common_pools_id *pools_id);

td_s32 ot_mpi_vb_pool_share(ot_vb_pool pool, td_s32 pid);
td_s32 ot_mpi_vb_pool_unshare(ot_vb_pool pool, td_s32 pid);
td_s32 ot_mpi_vb_pool_share_all(ot_vb_pool pool);
td_s32 ot_mpi_vb_pool_unshare_all(ot_vb_pool pool);
