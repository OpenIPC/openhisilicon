...
#define CHIP_NAME_XM72050200                   0x72050200
#define CHIP_NAME_XM72050210                   0x72050210
#define CHIP_NAME_XM72050300                   0x72050300
#define CHIP_NAME_XM72050230                   0x72050230
#define CHIP_NAME_XM72050330                   0x72050330
#define CHIP_NAME_XM72050500                   0x72050500
#define CHIP_NAME_XM72050510                   0x72050510
#define CHIP_NAME_XM72050530                   0x72050530
#define CHIP_NAME_XM72020300                   0x72020300
#define CHIP_NAME_XM72020330                   0x72020330
#define CHIP_NAME_XM76050100                   0x76050100
#define CHIP_NAME_XM76060100                   0x76060100
#define CHIP_NAME_XM76080200                   0x76080200
#define CHIP_NAME_xmediav102100                  0x00102100


#define CHIP_NAME_TEST                        0x0

#if CHIP_NAME == CHIP_NAME_XM72050200
#define CHIP_NAME_STR                      "XM72050200"
#else
...
#define VI_PIPE_ONLINE_MAX_WIDTH       3072
#elif (defined xm72050200) || (defined xm72020300) || (defined xm72050300) || \
    (defined xm76050100)
...
#if (defined xm72050500) || (defined xm72050510) || (defined xm72050530) || \
    (defined xm72020330) || (defined xm72050230)
#define VI_PHYCHN_ONLINE_MAX_WIDTH       3072
#elif (defined xm72050200) || (defined xm72020300) || (defined xm72050300) || \
    (defined xm76050100)
