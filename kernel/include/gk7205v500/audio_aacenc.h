...
typedef struct {
    ...
    XMEDIA_S16 bitsPerSample;
    XMEDIA_S32 sampleRate;   /**< audio file sample rate */
    XMEDIA_S32 bitRate;      /**< encoder bit rate in bits/sec */
    XMEDIA_S16 nChannelsIn;  /**< number of channels on input (1,2) */
    XMEDIA_S16 nChannelsOut; /**< number of channels on output (1,2) */
    XMEDIA_S16 bandWidth;    /**< targeted audio bandwidth in Hz */
    AACENCTransportType transtype;
} AACENC_CONFIG;

/* Defines AACENC version */
typedef struct AACENC_VERSION_S {
    XMEDIA_U8 aVersion[AACENC_VERSION_MAX_BYTE];
} AACENC_VERSION_S;

typedef XMEDIA_U32 AAC_ENCODER_S;
...
N/A
*/
XMEDIA_S32 AACENC_GetVersion(AACENC_VERSION_S *pVersion);
...
N/A
*/
XMEDIA_S32 AACInitDefaultConfig(AACENC_CONFIG *pstConfig);
...
N/A
*/
XMEDIA_S32 AACEncoderOpen(AAC_ENCODER_S **phAacPlusEnc, AACENC_CONFIG *pstConfig);
...
N/A
*/
XMEDIA_S32 AACEncoderFrame(AAC_ENCODER_S *hAacPlusEnc, XMEDIA_S16 *ps16PcmBuf,
                       XMEDIA_U8 *pu8Outbuf, XMEDIA_S32 *ps32NumOutBytes);
...
N/A
*/
XMEDIA_VOID AACEncoderClose(AAC_ENCODER_S *hAacPlusEnc);
...
N/A
*/
XMEDIA_S32 AACEncoderRegisterModule(XMEDIA_VOID *pModuleHandle);

/**
\brief Get WorkHandle of sbrenc module.
\attention \n
N/A
\retval ::XMEDIA_VOID *    : pointer to WorkHandle of sbrenc module
\see \n
N/A
*/
XMEDIA_VOID *AAC_SBRENC_GetHandle(XMEDIA_VOID);
