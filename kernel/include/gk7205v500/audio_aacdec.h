...
typedef struct AACDEC_VERSION_S {
    XMEDIA_U8 aVersion[AACDEC_VERSION_MAX_BYTE];
} AACDEC_VERSION_S;
...
N/A
*/
XMEDIA_S32 AACDEC_GetVersion(AACDEC_VERSION_S *pVersion);
...
N/A
*/
XMEDIA_VOID AACFreeDecoder(HAACDecoder hAACDecoder);
...
\retval ::XMEDIA_FAILURE    : RESERVED API, always return XMEDIA_FAILURE.
\see \n
N/A
*/
XMEDIA_S32 AACSetRawMode(HAACDecoder hAACDecoder, XMEDIA_S32 nChans, XMEDIA_S32 sampRate);
...
N/A
*/
XMEDIA_S32 AACDecodeFindSyncHeader(HAACDecoder hAACDecoder, XMEDIA_U8 **ppInbufPtr, XMEDIA_S32 *pBytesLeft);
...
N/A
*/
XMEDIA_S32 AACDecodeFrame(HAACDecoder hAACDecoder, XMEDIA_U8 **ppInbufPtr, XMEDIA_S32 *pBytesLeft, XMEDIA_S16 *pOutPcm);
...
N/A
*/
XMEDIA_S32 AACGetLastFrameInfo(HAACDecoder hAACDecoder, AACFrameInfo *aacFrameInfo);
...
N/A
*/
XMEDIA_S32 AACDecoderSetEosFlag(HAACDecoder hAACDecoder, XMEDIA_S32 s32Eosflag);
...
N/A
*/
XMEDIA_S32 AACFlushCodec(HAACDecoder hAACDecoder);
...
N/A
*/
XMEDIA_S32 AACDecoderRegisterModule(XMEDIA_VOID *pModuleHandle);

/**
\brief Get WorkHandle of sbrdec module
\attention \n
N/A
\retval :: XMEDIA_VOID *          : pointer to WorkHandle of sbrdec module
\see \n
N/A
*/
XMEDIA_VOID *AAC_SBRDEC_GetHandle(XMEDIA_VOID);
