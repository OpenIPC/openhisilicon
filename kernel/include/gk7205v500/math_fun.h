...
__inline static XMEDIA_BOOL IS_LITTLE_END(void)
{
    ...
    return (unEndTest.u32Test > 0x01020304) ? (XMEDIA_TRUE) : (XMEDIA_FALSE);
}
...
__inline static XMEDIA_VOID Rgb2Yc(XMEDIA_U16 r, XMEDIA_U16 g, XMEDIA_U16 b, XMEDIA_U16 * py, XMEDIA_U16 * pcb, XMEDIA_U16 * pcr)
{
...
__inline static XMEDIA_U32 Rgb2Yuv(XMEDIA_U32 u32Rgb)
{
    XMEDIA_U16 y,u,v;
...
__inline static XMEDIA_VOID Rgb2Yc_full(XMEDIA_U16 r, XMEDIA_U16 g, XMEDIA_U16 b, XMEDIA_U16 *py, XMEDIA_U16 *pcb, XMEDIA_U16 *pcr)
{
...
__inline static XMEDIA_U32 Rgb2Yuv_full(XMEDIA_U32 u32Rgb)
{
    XMEDIA_U16 y,u,v;
...
__inline static XMEDIA_VOID Rgb2Yc_8BIT(XMEDIA_U8 r, XMEDIA_U8 g, XMEDIA_U8 b, XMEDIA_U8 *py, XMEDIA_U8 *pcb, XMEDIA_U8 *pcr)
{
...
__inline static XMEDIA_U32 Rgb2Yuv_8BIT(XMEDIA_U32 u32Rgb)
{
    XMEDIA_U8 y,u,v;
...
__inline static XMEDIA_VOID Rgb2Yc_full_8BIT(XMEDIA_U8 r, XMEDIA_U8 g, XMEDIA_U8 b, XMEDIA_U8 *py, XMEDIA_U8 *pcb, XMEDIA_U8 *pcr)
{
...
__inline static XMEDIA_U32 Rgb2Yuv_full_8BIT(XMEDIA_U32 u32Rgb)
{
    XMEDIA_U8 y,u,v;
...
typedef struct FPS_CTRL_S
{
    XMEDIA_U32 u32Ffps;
    XMEDIA_U32 u32Tfps;
    XMEDIA_U32 u32FrmKey;
} FPS_CTRL_S;

__inline static XMEDIA_VOID InitFps(FPS_CTRL_S *pFrmCtrl, XMEDIA_U32 u32FullFps,
                                XMEDIA_U32 u32TagFps)
{
...
__inline static XMEDIA_BOOL FpsControl(FPS_CTRL_S *pFrmCtrl)
{
    XMEDIA_BOOL   bReturn       = XMEDIA_FALSE;
...
__inline static XMEDIA_U32 GetLowAddr(XMEDIA_U64  u64Phyaddr)
{
    return (XMEDIA_U32)u64Phyaddr;
}


__inline static XMEDIA_U32 GetHighAddr(XMEDIA_U64  u64Phyaddr)
{
    return (XMEDIA_U32)(u64Phyaddr>>32);
}
