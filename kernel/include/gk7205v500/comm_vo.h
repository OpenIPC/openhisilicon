...
typedef XMEDIA_U32 VO_INTF_TYPE_E;
...
typedef struct VO_BORDER_S {
    XMEDIA_BOOL bBorderEn;
    BORDER_S stBorder;
} VO_BORDER_S;

typedef struct VO_QUERY_STATUS_S {
    XMEDIA_U32 u32ChnBufUsed;
} VO_QUERY_STATUS_S;
...
typedef struct VO_VIDEO_LAYER_ATTR_S {
    RECT_S stDispRect;
    SIZE_S stImageSize;
    XMEDIA_U32 u32DispFrmRt;
    PIXEL_FORMAT_E enPixFormat;
    XMEDIA_BOOL bDoubleFrame;
    XMEDIA_BOOL bClusterMode;
...
typedef struct VO_ZOOM_RATIO_S {
    XMEDIA_U32 u32XRatio;
    XMEDIA_U32 u32YRatio;
    XMEDIA_U32 u32WRatio;
    XMEDIA_U32 u32HRatio;
} VO_ZOOM_RATIO_S;
...
typedef struct VO_CSC_S {
    ...
    XMEDIA_U32 u32Luma;
    XMEDIA_U32 u32Contrast;
    XMEDIA_U32 u32Hue;
    XMEDIA_U32 u32Satuature;
} VO_CSC_S;
...
typedef struct VO_LAYER_BOUNDARY_S {
    XMEDIA_U32 u32Width;
    XMEDIA_U32 u32Color[2];
} VO_LAYER_BOUNDARY_S;

typedef struct VO_CHN_BOUNDARY_S {
    XMEDIA_BOOL bBoundaryEn;
    XMEDIA_U32 u32ColorIndex;
} VO_CHN_BOUNDARY_S;

typedef struct VO_MOD_PARAM_S {
    XMEDIA_BOOL bTransparentTransmit;
    XMEDIA_BOOL bExitDev;
    XMEDIA_BOOL bWbcBgBlackEn;
    XMEDIA_BOOL bDevClkExtEn;
    XMEDIA_BOOL bSaveBufMode[VO_MAX_PHY_DEV_NUM];
} VO_MOD_PARAM_S;
...
typedef struct VO_USER_INTFSYNC_PLL_S {
    XMEDIA_U32 u32Fbdiv;
    XMEDIA_U32 u32Frac;
    XMEDIA_U32 u32Refdiv;
    XMEDIA_U32 u32Postdiv1;
    XMEDIA_U32 u32Postdiv2;
