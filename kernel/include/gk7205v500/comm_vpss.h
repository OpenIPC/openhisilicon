...
typedef struct VPSS_GRP_SHARPEN_MANUAL_ATTR_S {
    XMEDIA_U16 au16TextureStr[VPSS_SHARPEN_GAIN_NUM];
    XMEDIA_U16 au16EdgeStr[VPSS_SHARPEN_GAIN_NUM];
...
typedef struct VPSS_GRP_SHARPEN_AUTO_ATTR_S {
    XMEDIA_U16 au16TextureStr[VPSS_SHARPEN_GAIN_NUM][VPSS_AUTO_ISO_STRENGTH_NUM];
    XMEDIA_U16 au16EdgeStr[VPSS_SHARPEN_GAIN_NUM][VPSS_AUTO_ISO_STRENGTH_NUM];
    XMEDIA_U16 au16TextureFreq[VPSS_AUTO_ISO_STRENGTH_NUM];
    XMEDIA_U16 au16EdgeFreq[VPSS_AUTO_ISO_STRENGTH_NUM];
    XMEDIA_U8  au8OverShoot[VPSS_AUTO_ISO_STRENGTH_NUM];
    XMEDIA_U8  au8UnderShoot[VPSS_AUTO_ISO_STRENGTH_NUM];
    XMEDIA_U8  au8ShootSupStr[VPSS_AUTO_ISO_STRENGTH_NUM];
    XMEDIA_U8  au8DetailCtrl[VPSS_AUTO_ISO_STRENGTH_NUM];
} VPSS_GRP_SHARPEN_AUTO_ATTR_S;

typedef struct VPSS_GRP_SHARPEN_ATTR_S {
    XMEDIA_BOOL                         bEnable;
    OPERATION_MODE_E                enOpType;
    XMEDIA_U8                           au8LumaWgt[VPSS_YUV_SHPLUMA_NUM];
    VPSS_GRP_SHARPEN_MANUAL_ATTR_S  stSharpenManualAttr;
    VPSS_GRP_SHARPEN_AUTO_ATTR_S    stSharpenAutoAttr;
} VPSS_GRP_SHARPEN_ATTR_S;

typedef struct {
    XMEDIA_U8  IES0, IES1, IES2, IES3;
    XMEDIA_U16 IEDZ : 10, _rb_ : 6;
} tV1IEy;

typedef struct {
    XMEDIA_U8  SPN6 : 3, SFR  : 5;
    XMEDIA_U8  SBN6 : 3, PBR6 : 5;
    XMEDIA_U8  SFS2, SFT2, SBR2;
    XMEDIA_U8  SFS4, SFT4, SBR4;

    XMEDIA_U16 STH1 : 9,  SFN1 : 3, SFN0  : 3, NRyEn : 1;
    XMEDIA_U16 STH2 : 9,  SFN2 : 3, BWSF4 : 1, kMode : 3;
    XMEDIA_U16 STH3 : 9,  SFN3 : 3, tEdge : 2, TriTh : 1, _rb_  : 1;
} tV1SFy;

typedef struct {
    XMEDIA_U16 MADZ : 10, MAI0 : 2, MAI1 : 2,  MAI2 : 2;
    XMEDIA_U8  MADK,      MABR;
    XMEDIA_U16 MATH : 10, MATE : 4, MATW : 2;
    XMEDIA_U8  MASW :  4, MABW : 3, MAXN : 1, _rB_;
} tV1MDy;

typedef struct {
    XMEDIA_U16 TFS : 4,  TDZ : 10, TDX : 2;
    XMEDIA_U8  TFR[5],   TSS : 4,  TSI : 1, _rb_ : 2;
    XMEDIA_U16 SDZ : 10, STR : 5,  bRef : 1;
} tV1TFy;

typedef struct {
    XMEDIA_U8  SFC, _rb_ : 2, TFC : 6;
    XMEDIA_U16 CSFS : 10,    CSFR : 6;
    XMEDIA_U16 CTFR : 11,    CTFS : 4,    CIIR : 1;
} tV1NRc;
...
typedef struct {
    ...
    XMEDIA_U16 SBSk2[32], SDSk2[32];
    XMEDIA_U16 SBSk3[32], SDSk3[32];
} VPSS_NRX_V1_S;
...
typedef struct {
    ...
    XMEDIA_U16 SRT0 : 5, SRT1 : 5, JMODE : 3,  DeIdx : 3;
    XMEDIA_U8  DeRate, SFR6[3];

    XMEDIA_U8  SFS1,  SFT1,  SBR1;
    XMEDIA_U8  SFS2,  SFT2,  SBR2;
    XMEDIA_U8  SFS4,  SFT4,  SBR4;

    XMEDIA_U16 STH1 : 9, SFN1 : 3, SFN0  : 3, NRyEn : 1;
    XMEDIA_U16 STH2 : 9, SFN2 : 3, BWSF4 : 1, kMode : 3;
    XMEDIA_U16 STH3 : 9, SFN3 : 3, TriTh : 1, _rb0_ : 3;

    XMEDIA_U16 SBSk[32], SDSk[32];
} tV2_VPSS_SFy;

typedef struct {
    XMEDIA_U16 MADZ0   : 9,  MAI00    : 2,  MAI01  : 2,  MAI02    : 2,  biPath  : 1;
    XMEDIA_U16 MADZ1   : 9,  MAI10    : 2,  MAI11  : 2,  MAI12    : 2,  _rb0_ : 1;
    XMEDIA_U8  MABR0, MABR1;

    XMEDIA_U16 MATH0   : 10,  MATE0   : 4,  MATW   : 2;
    XMEDIA_U16 MATH1   : 10,  MATE1   : 4,  _rb1_  : 2;


    XMEDIA_U8  MASW    :  4,  _rb2_   : 4;
    XMEDIA_U8  MABW0   :  4,  MABW1   : 4;
} tV2_VPSS_MDy;

typedef struct {
    XMEDIA_U16 TFS0  :  4, TDZ0   : 10, TDX0    : 2;
    XMEDIA_U16 TFS1  :  4, TDZ1   : 10, TDX1    : 2;

    XMEDIA_U16 SDZ0  : 10, STR0   : 5,  DZMode0 : 1;
    XMEDIA_U16 SDZ1  : 10, STR1   : 5,  DZMode1 : 1;

    XMEDIA_U8  TFR0[6],    TSS0   : 4,  TSI0    : 4;
    XMEDIA_U8  TFR1[6],    TSS1   : 4,  TSI1    : 4;

    XMEDIA_U8  RFI   : 3,  tEdge  : 2,  bRef    : 1,  _rb_ : 2;
} tV2_VPSS_TFy;

typedef struct {
    XMEDIA_U16 advMATH : 1, RFDZ  : 9,    _rb_ : 6;
    XMEDIA_U8  RFUI    : 3, RFSLP : 5;
} tV2_VPSS_RFs;

typedef struct {
    tV2_VPSS_IEy  IEy;
    tV2_VPSS_SFy  SFy;
    XMEDIA_U8 NRcEn : 1, _rb_ : 7;
} tV2_VPSS_NRc;

typedef struct {
    XMEDIA_U8  SFC;
    XMEDIA_U16 CTFS : 4, TFC : 6, _rb_ : 6;
...
typedef struct {
    XMEDIA_U8  IES0, IES1, IES2, IES3;
    XMEDIA_U16  IEDZ : 10, IEEn : 1, _rb_ : 5;
} tV3_VPSS_IEy;
...
typedef struct {
    ...
    XMEDIA_U8  SFR6[4], SBR6[2], DeRate;
    ...
    XMEDIA_U16  STH1 : 9,  SFN1 : 3, SFN0  : 3, NRyEn   : 1;
    XMEDIA_U16  STHd1 : 9, _rb0_ : 7;
    XMEDIA_U16  STH2 : 9,  SFN2 : 3, kMode : 3, _rb1_   : 1;
    XMEDIA_U16  STHd2 : 9, _rb2_ : 7;
    XMEDIA_U16  SBSk[32], SDSk[32];
} tV3_VPSS_SFy;
...
typedef struct {
    ...
    XMEDIA_U8  TSS0 : 4,   TSI0 : 4,  TFR0[6];
    XMEDIA_U8  TSS1 : 4,   TSI1 : 4,  TFR1[6];

    XMEDIA_U8  TFRS : 4,   TED  : 2,   bRef    : 1,  _rb_ : 1;
} tV3_VPSS_TFy;

typedef struct {
    XMEDIA_U16  MADZ0   : 9,   MAI00 : 2,  MAI01  : 2, MAI02 : 2, _rb0_ : 1;
    XMEDIA_U16  MADZ1   : 9,   MAI10 : 2,  MAI11  : 2, MAI12 : 2, _rb1_ : 1;
    XMEDIA_U8  MABR0, MABR1;

    XMEDIA_U16  MATH0   : 10,  MATE0 : 4,  MATW   : 2;
    XMEDIA_U16  MATHd0  : 10,  _rb2_ : 6;
    XMEDIA_U16  MATH1   : 10,  _rb3_ : 6;
    XMEDIA_U16  MATHd1  : 10,  _rb4_ : 6;
    XMEDIA_U8  MASW    :  4,  MATE1 : 4;
    XMEDIA_U8  MABW0   :  4,  MABW1 : 4;

    XMEDIA_U16  AdvMATH : 1,   AdvTH : 12, _rb5_  : 3;
} tV3_VPSS_MDy;

typedef struct {
    XMEDIA_U8  SFC, TFC : 6, _rb0_ : 2;
    XMEDIA_U8  TRC, TPC : 6, _rb1_ : 2;

    XMEDIA_BOOL MODE;
    XMEDIA_U8  PRESFC : 6, _rb2_ : 2;
} tV3_VPSS_NRc;
...
typedef struct VPSS_CHN_BUF_WRAP_S {
    ...
    XMEDIA_U32  u32WrapBufferSize;
} VPSS_CHN_BUF_WRAP_S;

typedef struct VPSS_PARAM_MOD_S {
    XMEDIA_BOOL bOneBufForLowDelay;
    XMEDIA_U32  u32VpssVbSource;
    XMEDIA_U32  u32VpssSplitNodeNum;
    XMEDIA_BOOL bHdrSupport;
    XMEDIA_BOOL bNrQuickStart;
} VPSS_MOD_PARAM_S;
