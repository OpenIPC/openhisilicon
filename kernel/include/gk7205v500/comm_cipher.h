...
#define  ERR_CODE_CIPHER_NOT_INIT                     (XMEDIA_S32)(0x804D0001)
#define  ERR_CODE_CIPHER_INVALID_HANDLE               (XMEDIA_S32)(0x804D0002)
#define  ERR_CODE_CIPHER_INVALID_POINT                (XMEDIA_S32)(0x804D0003)
#define  ERR_CODE_CIPHER_INVALID_PARA                 (XMEDIA_S32)(0x804D0004)
#define  ERR_CODE_CIPHER_FAILED_INIT                  (XMEDIA_S32)(0x804D0005)
#define  ERR_CODE_CIPHER_FAILED_GETHANDLE             (XMEDIA_S32)(0x804D0006)
#define  ERR_CODE_CIPHER_FAILED_RELEASEHANDLE         (XMEDIA_S32)(0x804D0007)
#define  ERR_CODE_CIPHER_FAILED_CONFIGAES             (XMEDIA_S32)(0x804D0008)
#define  ERR_CODE_CIPHER_FAILED_CONFIGDES             (XMEDIA_S32)(0x804D0009)
#define  ERR_CODE_CIPHER_FAILED_ENCRYPT               (XMEDIA_S32)(0x804D000A)
#define  ERR_CODE_CIPHER_FAILED_DECRYPT               (XMEDIA_S32)(0x804D000B)
#define  ERR_CODE_CIPHER_BUSY                         (XMEDIA_S32)(0x804D000C)
#define  ERR_CODE_CIPHER_NO_AVAILABLE_RNG             (XMEDIA_S32)(0x804D000D)
#define  ERR_CODE_CIPHER_FAILED_MEM                   (XMEDIA_S32)(0x804D000E)
#define  ERR_CODE_CIPHER_UNAVAILABLE                  (XMEDIA_S32)(0x804D000F)
#define  ERR_CODE_CIPHER_OVERFLOW                     (XMEDIA_S32)(0x804D0010)
#define  ERR_CODE_CIPHER_HARD_STATUS                  (XMEDIA_S32)(0x804D0011)
#define  ERR_CODE_CIPHER_TIMEOUT                      (XMEDIA_S32)(0x804D0012)
#define  ERR_CODE_CIPHER_UNSUPPORTED                  (XMEDIA_S32)(0x804D0013)
#define  ERR_CODE_CIPHER_REGISTER_IRQ                 (XMEDIA_S32)(0x804D0014)
#define  ERR_CODE_CIPHER_ILLEGAL_UUID                 (XMEDIA_S32)(0x804D0015)
#define  ERR_CODE_CIPHER_ILLEGAL_KEY                  (XMEDIA_S32)(0x804D0016)
#define  ERR_CODE_CIPHER_INVALID_ADDR                 (XMEDIA_S32)(0x804D0017)
#define  ERR_CODE_CIPHER_INVALID_LENGTH               (XMEDIA_S32)(0x804D0018)
#define  ERR_CODE_CIPHER_ILLEGAL_DATA                 (XMEDIA_S32)(0x804D0019)
#define  ERR_CODE_CIPHER_RSA_SIGN                     (XMEDIA_S32)(0x804D001A)
#define  ERR_CODE_CIPHER_RSA_VERIFY                   (XMEDIA_S32)(0x804D001B)
#define  ERR_CODE_CIPHER_MEMSET_S_FAILED              (XMEDIA_S32)(0x804D001C)
#define  ERR_CODE_CIPHER_MEMCPY_S_FAILED              (XMEDIA_S32)(0x804D001D)
#define  ERR_CODE_CIPHER_RSA_CRYPT_FAILED             (XMEDIA_S32)(0x804D001E)
...
{
    XMEDIA_U32 u32EvenKey[8];
    XMEDIA_U32 u32OddKey[8];
    XMEDIA_U32 u32IV[4];
    UNF_CIPHER_BIT_WIDTH_E enBitWidth;
    UNF_CIPHER_KEY_LENGTH_E enKeyLen;
    UNF_CIPHER_CTRL_CHANGE_FLAG_S stChangeFlags;
...
typedef struct UNF_CIPHER_CTRL_AES_CCM_GCM_S
{
    ...
    UNF_CIPHER_KEY_LENGTH_E enKeyLen;
    XMEDIA_U32 u32IVLen;
    XMEDIA_U32 u32TagLen;
    XMEDIA_U32 u32ALen;
    XMEDIA_SIZE_T szAPhyAddr;
...
{
    XMEDIA_SIZE_T szSrcPhyAddr;
    XMEDIA_SIZE_T szDestPhyAddr;
    XMEDIA_U32 u32ByteLength;
    XMEDIA_BOOL bOddKey;
} UNF_CIPHER_DATA_S;
...
typedef struct
{
    XMEDIA_U8 *pu8HMACKey;
    XMEDIA_U32 u32HMACKeyLen;
