...
{
    XMEDIA_U32 u32TopWidth;
    XMEDIA_U32 u32BottomWidth;
    XMEDIA_U32 u32LeftWidth;
    XMEDIA_U32 u32RightWidth;
    XMEDIA_U32 u32Color;
} BORDER_S;
...
{
    XMEDIA_S32  s32SrcFrameRate;
    XMEDIA_S32  s32DstFrameRate;
} FRAME_RATE_CTRL_S;
...
{
    XMEDIA_U64 u64LumaPixSum;
    XMEDIA_U32 u32LumaPixAverage;
    XMEDIA_U64 u64PTS;
} LUMA_INFO_S;
...
{
    XMEDIA_U8       au8ImageDescription[DCF_DRSCRIPTION_LENGTH];
    XMEDIA_U8       au8Make[DCF_DRSCRIPTION_LENGTH];
    XMEDIA_U8       au8Model[DCF_DRSCRIPTION_LENGTH];
    XMEDIA_U8       au8Software[DCF_DRSCRIPTION_LENGTH];

    XMEDIA_U8       u8LightSource;
    XMEDIA_U32      u32FocalLength;
    XMEDIA_U8       u8SceneType;
    XMEDIA_U8       u8CustomRendered;
    XMEDIA_U8       u8FocalLengthIn35mmFilm;
    XMEDIA_U8       u8SceneCaptureType;
    XMEDIA_U8       u8GainControl;
    XMEDIA_U8       u8Contrast;
    XMEDIA_U8       u8Saturation;
    XMEDIA_U8       u8Sharpness;
    XMEDIA_U8       u8MeteringMode;
} ISP_DCF_CONST_INFO_S;

typedef struct ISP_DCF_UPDATE_INFO_S
{
    XMEDIA_U32      u32ISOSpeedRatings;
    XMEDIA_U32      u32ExposureTime;
    XMEDIA_U32      u32ExposureBiasValue;
    XMEDIA_U8       u8ExposureProgram;
    XMEDIA_U32      u32FNumber;
    XMEDIA_U32      u32MaxApertureValue;
    XMEDIA_U8       u8ExposureMode;
    XMEDIA_U8       u8WhiteBalance;
...
{
    XMEDIA_U8           au8CaptureTime[DCF_CAPTURE_TIME_LENGTH];
    XMEDIA_BOOL         bFlash;
    XMEDIA_U32          u32DigitalZoomRatio;
...
typedef struct ISP_FRAME_INFO_S
{
    ...
    XMEDIA_U32      u32Again;
    XMEDIA_U32      u32Dgain;
    XMEDIA_U32      au32Ratio[3];
    XMEDIA_U32      u32IspNrStrength;
    XMEDIA_U32      u32FNumber;
    XMEDIA_U32      u32SensorID;
    XMEDIA_U32      u32SensorMode;
...
{
    XMEDIA_U32 u32Numerator;
    XMEDIA_U32 u32Denominator;
} DNG_RATIONAL_S;

typedef struct DNG_IMAGE_DYNAMIC_INFO_S
{
    XMEDIA_U32 au32BlackLevel[ISP_BAYER_CHN];
    DNG_RATIONAL_S astAsShotNeutral[CFACOLORPLANE];
    XMEDIA_DOUBLE adNoiseProfile[DNG_NP_SIZE];
...
typedef struct ISP_CONFIG_INFO_S
{
    ...
    XMEDIA_U32  u32IspDgain;
    XMEDIA_U32  u32ExposureTime;
    XMEDIA_U32  au32WhiteBalanceGain[ISP_WB_GAIN_NUM];
    XMEDIA_U32  u32ColorTemperature;
    XMEDIA_U16  au16CapCCM[ISP_CAP_CCM_NUM];
} ISP_CONFIG_INFO_S;

typedef struct VIDEO_SUPPLEMENT_S
{
    XMEDIA_U64   u64JpegDCFPhyAddr;
    XMEDIA_U64   u64IspInfoPhyAddr;
    XMEDIA_U64   u64LowDelayPhyAddr;
    XMEDIA_U64   u64MotionDataPhyAddr;
    XMEDIA_U64   u64FrameDNGPhyAddr;

    XMEDIA_VOID* ATTRIBUTE pJpegDCFVirAddr;
    XMEDIA_VOID* ATTRIBUTE pIspInfoVirAddr;
    XMEDIA_VOID* ATTRIBUTE pLowDelayVirAddr;
    XMEDIA_VOID* ATTRIBUTE pMotionDataVirAddr;
    XMEDIA_VOID* ATTRIBUTE pFrameDNGVirAddr;
} VIDEO_SUPPLEMENT_S;
...
typedef struct VIDEO_FRAME_S
{
    ...
    COLOR_GAMUT_E       enColorGamut;
    ROTATION_E          enRotationFormat;
    XMEDIA_U32              u32HeaderStride[3];
    XMEDIA_U32              u32Stride[3];
    XMEDIA_U32              u32ExtStride[3];

    XMEDIA_U64              u64HeaderPhyAddr[3];
    XMEDIA_U64              u64HeaderVirAddr[3];
    XMEDIA_U64              u64PhyAddr[3];
    XMEDIA_U64              u64VirAddr[3];
    XMEDIA_U64              u64ExtPhyAddr[3];
    XMEDIA_U64              u64ExtVirAddr[3];

    XMEDIA_S16              s16OffsetTop;
    XMEDIA_S16              s16OffsetBottom;
    XMEDIA_S16              s16OffsetLeft;
    XMEDIA_S16              s16OffsetRight;

    XMEDIA_U32              u32MaxLuminance;
    XMEDIA_U32              u32MinLuminance;

    XMEDIA_U32              u32TimeRef;
    XMEDIA_U64              u64PTS;

    XMEDIA_U64              u64PrivateData;
...
{
    XMEDIA_U32 u32VBSize;

    XMEDIA_U32 u32HeadStride;
    XMEDIA_U32 u32HeadSize;
    XMEDIA_U32 u32HeadYSize;

    XMEDIA_U32 u32MainStride;
    XMEDIA_U32 u32MainSize;
    XMEDIA_U32 u32MainYSize;

    XMEDIA_U32 u32ExtStride;
    XMEDIA_U32 u32ExtYSize;
}VB_CAL_CONFIG_S;
...
{
    XMEDIA_BOOL    bAspect;
    XMEDIA_S32     s32XRatio;
    XMEDIA_S32     s32YRatio;
    XMEDIA_S32     s32XYRatio;
    XMEDIA_S32 s32CenterXOffset;
    XMEDIA_S32 s32CenterYOffset;
    XMEDIA_S32 s32DistortionRatio;
} LDC_ATTR_S;


typedef struct LDCV2_ATTR_S
{
    XMEDIA_S32 s32FocalLenX;
    XMEDIA_S32 s32FocalLenY;
    XMEDIA_S32 s32CoorShiftX;
    XMEDIA_S32 s32CoorShiftY;
    XMEDIA_S32 as32SrcCaliRatio[SRC_LENS_COEF_SEG][SRC_LENS_COEF_NUM];
    XMEDIA_S32 s32SrcJunPt;
    XMEDIA_S32 as32DstCaliRatio[DST_LENS_COEF_SEG][DST_LENS_COEF_NUM];
    XMEDIA_S32 as32DstJunPt[DST_LENS_COEF_SEG_POINT];
    XMEDIA_S32 s32MaxDu;
} LDCV2_ATTR_S;
