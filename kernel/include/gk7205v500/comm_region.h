...
typedef XMEDIA_U32 RGN_HANDLE;
typedef XMEDIA_U32 RGN_HANDLEGROUP;
...
typedef struct OVERLAY_QP_INFO_S {
    XMEDIA_BOOL bAbsQp;
    XMEDIA_S32 s32Qp;
    XMEDIA_BOOL bQpDisable;
} OVERLAY_QP_INFO_S;

typedef struct OVERLAY_INVERT_COLOR_S {
    SIZE_S stInvColArea;
    XMEDIA_U32 u32LumThresh;
    INVERT_COLOR_MODE_E enChgMod;
    XMEDIA_BOOL bInvColEn;
...
typedef struct OVERLAY_CHN_ATTR_S {
    ...
    XMEDIA_U16 u16ColorLUT[RGN_COLOR_LUT_NUM];
} OVERLAY_CHN_ATTR_S;
...
typedef struct RGN_CANVAS_INFO_S {
    ...
    XMEDIA_U64 u64VirtAddr;
    SIZE_S stSize;
    XMEDIA_U32 u32Stride;
    PIXEL_FORMAT_E enPixelFmt;
} RGN_CANVAS_INFO_S;

#define NOTICE_RGN_BUFFER_CHANGE DEFINE_ERR_CODE(MOD_ID_RGN, EN_ERR_LEVEL_NOTICE, XMEDIA_SUCCESS)
