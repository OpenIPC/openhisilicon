...
typedef struct DIS_ATTR_S {
    XMEDIA_BOOL bEnable;
    XMEDIA_BOOL bGdcBypass;
    XMEDIA_U32 u32MovingSubjectLevel;
    XMEDIA_S32 s32RollingShutterCoef;
    XMEDIA_S32 s32Timelag;
    XMEDIA_U32 u32ViewAngle;
    XMEDIA_U32 u32HorizontalLimit;
    XMEDIA_U32 u32VerticalLimit;
    XMEDIA_BOOL bStillCrop;
} DIS_ATTR_S;
...
typedef struct DIS_CONFIG_S {
    ...
    XMEDIA_U32 u32BufNum;
    XMEDIA_U32 u32CropRatio;
    XMEDIA_U32 u32FrameRate;
    XMEDIA_U32 u32GyroOutputRange;
    XMEDIA_U32 u32GyroDataBitWidth;
    XMEDIA_BOOL bCameraSteady;
    XMEDIA_BOOL bScale;
} DIS_CONFIG_S;
