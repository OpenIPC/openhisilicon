...
__inline static XMEDIA_VOID COMMON_GetPicBufferConfigV2(XMEDIA_U32 u32Width, XMEDIA_U32 u32Height,
    PIXEL_FORMAT_E enPixelFormat, DATA_BITWIDTH_E enBitWidth,
    COMPRESS_MODE_E enCmpMode, XMEDIA_U32 u32Align, VIDEO_FORMAT_E enVideoFormat, VB_CAL_CONFIG_S *pstCalConfig)
{
    XMEDIA_U32 u32BitWidth = 0;
    XMEDIA_U32 u32VBSize = 0;
    XMEDIA_U32 u32HeadSize = 0;
    XMEDIA_U32 u32AlignHeight;
    XMEDIA_U32 u32MainStride = 0;
    XMEDIA_U32 u32MainSize = 0;
    XMEDIA_U32 u32HeadStride = 0;
    XMEDIA_U32 u32HeadYSize = 0;
    XMEDIA_U32 u32YSize = 0;
    ...
    if((enVideoFormat == VIDEO_FORMAT_TILE_16x4)&&(enCmpMode == COMPRESS_MODE_NONE))
    {
        u32Width = ALIGN_UP(u32Width, 16);
        u32AlignHeight = ALIGN_UP(u32Height, 4);
    }
    else
    {
        return;
    ...
    if (enCmpMode == COMPRESS_MODE_NONE) {
        ...
        if ((PIXEL_FORMAT_YVU_SEMIPLANAR_420 == enPixelFormat) ||
            ...
            if(enVideoFormat != VIDEO_FORMAT_TILE_16x4)
            {
                u32MainSize = (u32MainStride * u32AlignHeight * 3) >> 1;
            }
            else
            {
                XMEDIA_U32 UVHeight, UVSize;
                UVHeight = ALIGN_UP(u32AlignHeight/2, 4);
                UVSize = u32MainStride * UVHeight;
                u32MainSize = u32YSize+UVSize;
            }
        ...
        XMEDIA_U32 u32CmpRatioLuma = 1450;
        XMEDIA_U32 u32CmpRatioChroma = 1800;
        XMEDIA_U32 u32CSizeFor420;
...
__inline static XMEDIA_VOID COMMON_GetPicBufferConfig(XMEDIA_U32 u32Width, XMEDIA_U32 u32Height,
    PIXEL_FORMAT_E enPixelFormat, DATA_BITWIDTH_E enBitWidth,
    COMPRESS_MODE_E enCmpMode, XMEDIA_U32 u32Align, VB_CAL_CONFIG_S *pstCalConfig)
{
    XMEDIA_U32 u32BitWidth = 0;
    XMEDIA_U32 u32VBSize = 0;
    XMEDIA_U32 u32HeadSize = 0;
...
__inline static XMEDIA_U32 COMMON_GetPicBufferSizeV2(XMEDIA_U32 u32Width, XMEDIA_U32 u32Height,
    PIXEL_FORMAT_E enPixelFormat, DATA_BITWIDTH_E enBitWidth, COMPRESS_MODE_E enCmpMode, XMEDIA_U32 u32Align, VIDEO_FORMAT_E enVideoFormat)
{
    ...
    {
        /*
        "Err, now only support video formart(VIDEO_FORMAT_TILE_16x4) and compress mode(COMPRESS_MODE_NONE)"
        "please use COMMON_GetPicBufferConfig function to caculate vb"
        */
        return 0;
    }

    COMMON_GetPicBufferConfigV2(u32Width, u32Height, enPixelFormat, enBitWidth, enCmpMode, u32Align, enVideoFormat, &stCalConfig);

    return stCalConfig.u32VBSize;
}

__inline static XMEDIA_U32 COMMON_GetPicBufferSize(XMEDIA_U32 u32Width, XMEDIA_U32 u32Height,
    PIXEL_FORMAT_E enPixelFormat, DATA_BITWIDTH_E enBitWidth, COMPRESS_MODE_E enCmpMode, XMEDIA_U32 u32Align)
{
    VB_CAL_CONFIG_S stCalConfig;
...
__inline static XMEDIA_U32 VPSS_GetWrapBufferSize(XMEDIA_U32 u32Width, XMEDIA_U32 u32Height, XMEDIA_U32 u32BufLine,
    PIXEL_FORMAT_E enPixelFormat, DATA_BITWIDTH_E enBitWidth, COMPRESS_MODE_E enCmpMode, XMEDIA_U32 u32Align)
{
    VB_CAL_CONFIG_S stCalConfig;
...
__inline static XMEDIA_U32 VI_GetRawBufferSize(XMEDIA_U32 u32Width, XMEDIA_U32 u32Height,
                                           PIXEL_FORMAT_E enPixelFormat, COMPRESS_MODE_E enCmpMode, XMEDIA_U32 u32Align)
{
    XMEDIA_U32 u32BitWidth;
    XMEDIA_U32 u32Size = 0;
    XMEDIA_U32 u32Stride = 0;
    XMEDIA_U32 u32CmpRatioLine = 1600;
    XMEDIA_U32 u32CmpRatioFrame = 2000;
...
__inline static XMEDIA_U32 VENC_GetRefPicInfoBufferSize(PAYLOAD_TYPE_E enType, XMEDIA_U32 u32Width, XMEDIA_U32 u32Height,
                                                    XMEDIA_U32 u32Align)
{
    XMEDIA_U32 u32Size;
    XMEDIA_U32 u32AlignWidth, u32AlignHeight;
    XMEDIA_U32 u32TmvSize, u32PmeSize, u32PmeInfoSize;
...
__inline static XMEDIA_U32 VENC_GetRefBufferSize(PAYLOAD_TYPE_E enType, XMEDIA_U32 u32Width, XMEDIA_U32 u32Height,
                                             DATA_BITWIDTH_E enBitWidth, XMEDIA_U32 u32Align)
{
    XMEDIA_U32 u32Size = 0;
    XMEDIA_U32 u32AlignWidth, u32AlignHeight, u32BitWidth;
    XMEDIA_U32 u32YHeaderSize, u32CHeaderSize, u32YSize, u32CSize;
...
__inline static XMEDIA_U32 VENC_GetQpmapSizeStride(XMEDIA_U32 u32Width)
{
...
__inline static XMEDIA_U32 VENC_GetQpmapSize(XMEDIA_U32 u32Width, XMEDIA_U32 u32Height)
{
    XMEDIA_U32 u32Stride, u32AlignHeight;
...
__inline static XMEDIA_U32 VENC_GetSkipWeightSizeStride(PAYLOAD_TYPE_E enType, XMEDIA_U32 u32Width)
{
...
__inline static XMEDIA_U32 VENC_GetSkipWeightSize(PAYLOAD_TYPE_E enType, XMEDIA_U32 u32Width, XMEDIA_U32 u32Height)
{
    XMEDIA_U32 u32Stride, u32AlignHeight;
