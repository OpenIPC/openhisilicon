...
#define COMPAT_POINTER(ptr, type)\
    do {\
        XMEDIA_UL ulAddr   =  (XMEDIA_UL)ptr;\
        XMEDIA_U32 u32Addr =  (XMEDIA_U32)ulAddr;\
        ptr = (type)(XMEDIA_UL)u32Addr;\
    } while(0)
...
{
    XMEDIA_CHAR aVersion[VERSION_NAME_MAXLEN];
} MPP_VERSION_S;


typedef XMEDIA_S32 AI_CHN;
typedef XMEDIA_S32 AO_CHN;
typedef XMEDIA_S32 AENC_CHN;
typedef XMEDIA_S32 ADEC_CHN;
typedef XMEDIA_S32 AUDIO_DEV;
typedef XMEDIA_S32 VI_DEV;
typedef XMEDIA_S32 VI_PIPE;
typedef XMEDIA_S32 VI_CHN;
typedef XMEDIA_S32 VI_STITCH_GRP;
typedef XMEDIA_S32 VO_DEV;
typedef XMEDIA_S32 VO_LAYER;
typedef XMEDIA_S32 VO_CHN;
typedef XMEDIA_S32 VO_WBC;
typedef XMEDIA_S32 GRAPHIC_LAYER;
typedef XMEDIA_S32 VENC_CHN;
typedef XMEDIA_S32 VDEC_CHN;
typedef XMEDIA_S32 IVE_HANDLE;
typedef XMEDIA_S32 CLS_HANDLE;
typedef XMEDIA_S32 FD_CHN;
typedef XMEDIA_S32 MD_CHN;
typedef XMEDIA_S32 ISP_DEV;
typedef XMEDIA_S32 BLK_DEV;
typedef XMEDIA_S32 SENSOR_ID;
typedef XMEDIA_S32 MIPI_DEV;
typedef XMEDIA_S32 SLAVE_DEV;
typedef XMEDIA_S32 SVP_NNIE_HANDLE;
typedef XMEDIA_S32 SVP_DSP_HANDLE;
typedef XMEDIA_S32 SVP_ALG_CHN;
typedef XMEDIA_S32 VPSS_GRP;
typedef XMEDIA_S32 VPSS_GRP_PIPE;
typedef XMEDIA_S32 VPSS_CHN;
typedef XMEDIA_S32 AVS_GRP;
typedef XMEDIA_S32 AVS_PIPE;
typedef XMEDIA_S32 AVS_CHN;
typedef XMEDIA_S32 MCF_GRP;
typedef XMEDIA_S32 MCF_PIPE;
typedef XMEDIA_S32 MCF_CHN;

#define XMEDIA_INVALID_CHN (-1)
#define XMEDIA_INVALID_WAY (-1)
#define XMEDIA_INVALID_LAYER (-1)
#define XMEDIA_INVALID_DEV (-1)
#define XMEDIA_INVALID_HANDLE (-1)
