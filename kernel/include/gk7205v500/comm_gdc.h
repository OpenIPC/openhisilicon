...
typedef struct FISHEYE_REGION_ATTR_S {
    ...
    XMEDIA_U32 u32InRadius;
    XMEDIA_U32 u32OutRadius;
    XMEDIA_U32 u32Pan;
    XMEDIA_U32 u32Tilt;
    XMEDIA_U32 u32HorZoom;
    XMEDIA_U32 u32VerZoom;
    RECT_S stOutRect;
...
typedef struct FISHEYE_ATTR_S {
    XMEDIA_BOOL bEnable;
    XMEDIA_BOOL bLMF;
    XMEDIA_BOOL bBgColor;
    XMEDIA_U32 u32BgColor;

    XMEDIA_S32 s32HorOffset;
    XMEDIA_S32 s32VerOffset;

    XMEDIA_U32 u32TrapezoidCoef;
    XMEDIA_S32 s32FanStrength;
...
typedef struct SPREAD_ATTR_S {
    XMEDIA_BOOL bEnable;
    XMEDIA_U32 u32SpreadCoef;
    SIZE_S stDestSize;
} SPREAD_ATTR_S;

typedef struct FISHEYE_JOB_CONFIG_S {
    XMEDIA_U64 u64LenMapPhyAddr;
} FISHEYE_JOB_CONFIG_S;

typedef struct FISHEYE_CONFIG_S {
    XMEDIA_U16 au16LMFCoef[FISHEYE_LMFCOEF_NUM];
} FISHEYE_CONFIG_S;

typedef struct GDC_PMF_ATTR_S {
    XMEDIA_S64 as64PMFCoef[GDC_PMFCOEF_NUM];
} GDC_PMF_ATTR_S;
