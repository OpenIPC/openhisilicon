...
typedef struct GPS_INFO_S {
    XMEDIA_CHAR chGPSLatitudeRef;
    XMEDIA_U32 au32GPSLatitude[3][2];
    XMEDIA_CHAR chGPSLongitudeRef;
    XMEDIA_U32 au32GPSLongitude[3][2];
    XMEDIA_U8 u8GPSAltitudeRef;
    XMEDIA_U32 au32GPSAltitude[2];
} GPS_INFO_S;
...
typedef struct RAW_FRAME_COMPRESS_PARAM_S {
    XMEDIA_U32 u32CompRatio_10Bit;
    XMEDIA_U32 u32CompRatio_12Bit;
    XMEDIA_U32 u32CompRatio_14Bit;
} RAW_FRAME_COMPRESS_PARAM_S;


typedef struct UNIQUE_ID_S {
    XMEDIA_U32 u32Id[UNIQUE_ID_NUM];
} UNIQUE_ID_S;
