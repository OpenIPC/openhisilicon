...
typedef struct AENC_ENCODER_S {
    ...
    XMEDIA_U32          u32MaxFrmLen;
    XMEDIA_CHAR         aszName[17];
    XMEDIA_S32          (*pfnOpenEncoder)(XMEDIA_VOID *pEncoderAttr, XMEDIA_VOID **ppEncoder);
    XMEDIA_S32          (*pfnEncodeFrm)(XMEDIA_VOID *pEncoder, const AUDIO_FRAME_S *pstData,
                        XMEDIA_U8 *pu8Outbuf, XMEDIA_U32 *pu32OutLen);
    XMEDIA_S32          (*pfnCloseEncoder)(XMEDIA_VOID *pEncoder);
} AENC_ENCODER_S;
