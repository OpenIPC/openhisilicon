...
typedef struct VI_CMP_PARAM_S {
    XMEDIA_U8 au8CmpParam[VI_CMP_PARAM_SIZE];
} VI_CMP_PARAM_S;
...
typedef struct VI_TIMING_BLANK_S {
    XMEDIA_U32 u32HsyncHfb ;
    XMEDIA_U32 u32HsyncAct ;
    XMEDIA_U32 u32HsyncHbb ;
    XMEDIA_U32 u32VsyncVfb ;
    XMEDIA_U32 u32VsyncVact ;
    XMEDIA_U32 u32VsyncVbb ;
    XMEDIA_U32 u32VsyncVbfb ;
    XMEDIA_U32 u32VsyncVbact ;
    XMEDIA_U32 u32VsyncVbbb ;
} VI_TIMING_BLANK_S;
...
typedef struct VI_DEV_ATTR_EX_S {
    ...
    XMEDIA_U32                  au32ComponentMask[VI_COMPMASK_NUM];

    VI_SCAN_MODE_E          enScanMode;
    XMEDIA_S32                  as32AdChnId[VI_MAX_ADCHN_NUM];
...
typedef struct VI_PIPE_ATTR_S {
    ...
    XMEDIA_BOOL               bYuvSkip;
    XMEDIA_BOOL               bIspBypass;
    XMEDIA_U32                u32MaxW;
    XMEDIA_U32                u32MaxH;
    PIXEL_FORMAT_E        enPixFmt;
    COMPRESS_MODE_E       enCompressMode;
...
typedef struct VI_STITCH_GRP_ATTR_S {
    ...
    XMEDIA_U32                      u32MaxPTSGap;
    XMEDIA_U32                      u32PipeNum;
...
typedef struct {
    ...
    XMEDIA_U16  HdgType : 1;
    XMEDIA_U16  BriType : 1;
    XMEDIA_U16  HdgMode : 2;
    XMEDIA_U16  kTab2   : 1;
    XMEDIA_U16  HdgWnd  : 1;
    XMEDIA_U16  kTab3   : 1;
    XMEDIA_U16  HdgSFR  : 4;
...
typedef struct {
    ...
    XMEDIA_U16 STH1 : 9, SFN1 : 3, NRyEn : 1, SFN0  : 3;
...
typedef struct VI_PIPE_STATUS_S {
    XMEDIA_BOOL bEnable;
    XMEDIA_U32  u32IntCnt;
    XMEDIA_U32  u32FrameRate;
    XMEDIA_U32  u32LostFrame;
    XMEDIA_U32  u32VbFail;
    SIZE_S  stSize;
} VI_PIPE_STATUS_S;
...
typedef struct VI_VS_SIGNAL_ATTR_S {
    ...
    XMEDIA_U32              u32StartTime;
    XMEDIA_U32              u32Duration;
    XMEDIA_U32              u32CapFrmIndex;
    XMEDIA_U32              u32Interval;
} VI_VS_SIGNAL_ATTR_S;
...
typedef struct VI_PMF_ATTR_S {
    XMEDIA_BOOL bEnable;
    SIZE_S  stDestSize;
    XMEDIA_S64  as64PMFCoef[VI_PMFCOEF_NUM];
} VI_PMF_ATTR_S;
...
typedef struct VI_MOD_PARAM_S {
    XMEDIA_S32      s32DetectErrFrame;
    XMEDIA_U32      u32DropErrFrame;
    VB_SOURCE_E enViVbSource;
} VI_MOD_PARAM_S;

typedef struct VI_DEV_TIMING_ATTR_S {
    XMEDIA_BOOL bEnable;
    XMEDIA_S32  s32FrmRate;
