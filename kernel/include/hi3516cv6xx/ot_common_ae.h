...
typedef struct {
    td_bool enable;
    td_u16  sns_delay_frame; /* RW; Range:[3, 4]; Format:4.0 */
} ot_isp_ae_fast_ae_attr;
...
typedef struct {
    ...
    td_void (*pfn_cmos_ae_fast_ae_attr_get)(ot_vi_pipe vi_pipe, ot_isp_ae_fast_ae_attr *fast_ae_attr);
    td_void (*pfn_cmos_ae_fast_ae_attr_set)(ot_vi_pipe vi_pipe, const ot_isp_ae_fast_ae_attr *fast_ae_attr);
