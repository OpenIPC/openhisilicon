...
#define OT_EXT_SYSTEM_ISP_LONG_EDGE_STITCHING_DEFAULT  0x2
/* args: data (u8-bit) */
/* addr range TOP: [0x266,0x268), index:2 */
static __inline td_void ot_ext_system_isp_is_long_edge_stitching_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct(vreg_top_base(vi_pipe) + 0x265, data);
}

static __inline td_u8 ot_ext_system_isp_is_long_edge_stitching_read(ot_vi_pipe vi_pipe)
{
    return iord_8direct(vreg_top_base(vi_pipe) + 0x265);
}

/* args: data (u8-bit) */
/* addr range TOP: [0x268,0x26a), index:2 */
static __inline td_void ot_ext_system_isp_is_rotating_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct(vreg_top_base(vi_pipe) + 0x266, data);
}

static __inline td_u8 ot_ext_system_isp_is_rotatings_read(ot_vi_pipe vi_pipe)
{
    return iord_8direct(vreg_top_base(vi_pipe) + 0x266);
}
...
static __inline td_u16 ot_ext_system_ae_crop_x_read(ot_vi_pipe vi_pipe)
{
...
static __inline td_u16 ot_ext_system_ae_fe_crop_x_read(ot_vi_pipe vi_pipe)
{
...
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x3CC + sizeof(td_u8) * index), data);
}
static __inline td_u8 ot_ext_system_bayernr_auto_noisesd_lut_read(ot_vi_pipe vi_pipe,  td_u16 index)
{
    return (iord_8direct((vreg_bnr_base(vi_pipe) + 0x3CC + sizeof(td_u8) * index)));
}

static __inline td_void ot_ext_system_bayernr_ref_mode_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x5CC), data);
}

static __inline td_u8 ot_ext_system_bayernr_ref_mode_read(ot_vi_pipe vi_pipe)
{
    return (iord_8direct(vreg_bnr_base(vi_pipe) + 0x5CC));
}

static __inline td_void ot_ext_system_bayernr_load_ref_enable_write(ot_vi_pipe vi_pipe, td_u8 data)
{
    iowr_8direct((vreg_bnr_base(vi_pipe) + 0x5CD), data);
}

static __inline td_u8 ot_ext_system_bayernr_load_ref_enable_read(ot_vi_pipe vi_pipe)
{
    return (iord_8direct(vreg_bnr_base(vi_pipe) + 0x5CD));
}
