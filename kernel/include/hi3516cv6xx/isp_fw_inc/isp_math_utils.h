...
td_s32 solving_nth_root_045(td_s32 x, const td_u8 fraction_size);
td_u32 transition(td_u32 *lut_in, td_u32 *lut_out, td_u32 lut_size, td_u32 value, td_u8 value_fraction_size);
