...
#define isp_check_sensor_register_notrace_goto(pipe, ret, failed)                                              \
    do {                                                                                   \
        isp_usr_ctx *isp_ctx_tmp = TD_NULL;                                                \
        isp_get_ctx(pipe, isp_ctx_tmp);                                                     \
        if ((isp_ctx_tmp->sns_reg != TD_TRUE) && (isp_ctx_tmp->isp_yuv_mode != TD_TRUE)) { \
...
td_s32 isp_set_correction_attr(ot_vi_pipe vi_pipe, const ot_isp_fpn_attr *correction, td_bool correct_enable,
    td_u8 fpn_work_mode);
...
td_s32 isp_set_motion_stats_config(ot_vi_pipe vi_pipe, const ot_isp_motion_stats_cfg *motion_cfg);
td_s32 isp_get_motion_stats_config(ot_vi_pipe vi_pipe, ot_isp_motion_stats_cfg *motion_cfg);
td_s32 isp_get_motion_stats(ot_vi_pipe vi_pipe, ot_isp_motion_stats *motion_stats);
