...
struct mmz_status {
    unsigned int mmz_total;
    unsigned int mmz_free;
};
...
#define MMZ_MMB_QUERY_STATUS_IOC_MAGIC  'q'
...
typedef enum {
    ...
    OT_MMZ_IOC_NR_MMB_QUERY_MMZ_STATUS = 60,
...
#define IOC_MMB_QUERY_MMZ_STATUS   _IOR(MMZ_MMB_QUERY_STATUS_IOC_MAGIC, OT_MMZ_IOC_NR_MMB_QUERY_MMZ_STATUS, \
                                        struct mmz_status)
