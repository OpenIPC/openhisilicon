...
typedef union {
    /* AUTO:ot_ive_lbp_compare_mode:OT_IVE_LBP_COMPARE_MODE_NORMAL;
     * ot_ive_threshold_s16_mode: OT_IVE_THRESHOLD_S16_MODE_S16_TO_S8_MIN_MID_MAX,
     * OT_IVE_THRESHOLD_S16_MODE_S16_TO_S8_MIN_ORIG_MAX;
     */
    td_s8 s8_val;
    /* AUTO:ot_ive_lbp_compare_mode:OT_IVE_LBP_COMPARE_MODE_ABS;
     * ot_ive_threshold_s16_mode: OT_IVE_THRESHOLD_S16_MODE_S16_TO_U8_MIN_MID_MAX,
     * OT_IVE_THRESHOLD_S16_MODE_S16_TO_U8_MIN_MID_MAX,OT_IVE_THRESHOLD_S16_MODE_BUTT;
     */
    td_u8 u8_val;
} ot_svp_8bit;
