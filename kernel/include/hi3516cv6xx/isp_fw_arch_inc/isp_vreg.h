...
#define vicap_slave_hstime(dev) (0x10c + (dev) * SLAVE_MODE_ALIGN)
#define vicap_slave_vscycle(dev) (0x11c + (dev) * SLAVE_MODE_ALIGN)
#define vicap_slave_hscycle(dev) (0x120 + (dev) * SLAVE_MODE_ALIGN)
#define vicap_slave_hsdlycle(dev) (0x12c + (dev) * SLAVE_MODE_ALIGN)
#define vicap_slave_sync    (0x1fc)
