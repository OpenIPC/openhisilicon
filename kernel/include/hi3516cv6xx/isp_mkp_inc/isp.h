...
/* INT_MODE */
typedef enum {
    ISP_INT_IDX_PORT = 0x0,
    ISP_INT_IDX_FE_DYNBLC_END,
    ISP_INT_IDX_FE_DELAY,
    ISP_INT_IDX_FE_END,
    ISP_INT_IDX_CHN_START,
    ISP_INT_IDX_CHN_LOWDELAY,
    ISP_INT_IDX_BUTT
} isp_int_idx;

typedef struct {
    ot_syskol_capture_mode mode;
    td_u8 kol_int_num[ISP_INT_IDX_BUTT];
    td_u32 kol_frame_num;
} isp_kol_int_info;
#endif
typedef struct {
    td_bool                  edge;
    ...
    osal_wait              isp_wait_vd_run_end;
    osal_wait              isp_wait_vd_standby_end;
    osal_wait              isp_exit_wait;
    osal_semaphore    isp_sem;
    osal_semaphore    isp_sem_vd;
    osal_semaphore    isp_sem_be_vd;
    osal_semaphore    isp_sem_run_end_vd;
    osal_semaphore    isp_sem_standby_vd;
    ...
    td_bool is_chg_fps_cfg;
    td_bool is_chg_fps_done;
    td_u16  chg_fps_cnt;
#endif
} isp_drv_ctx;
