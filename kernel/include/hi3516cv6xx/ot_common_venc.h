...
typedef enum {
    ...
    OT_VENC_GOP_MODE_SINGLE_SP   = 7,
    OT_VENC_GOP_MODE_I           = 8,
...
typedef struct {
    ...
    union {
        ...
        ot_venc_gop_single_sp   single_sp;   /* AUTO:ot_venc_gop_mode:OT_VENC_GOP_MODE_SINGLE_SP; */
    };
} ot_venc_gop_attr;
...
typedef enum {
    ...
    OT_VENC_SCENE_3 = 3,        /* RW; A scene such as continuous lens rotation and zooming
...
typedef struct {
    ...
    td_u32  bg_cost;
    td_u32  fg_cost;
    td_u8  bg_lambda_factor;
    td_u8  fg_lambda_factor;
} ot_venc_skip_bias;
...
typedef enum {
    OT_VENC_BITRATE_STRATEGY_AUTO = 0,
    OT_VENC_BITRATE_STRATEGY_HIGH_QUALITY,
    OT_VENC_BITRATE_STRATEGY_BIAS_QUALITY,
    OT_VENC_BITRATE_STRATEGY_BIAS_BITRATE,
    OT_VENC_BITRATE_STRATEGY_LOW_BITRATE,
    OT_VENC_BITRATE_STRATEGY_BUTT
} ot_venc_bitrate_strategy;

typedef enum {
    OT_VENC_PAYLOAD_SUPPORT_H264 = (1 << 0),
    OT_VENC_PAYLOAD_SUPPORT_H265 = (1 << 1),
    OT_VENC_PAYLOAD_SUPPORT_SVAC3 = (1 << 2),
    OT_VENC_PAYLOAD_SUPPORT_JPEG = (1 << 3),
    OT_VENC_PAYLOAD_SUPPORT_MJPEG = (1 << 4),
    OT_VENC_PAYLOAD_SUPPORT_BUTT = ~((1 << 5) - 1),
} ot_venc_payload_support;

typedef enum {
    OT_VENC_RC_SUPPORT_ABR = (1 << 0),
    OT_VENC_RC_SUPPORT_CBR = (1 << 1),
    OT_VENC_RC_SUPPORT_VBR = (1 << 2),
    OT_VENC_RC_SUPPORT_AVBR = (1 << 3),
    OT_VENC_RC_SUPPORT_QVBR = (1 << 4),
    OT_VENC_RC_SUPPORT_CVBR = (1 << 5),
    OT_VENC_RC_SUPPORT_FIXQP = (1 << 6),
    OT_VENC_RC_SUPPORT_QPMAP = (1 << 7),
    OT_VENC_RC_SUPPORT_RANGEQP = (1 << 8),
    OT_VENC_RC_SUPPORT_BUTT = ~((1 << 9) - 1),
} ot_venc_rc_mode_support;

typedef enum {
    OT_VENC_GOP_SUPPORT_NORMAL_P = (1 << OT_VENC_GOP_MODE_NORMAL_P),
    OT_VENC_GOP_SUPPORT_DUAL_P = (1 << OT_VENC_GOP_MODE_DUAL_P),
    OT_VENC_GOP_SUPPORT_SMART_P = (1 << OT_VENC_GOP_MODE_SMART_P),
    OT_VENC_GOP_SUPPORT_ADV_SMART_P = (1 << OT_VENC_GOP_MODE_ADV_SMART_P),
    OT_VENC_GOP_SUPPORT_BIPRED_B = (1 << OT_VENC_GOP_MODE_BIPRED_B),
    OT_VENC_GOP_SUPPORT_LOW_DELAY_B = (1 << OT_VENC_GOP_MODE_LOW_DELAY_B),
    OT_VENC_GOP_SUPPORT_SMART_CRR = (1 << OT_VENC_GOP_MODE_SMART_CRR),
    OT_VENC_GOP_SUPPORT_SINGLE_SP = (1 << OT_VENC_GOP_MODE_SINGLE_SP),
    OT_VENC_GOP_SUPPORT_I = (1 << OT_VENC_GOP_MODE_I),
    OT_VENC_GOP_SUPPORT_BUTT = ~((1 << OT_VENC_GOP_MODE_BUTT) - 1),
} ot_venc_gop_support;

typedef enum {
    OT_VENC_CRR_SUPPORT_RECODE_DISABLE = (1 << OT_VENC_CRR_RECODE_DISABLE),
    OT_VENC_CRR_SUPPORT_RECODE_NORMAL = (1 << OT_VENC_CRR_RECODE_NORMAL),
    OT_VENC_CRR_SUPPORT_RECODE_COPY = (1 << OT_VENC_CRR_RECODE_COPY),
    OT_VENC_CRR_SUPPORT_RECODE_WRITE_BACK = (1 << OT_VENC_CRR_RECODE_WRITE_BACK),
    OT_VENC_CRR_SUPPORT_RECODE_BUTT = ~((1 << OT_VENC_CRR_RECODE_BUTT) - 1),
} ot_venc_crr_recode_strategy_support;

typedef enum {
    OT_VENC_BITRATE_STRATEGY_SUPPORT_AUTO = (1 << OT_VENC_BITRATE_STRATEGY_AUTO),
    OT_VENC_BITRATE_STRATEGY_SUPPORT_HIGH_QUALITY = (1 << OT_VENC_BITRATE_STRATEGY_HIGH_QUALITY),
    OT_VENC_BITRATE_STRATEGY_SUPPORT_BIAS_QUALITY = (1 << OT_VENC_BITRATE_STRATEGY_BIAS_QUALITY),
    OT_VENC_BITRATE_STRATEGY_SUPPORT_BIAS_BITRATE = (1 << OT_VENC_BITRATE_STRATEGY_BIAS_BITRATE),
    OT_VENC_BITRATE_STRATEGY_SUPPORT_LOW_BITRATE = (1 << OT_VENC_BITRATE_STRATEGY_LOW_BITRATE),
    OT_VENC_BITRATE_STRATEGY_SUPPORT_BUTT = ~((1 << OT_VENC_BITRATE_STRATEGY_BUTT) - 1),
} ot_venc_bitrate_strategy_support;

typedef enum {
    OT_VENC_SVC_SUPPORT_NONE = 0,
    OT_VENC_SVC_SUPPORT_V1 = (1 << OT_VENC_SVC_V1),
    OT_VENC_SVC_SUPPORT_V2 = (1 << OT_VENC_SVC_V2),
    OT_VENC_SVC_SUPPORT_BUTT = ~((1 << OT_VENC_SVC_BUTT) - 1),
} ot_venc_svc_version_support;

typedef struct {
    td_u32 payload_support; /* RW; range:(0, ~OT_VENC_PAYLOAD_SUPPORT_BUTT]; */
    td_u32 max_pic_width;
    td_u32 max_pic_height;
    td_u32 buf_size;
    td_bool rcn_ref_share_buf_en;
    td_u32 frame_buf_ratio;
} ot_venc_attr_capability;

typedef struct {
    td_u32 rc_mode_support; /* RW; range:[0, ~OT_VENC_RC_SUPPORT_BUTT]; */
    td_u32 min_gop; /* RW; range:[1, 65536]; */
    td_u32 max_gop; /* RW; range:[1, 65536]; */
    td_u32 max_stats_time;  /* RW; range:[1, 60]; */
    td_u32 max_src_frame_rate;  /* RW; range:[1, 240]; */
    td_u32 max_short_term_stats_time; /* RW; range:[1, 120]; */
    td_u32 max_long_term_stats_time; /* RW; range:[1, 1440];  */
} ot_venc_rc_capability;

typedef struct {
    td_u32 gop_mode_support; /* RW; range:[0, ~OT_VENC_GOP_SUPPORT_BUTT]; */
    td_u32 crr_recode_strategy_support; /* RW; range:[0, ~OT_VENC_RC_SUPPORT_BUTT]; */
    td_u32 min_bg_interval; /* RW; range:[1, 65536]; */
    td_u32 max_bg_interval; /* RW; range:[1, 65536]; */
    td_bool skip_ref_support;
    td_u32 max_frame_num;
} ot_venc_gop_capability;

typedef struct {
    td_bool user_data_support;
    td_bool watermark_support;
    td_bool deblur_support;
    td_bool quality_balance_support;
    td_bool md_support;
    td_bool jpeg_roi_support;
    td_u32 bitrate_strategy_support;  /* RW; range:[1, ~OT_VENC_CRR_SUPPORT_RECODE_BUTT]; */
    td_u32 svc_support; /* RW; range:[0, ~OT_VENC_SVC_SUPPORT_BUTT]; */
    td_u32 svc_v2_max_ref_num;
} ot_venc_feature_capability;

typedef struct {
    td_bool enable;
    ot_venc_attr_capability attr_capability;
    ot_venc_rc_capability rc_capability;
    ot_venc_gop_capability gop_capability;
    ot_venc_feature_capability feature_capability;
} ot_venc_chn_capability;

typedef struct {
    td_bool enable;
} ot_venc_fast_enc_param;
