...
/**
 * @ingroup osal_device
 * @brief Invoke the suspend callback function of all devices.
 *
 * @par Description:
 * Invoke the suspend callback function of all devices.
 *
 * @par Support System:
 * linux.
 */
...
/**
 * @ingroup osal_device
 * @brief Invoke the resume callback function of all devices.
 *
 * @par Description:
 * Invoke the resume callback function of all devices,
 *
 * @par Support System:
 * linux.
 */
