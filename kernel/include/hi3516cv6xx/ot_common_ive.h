...
#define OT_IVE_WARP_PERSPECTIVE_POINT_NUM   4
typedef enum {
...
typedef struct {
    ot_svp_point_float src_point; /* Source point */
    ot_svp_point_float dst_point; /* Destination point */
} ot_ive_warp_perspective_point_pair;
 
typedef struct {
    ot_ive_warp_perspective_point_pair  point[OT_IVE_WARP_PERSPECTIVE_POINT_NUM];
} ot_ive_warp_perspective_points;
 
typedef struct {
    td_u32 roi_num; /* Max 16 ROI */
    td_u32 norm;
} ot_ive_warp_perspective_transform_ctrl;
 
typedef struct {
    td_u32 roi_num;   /* Max 16 ROI */
    ot_ive_padding_mode padding_mode;   /* Border mode */
    td_s32 padding_val[OT_IVE_PADDING_ARR_NUM];
} ot_ive_warp_perspective_ctrl;
...
typedef enum {
    OT_IVE_ACC_MODE_INCREASE = 0x0,
    OT_IVE_ACC_MODE_DECREASE = 0x1,
    OT_IVE_ACC_MODE_INCREASE_MAP_255TO1 = 0x2,
 
    OT_IVE_ACC_MODE_BUTT
} ot_ive_acc_mode;
 
typedef struct {
    ot_ive_acc_mode mode;
} ot_ive_acc_ctrl;
 
typedef enum {
    OT_IVE_IMAGE_DOT_MODE_ROUND_INT = 0x0,
 
    OT_IVE_IMAGE_DOT_MODE_BUTT
} ot_ive_image_dot_mode;
 
typedef struct {
    ot_ive_image_dot_mode mode;
} ot_ive_image_dot_ctrl;
