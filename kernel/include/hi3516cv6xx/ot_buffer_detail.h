...
__inline static td_u32 ot_aidrc_get_coef_buf_size(td_u32 width, td_u32 height)
{
    ...
    align_width = OT_ALIGN_UP(width, 2); /* align up to 2 */
    align_height = OT_ALIGN_UP(height, 2); /* align up to 2 */
    coef_size = OT_DIV_UP(align_width, down_sample_factor) * OT_DIV_UP(align_height, down_sample_factor) * channels;
