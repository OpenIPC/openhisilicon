...
td_s32 ss_mpi_venc_set_chn_capability(ot_venc_chn chn, const ot_venc_chn_capability *chn_capability);
td_s32 ss_mpi_venc_get_chn_capability(ot_venc_chn chn, ot_venc_chn_capability *chn_capability);
...
td_s32 ss_mpi_venc_set_bitrate_strategy(ot_venc_chn chn, const ot_venc_bitrate_strategy *bitrate_strategy);
td_s32 ss_mpi_venc_get_bitrate_strategy(ot_venc_chn chn, ot_venc_bitrate_strategy *bitrate_strategy);
td_s32 ss_mpi_venc_set_fast_enc_param(ot_venc_chn chn, const ot_venc_fast_enc_param *fast_enc_param);
td_s32 ss_mpi_venc_get_fast_enc_param(ot_venc_chn chn, ot_venc_fast_enc_param *fast_enc_param);
#ifdef __cplusplus
}
#endif
