...
typedef struct {
    ...
    td_u32  max_i_qp; /* RW; range:[i_qp, 51]; for svac3: [i_qp, 63]; */
    td_u32  min_i_qp; /* RW; range:[0, i_qp]; */
    td_u32  max_p_qp; /* RW; range:[p_qp, 51]; for svac3: [p_qp, 63]; */
    td_u32  min_p_qp; /* RW; range:[0, p_qp]; */
    td_u32  max_vi_qp; /* RW; range:[p_qp, 51]; for svac3: [p_qp, 63]; */
    td_u32  min_vi_qp; /* RW; range:[0, p_qp]; */
    td_u32  max_b_qp; /* RW; range:[b_qp, 51]; for svac3: [b_qp, 63]; */
    td_u32  min_b_qp; /* RW; range:[0, b_qp]; */
} ot_venc_h264_rangeqp;

typedef struct {
    td_u32 gop; /* RW; range:[1, 65536]; */
    td_u32 stats_time; /* RW; range:[1, 60]; */
    td_u32 src_frame_rate; /* RW; range:[1/64, 240]; */
    td_u32 dst_frame_rate; /* RW; range:[1/64, src_frame_rate]; */
...
typedef ot_venc_h264_rangeqp ot_venc_h265_rangeqp;
...
typedef ot_venc_h265_rangeqp ot_venc_svac3_rangeqp;
...
typedef struct {
    ...
    union {
        ...
        ot_venc_h264_rangeqp h264_rangeqp; /* AUTO:ot_venc_rc_mode:OT_VENC_RC_MODE_H264_RANGEQP; */
        ...
        ot_venc_h265_rangeqp h265_rangeqp; /* AUTO:ot_venc_rc_mode:OT_VENC_RC_MODE_H265_RANGEQP; */
        ...
        ot_venc_svac3_rangeqp svac3_rangeqp; /* AUTO:ot_venc_rc_mode:OT_VENC_RC_MODE_SVAC3_RANGEQP; */
    };
} ot_venc_rc_attr;
...
typedef struct {
    td_u32 qp_delta; /* RW; range:[1, 51], for svac3: [1, 63]; for mjpeg : [1, 99]; */
    td_s32 max_lost_times; /* RW; range:[0, 1000]; */
} ot_venc_discard_param;
...
typedef struct {
    ...
    ot_venc_discard_param discard_param;
