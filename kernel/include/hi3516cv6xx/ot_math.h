...
__inline static td_void yc_full_to_rgb(td_u16 y, td_u16 cb, td_u16 cr, td_u16 *r, td_u16 *g, td_u16 *b)
{
    td_s16 r_tmp, g_tmp, b_tmp;
...
__inline static td_u32 yuv_full_to_rgb(td_u32 yuv)
{
    td_u16 r, g, b;
