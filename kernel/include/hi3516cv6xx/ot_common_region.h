...
#ifndef OT_COMMON_REGION_H
#define OT_COMMON_REGION_H
...
typedef union {
    ...
    ot_rgn_lineex_chn_attr      lineex_chn; /* attribute of lineex region. AUTO:ot_rgn_type:OT_RGN_LINEEX; */
    ...
    /*
     * attribute of corner rect region.
     * AUTO:ot_rgn_type:OT_RGN_CORNER_RECT;
     */
