...
#define ISP_MIX_EN_3DNR 1
#define ISP_MIX_EN_PURE 2
...
typedef struct {
    ...
    td_s32 (*pfn_isp_close_drc_bypass)(ot_vi_pipe vi_pipe);
    td_s32 (*pfn_isp_close_drc_var)(ot_vi_pipe vi_pipe);
    ...
    td_void (*pfn_isp_clear_kol_int_num)(ot_vi_pipe vi_pipe);
#endif
} isp_export_func;
...
#ifdef CONFIG_OT_ISP_DRC_SWITCH_SUPPORT
#define ckfn_isp_close_drc_bypass() \
        (func_entry(isp_export_func, OT_ID_ISP)->pfn_isp_close_drc_bypass != TD_NULL)
#define call_isp_close_drc_bypass(vi_pipe) \
        func_entry(isp_export_func, OT_ID_ISP)->pfn_isp_close_drc_bypass(vi_pipe)

#define ckfn_isp_close_drc_var() \
                        (func_entry(isp_export_func, OT_ID_ISP)->pfn_isp_close_drc_var != TD_NULL)
#define call_isp_close_drc_var(vi_pipe) \
                        func_entry(isp_export_func, OT_ID_ISP)->pfn_isp_close_drc_var(vi_pipe)

#define ckfn_isp_restore_drc() \
            (func_entry(isp_export_func, OT_ID_ISP)->pfn_isp_restore_drc != TD_NULL)
#define call_isp_restore_drc(vi_pipe) \
...
#define call_isp_cfg_bnr_online(vi_pipe, tnr_en, initial_en, ref_mdoe) \
    func_entry(isp_export_func, OT_ID_ISP)->pfn_isp_cfg_bnr_online(vi_pipe, tnr_en, initial_en, ref_mdoe)

#ifdef CONFIG_OT_SYS_KOL_SUPPORT
#define ckfn_isp_clear_kol_int_num() \
        (func_entry(isp_export_func, OT_ID_ISP)->pfn_isp_clear_kol_int_num != TD_NULL)
#define call_isp_clear_kol_int_num(vi_pipe) \
        func_entry(isp_export_func, OT_ID_ISP)->pfn_isp_clear_kol_int_num(vi_pipe)
#endif
