...
typedef td_s32  fn_vi_set_pipe_distribute_stop(ot_vi_pipe vi_pipe);
...
typedef td_s32  fn_vi_get_vi_pipe_wrap_en(ot_vi_pipe vi_pipe, td_bool *wrap_en);
#endif
#ifdef IQ_DEBUG
...
typedef struct {
    ...
    fn_vi_set_pipe_distribute_stop    *pfn_vi_set_pipe_distribute_stop;
...
#ifdef CONFIG_OT_SYS_VI_WRAP_SUPPORT
    fn_vi_get_vi_pipe_wrap_en         *pfn_vi_get_vi_pipe_wrap_en;
#endif
#ifdef IQ_DEBUG
...
#define ckfn_vi_set_distribute_stop() \
    (func_entry(vi_export_func, OT_ID_VI)->pfn_vi_set_pipe_distribute_stop != TD_NULL)
#define call_vi_set_distribute_stop(vi_pipe) \
    func_entry(vi_export_func, OT_ID_VI)->pfn_vi_set_pipe_distribute_stop(vi_pipe)
#endif
...
#ifdef CONFIG_OT_SYS_VI_WRAP_SUPPORT
#define ckfn_vi_get_vi_pipe_wrap_en() \
    (func_entry(vi_export_func, OT_ID_VI)->pfn_vi_get_vi_pipe_wrap_en != TD_NULL)
#define call_vi_get_vi_pipe_wrap_en(vi_pipe, wrap_en) \
    func_entry(vi_export_func, OT_ID_VI)->pfn_vi_get_vi_pipe_wrap_en(vi_pipe, wrap_en)
#endif
