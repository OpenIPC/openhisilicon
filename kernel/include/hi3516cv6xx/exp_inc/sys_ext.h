...
typedef enum {
    ...
    SYS_GET_PROFILE,
    SYS_SET_ISP_NPU_MEM_SEL,
    SYS_GET_ISP_NPU_MEM_SEL,
...
#ifdef CONFIG_OT_SYS_KOL_SUPPORT
    td_s32 (*pfn_sys_query_kol_param)(ot_syskol_param *param);
#endif
} sys_export_func;
...
#ifdef CONFIG_OT_SYS_KOL_SUPPORT
#define ckfn_sys_query_kol_param() \
    (func_entry(sys_export_func, OT_ID_SYS)->pfn_sys_query_kol_param != TD_NULL)
#define call_sys_query_kol_param(param) \
    func_entry(sys_export_func, OT_ID_SYS)->pfn_sys_query_kol_param(param)
#endif
