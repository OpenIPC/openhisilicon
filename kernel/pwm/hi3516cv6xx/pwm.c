...
#else   /* linux */
/*
 * asm/io.h defines IOMEM(x) as a function-like macro; vendor pwm uses
 * IOMEM as an object-like qualifier alias for __iomem. Force-undef
 * before redefining so our object-like form wins.
 */
#undef IOMEM
