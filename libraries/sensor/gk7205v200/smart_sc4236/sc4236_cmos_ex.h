...
static const ISP_CMOS_DPC_S g_stCmosDpc = {
	...
	{ 130, 150, 150, 200, 220, 230, 240, 240, 240, 240, 152, 152, 152, 152,
	  152, 152 }, /* au16Strength[16] */
	{ 24, 28, 32, 32, 32, 32, 36, 36, 36, 40, 50, 50, 50, 50, 50,
...
static AWB_CCM_S g_stAwbCcm = {
	4,
	{
		{
			6150,
			{ 0x02A3, 0x81C8, 0x0025, 0x8058, 0x01DD, 0x8085,
			  0x8020, 0x816A, 0x028A },
		},

		{
			4850,
			{ 0x0297, 0x81AC, 0x0015, 0x806C, 0x01D3, 0x8067,
			  0x8032, 0x81A8, 0x02DA },
		},

		{
			3650,
			{ 0x028E, 0x8196, 0x0008, 0x809B, 0x01E8, 0x804D,
			  0x8057, 0x81DB, 0x0332 },
		},

		{
			2650,
			{ 0x01CF, 0x80C1, 0x800E, 0x8084, 0x0185, 0x8001,
...
static AWB_AGC_TABLE_S g_stAwbAgcTable = {
	...
	/* saturation */
	/*  1,    2,    4,    8,   16,   32,   64,  128,  256,  512, 1024, 2048, 4096, 8192, 16384, 32768 */
	{ 110, 110, 110, 110, 110, 105, 100, 90, 80, 72, 64, 56, 56, 56, 56,
	  56 }
};
