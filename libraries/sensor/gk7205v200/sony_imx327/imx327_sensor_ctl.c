...
void imx327_wdr_1080p30_2to1_init(VI_PIPE ViPipe)
{
	...
	imx327_write_register(ViPipe, 0x3129,
			      0x00); /* ADBIT1,12Bit;0x1D->10Bit */
	...
	imx327_write_register(ViPipe, 0x317c,
			      0x00); /* ADBIT2,12Bit;0x12->10Bit */
	imx327_write_register(ViPipe, 0x31ec,
			      0x0e); /* ADBIT3,12Bit;0x12->10Bit */
	imx327_write_register(
		ViPipe, 0x3480,
