/*
 * SC2235 sensor I2C / control — single source for hi3516cv200 (V2) and
 * hi3516cv300 (V3). See sc2235_cmos.c and docs/sensor-driver-api.md §3.2
 * for the V2/V3 ABI drift this gating addresses (different I2C ioctl
 * patterns and slightly different sensor register-init sequences).
 */
