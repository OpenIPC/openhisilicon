...
void IMX335_linear_5M30_12bit_init(VI_PIPE ViPipe)
{
	...
	IMX335_write_register(ViPipe, 0x3A01, 0x01);
	...
	printf("-------Sony IMX335_2l_init_5M_2592x1944_10bit_linear Initial OK!-------\n");
}
