...
static GK_S32 cmos_get_sns_regs_info(VI_PIPE ViPipe, ISP_SNS_REGS_INFO_S *pstSnsRegsInfo)
{
    ...
    if ((pstSnsState->bSyncInit == GK_FALSE) || (pstSnsRegsInfo->bConfig == GK_FALSE)) {
        ...
        if (GK_TRUE == (pstSnsState->astRegsInfo[0].astI2cData[10].bUpdate\
        ...
        if (GK_TRUE == (pstSnsState->astRegsInfo[0].astI2cData[12].bUpdate\
...
static GK_S32 sc4236_set_bus_info(VI_PIPE ViPipe, ISP_SNS_COMMBUS_U unSNSBusInfo)
{
