...
void Sofia_sensor_linear_1080p30_init();
...
void sensor_init()
{
    ...
    switch (cmp_value)
    {
        case 0x10:
        {
            Sofia_sensor_linear_1080p30_init();
            break;
        }
        case 0x20:
        {
...
void Sofia_sensor_linear_1080p30_init()
{
  ...
  sensor_write_register(0x3086, 0x43D);
  sensor_write_register(0x3086, 0x102A);
  sensor_write_register(0x3086, 0x52A);
  ...
  sensor_write_register(0x3086, 0x955);
  ...
  sensor_write_register(0x3086, 0x72A);
  ...
  sensor_write_register(0x3086, 0x48B);
  ...
  sensor_write_register(0x3086, 0x4316);
  sensor_write_register(0x3086, 0xB43);
  sensor_write_register(0x3086, 0x168E);
  sensor_write_register(0x3086, 0x32A);
  ...
  sensor_write_register(0x3086, 0x4316);
  sensor_write_register(0x3086, 0x643);
  sensor_write_register(0x3086, 0x1605);
  sensor_write_register(0x3086, 0x4316);
  sensor_write_register(0x3086, 0x743);
  ...
  sensor_write_register(0x3086, 16135);
  sensor_write_register(0x3086, 10909);
  sensor_write_register(0x3086, 21261);
  sensor_write_register(0x3086, 35606);
  sensor_write_register(0x3086, 34366);
  sensor_write_register(0x3086, 9029);
  sensor_write_register(0x3086, 22565);
  sensor_write_register(0x3086, 15888);
  sensor_write_register(0x3086, 36353);
  sensor_write_register(0x3086, 10904);
  sensor_write_register(0x3086, 36352);
  sensor_write_register(0x3086, 15888);
  sensor_write_register(0x3086, 36192);
  sensor_write_register(0x3086, 4676);
  sensor_write_register(0x3086, 19385);
  sensor_write_register(0x3086, 11308);
  sensor_write_register(0x3086, 11308);
  sensor_write_register(0x3086, 11308);
  sensor_write_register(0x3064, 6146);
  sensor_write_register(0x3EEE, 41130);
  sensor_write_register(0x30BA, 30252);
  sensor_write_register(0x3F4A, 3952);
  sensor_write_register(0x309E, 364);
  sensor_write_register(0x3092, 111);
  sensor_write_register(0x3EE4, 39223);
  sensor_write_register(0x3EE6, 14435);
  sensor_write_register(0x3EEC, 15116);
  sensor_write_register(0x3EEA, 10296);
  sensor_write_register(0x3ECC, 20013);
  sensor_write_register(0x3ED2, 65190);
  sensor_write_register(0x3ED6, 11443);
  sensor_write_register(0x3EEA, 10265);
  sensor_write_register(0x301A, 4312);
  sensor_write_register(0x30B0, 6712);
  sensor_write_register(0x31AC, 3084);
  sensor_write_register(0x302A, 8);
  sensor_write_register(0x302C, 1);
  sensor_write_register(0x302E, 2);
  sensor_write_register(0x3030, 0x2C);
  sensor_write_register(0x3036, 0xC);
  sensor_write_register(0x3038, 1);
  sensor_write_register(0x3002, 0);
  sensor_write_register(0x3004, 0);
  sensor_write_register(0x3006, 0x43E);
  sensor_write_register(0x3008, 0x786);
  sensor_write_register(0x300A, 0x465);
  sensor_write_register(0x300C, 0x44C);
  sensor_write_register(0x3012, 0x416);
  sensor_write_register(0x30A2, 1);
  sensor_write_register(0x30A6, 1);
  sensor_write_register(0x30AE, 1);
  sensor_write_register(0x30A8, 1);
  sensor_write_register(0x3040, 0);
  sensor_write_register(0x31AE, 0x301);
  sensor_write_register(0x3082, 9);
  sensor_write_register(0x30BA, 0x762C);
  sensor_write_register(0x3060, 0xB);
  sensor_write_register(0x3100, 0);
  sensor_write_register(0x31D0, 0);
  sensor_write_register(0x3064, 0x1802);
  sensor_write_register(0x301A, 0x10DC);
  sensor_write_register(0x3028, 0x20);
  sensor_write_register(0x3100, 4);
  sensor_write_register(0x3060, 0);
  sensor_write_register(0x3012, 0x232);
  puts("------------- AR0237 1080p 25fps  init ok! Lycai ----------------");
    bSensorInit = HI_TRUE;
}
