 ...
 * Description: Function of imx327_cmos.h
 * Author: ISP SW
 * Create: 2012/06/28
 */

#ifndef __IMX327_CMOS_H_
...
#define IMX327_I2C_ADDR    0x34
#define IMX327_ADDR_BYTE   2
#define IMX327_DATA_BYTE   1
#define IMX327_SENSOR_GET_CTX(dev, pstCtx)   ((pstCtx) = imx327_get_ctx(dev))
...
typedef struct hiIMX327_VIDEO_MODE_TBL_S {
