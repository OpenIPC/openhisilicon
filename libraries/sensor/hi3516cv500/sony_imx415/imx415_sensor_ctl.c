...
static const HI_U16 g_au16SensorCfgSeq[][IMX415_MODE_BUTT + 1] = {
    {0x7F, 0x7F, 0x7F, 0x3008},
    {0x5B, 0x5B, 0x5B, 0x300A},
    {  NA,   NA, 0x01, 0X3020},
    {  NA,   NA, 0x01, 0X3021},
    {  NA,   NA, 0x01, 0X3022},
    {  NA,   NA, 0xF8, 0X3024},
    {0x4C, 0x72, 0x1B, 0x3028},
    {0x04, 0x06,   NA, 0x3029},
    {  NA,   NA, 0x00, 0X3031},
    {0x05, 0x07, 0x05, 0x3033},
    {0x08, 0x08, 0x08, 0x3050},  /* SHR0 */
    {0x00, 0x00, 0x00, 0x30C1},
    {  NA,   NA, 0x02, 0X30D9},
    {  NA,   NA, 0x01, 0X30DA},
    {0x24, 0x24, 0x24, 0x3116},
    {0xC0, 0x80,   NA, 0x3118},
    {0x24, 0x24, 0x24, 0x311E},
    ...
    {0x48, 0x48, 0x48, 0x4004},
    {0x09, 0x09, 0x09, 0x4005},
    {0x00, 0x00, 0x00, 0x400C},
    {0x7F, 0x67, 0x7F, 0x4018},
    {0x37, 0x27, 0x37, 0x401A},
    {0x37, 0x27, 0x37, 0x401C},
    {0xF7, 0xB7, 0xF7, 0x401E},
    {0x00, 0x00, 0x00, 0x401F},
    {0x3F, 0x2F, 0x3F, 0x4020},
    {0x6F, 0x4F, 0x6F, 0x4022},
    {0x3F, 0x2F, 0x3F, 0x4024},
    {0x5F, 0x47, 0x5F, 0x4026},
    {0x2F, 0x27, 0x2F, 0x4028},
    {0x01, 0x01, 0x01, 0x4074},
};
