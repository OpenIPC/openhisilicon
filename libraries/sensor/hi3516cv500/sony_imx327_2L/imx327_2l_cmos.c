 ...
 * Description: Function of imx327_2l_cmos.c
 * Author: ISP SW
 * Create: 2012/06/28
 */
...
{
    return &g_aunImx327_2l_BusInfo[vi_pipe];
}

ISP_SNS_STATE_S *imx327_2l_get_ctx(VI_PIPE vi_pipe)
{
    return g_pastImx327_2l[vi_pipe];
}
...
const IMX327_2L_VIDEO_MODE_TBL_S g_astImx327_2l_ModeTbl[IMX327_MODE_BUTT] = {
...
static HI_S32 cmos_get_ae_default(VI_PIPE vi_pipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    IMX327_2L_SENSOR_GET_CTX(vi_pipe, pstSnsState);
...
static HI_VOID cmos_fps_set(VI_PIPE vi_pipe, HI_FLOAT f32Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    u32Lines = g_astImx327_2l_ModeTbl[pstSnsState->u8ImgMode].u32VertiLines;
    u32LinesMax = g_astImx327_2l_ModeTbl[pstSnsState->u8ImgMode].u32MaxVertiLines;
    f32MaxFps = g_astImx327_2l_ModeTbl[pstSnsState->u8ImgMode].f32MaxFps;
    f32MinFps = g_astImx327_2l_ModeTbl[pstSnsState->u8ImgMode].f32MinFps;
    ...
    if (pstSnsState->enWDRMode == WDR_MODE_2To1_LINE) {
        ...
        g_astimx327_2l_State[vi_pipe].u32RHS1_MAX =
            (u32VMAX - g_astimx327_2l_State[vi_pipe].u32BRL) * 2 - 21; /* (VMAX - BRL) * 2 - 21 */
    } else {
...
static HI_VOID cmos_slow_framerate_set(VI_PIPE vi_pipe, HI_U32 u32FullLines, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    if (pstSnsState->enWDRMode == WDR_MODE_2To1_LINE) {
        ...
        g_astimx327_2l_State[vi_pipe].u32RHS1_MAX =
            pstSnsState->au32FL[0] - g_astimx327_2l_State[vi_pipe].u32BRL * 2 - 21; /* FL - BRL * 2 - 21 */
    } else {
...
{
    ISP_SNS_STATE_S *pstSnsState = HI_NULL;
    HI_U32 u32HCG = g_astimx327_2l_State[vi_pipe].u8Hcg;
    HI_U32 u32Tmp;
    ...
    HI_U32 *au32IntTimeMin, HI_U32 *pu32LFMaxIntTime)
{
    ...
    if (g_genFSWDRMode[vi_pipe] == ISP_FSWDR_LONG_FRAME_MODE) {
        ...
        u32ShortMax = (u32ShortMax0 < u32ShortMax) ? u32ShortMax0 : u32ShortMax;
        u32ShortMax = (u32ShortMax > (g_astimx327_2l_State[vi_pipe].u32RHS1_MAX - 3)) ? /* sub 3 */
            (g_astimx327_2l_State[vi_pipe].u32RHS1_MAX - 3) : u32ShortMax; /* sub 3 */
...
static HI_VOID cmos_set_pixel_detect(VI_PIPE vi_pipe, HI_BOOL bEnable)
{
    ...
    if (bEnable) { /* setup for ISP pixel calibration mode */
        imx327_2l_write_register(vi_pipe, IMX327_GAIN_ADDR, 0x00);

        imx327_2l_write_register(vi_pipe, IMX327_VMAX_ADDR, LOW_8BITS(u32FullLines_5Fps));
        imx327_2l_write_register(vi_pipe, IMX327_VMAX_ADDR + 1, HIGH_8BITS(u32FullLines_5Fps));
        imx327_2l_write_register(vi_pipe, IMX327_VMAX_ADDR + 2, HIGHER_4BITS(u32FullLines_5Fps)); /* index 2 */

        imx327_2l_write_register(vi_pipe, IMX327_SHS1_ADDR, LOW_8BITS(u32MaxIntTime_5Fps));
        imx327_2l_write_register(vi_pipe, IMX327_SHS1_ADDR + 1, HIGH_8BITS(u32MaxIntTime_5Fps));
        imx327_2l_write_register(vi_pipe, IMX327_SHS1_ADDR + 2, HIGHER_4BITS(u32MaxIntTime_5Fps)); /* index 2 */
    } else { /* setup for ISP 'normal mode' */
        pstSnsState->u32FLStd = (pstSnsState->u32FLStd > 0x1FFFF) ? 0x1FFFF : pstSnsState->u32FLStd;
        imx327_2l_write_register(vi_pipe, IMX327_VMAX_ADDR, LOW_8BITS(pstSnsState->u32FLStd));
        imx327_2l_write_register(vi_pipe, IMX327_VMAX_ADDR + 1, HIGH_8BITS(pstSnsState->u32FLStd));
        imx327_2l_write_register(vi_pipe, IMX327_VMAX_ADDR + 2, HIGHER_4BITS(pstSnsState->u32FLStd)); /* index 2 */
...
static HI_VOID cmos_comm_sns_reg_info_init(VI_PIPE vi_pipe, ISP_SNS_STATE_S *pstSnsState)
{
    ...
    pstSnsState->astRegsInfo[0].unComBus.s8I2cDev = g_aunImx327_2l_BusInfo[vi_pipe].s8I2cDev;
    ...
    ISP_SNS_STATE_S *pstSnsState)
{
    switch (u8SensorImageMode) {
        ...
        case IMX327_SENSOR_1080P_30FPS_FRAME_WDR_2to1_MODE:
            ...
            g_astimx327_2l_State[vi_pipe].u8Hcg = 0x2;
            break;
        case IMX327_SENSOR_1080P_30FPS_WDR_2to1_MODE:
            pstSnsState->u32FLStd           = IMX327_VMAX_1080P60TO30_WDR * 2; /* *2 */
            g_astimx327_2l_State[vi_pipe].u32BRL = 1109; /* u32BRL 1109 */
            g_astimx327_2l_State[vi_pipe].u8Hcg    = 0x1;
            break;
    }
    return;
}
...
static HI_S32 cmos_set_image_mode(VI_PIPE vi_pipe, ISP_CMOS_SENSOR_IMAGE_MODE_S *pstSensorImageMode)
{
    ...
    for (i = 0; i < IMX327_MODE_BUTT; i++) {
        if (pstSensorImageMode->f32Fps <= g_astImx327_2l_ModeTbl[i].f32MaxFps &&
            pstSensorImageMode->u16Width <= g_astImx327_2l_ModeTbl[i].u32Width &&
            pstSensorImageMode->u16Height <= g_astImx327_2l_ModeTbl[i].u32Height &&
            pstSnsState->enWDRMode == g_astImx327_2l_ModeTbl[i].enWDRMode) {
            u8SensorImageMode = (IMX327_2L_RES_MODE_E)i;
            break;
        }
    }
...
{
    g_aunImx327_2l_BusInfo[vi_pipe].s8I2cDev = unSNSBusInfo.s8I2cDev;
...
static HI_S32 sensor_ctx_init(VI_PIPE vi_pipe)
{
    ...
    IMX327_2L_SENSOR_GET_CTX(vi_pipe, pastSnsStateCtx);
...
static HI_S32 sensor_set_init(VI_PIPE vi_pipe, ISP_INIT_ATTR_S *pstInitAttr)
{
    ...
    memcpy_s(&g_astInitAERouteSF[vi_pipe], sizeof(ISP_AE_ROUTE_S),
