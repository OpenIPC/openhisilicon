...
typedef enum {
    ...
    OT_ISP_ALG_AGAMMA,         /* 6 */
    OT_ISP_ALG_DRC,            /* 7 */
    OT_ISP_ALG_DEMOSAIC,       /* 8 */
    OT_ISP_ALG_ANTIFALSECOLOR, /* 9 */
    OT_ISP_ALG_GAMMA,          /* 10 */
    OT_ISP_ALG_GE,             /* 11 */
    OT_ISP_ALG_SHARPEN,        /* 12 */
    OT_ISP_ALG_FRAMEWDR,       /* 13 */
    OT_ISP_ALG_FPN,            /* 14 */
    OT_ISP_ALG_DEHAZE,         /* 15 */
    OT_ISP_ALG_LCAC,           /* 16 */
    OT_ISP_ALG_CAC,            /* 17 */
    OT_ISP_ALG_BSHP,           /* 18 */
    OT_ISP_ALG_CSC,            /* 19 */
    OT_ISP_ALG_EXPANDER,       /* 20 */
    OT_ISP_ALG_MCDS,           /* 21 */
    OT_ISP_ALG_ACS,            /* 22 */
    OT_ISP_ALG_LSC,            /* 23 */
    OT_ISP_ALG_RC,             /* 24 */
    ...
    OT_ISP_ALG_HRS,            /* 26 */
    OT_ISP_ALG_DG,             /* 27 */
    OT_ISP_ALG_BAYERNR,        /* 28 */
    OT_ISP_ALG_FLICKER,        /* 29 */
    OT_ISP_ALG_LDCI,           /* 30 */
    OT_ISP_ALG_CA,             /* 31 */
    OT_ISP_ALG_CLUT,           /* 32 */
    OT_ISP_ALG_CCM,            /* 33 */
