...
td_s32 ot_mpi_vi_set_chn_dis_wdr_attr(ot_vi_pipe vi_pipe, ot_vi_chn vi_chn, const ot_dis_wdr_attr *dis_wdr_attr);
td_s32 ot_mpi_vi_get_chn_dis_wdr_attr(ot_vi_pipe vi_pipe, ot_vi_chn vi_chn, ot_dis_wdr_attr *dis_wdr_attr);
...
td_s32 ot_mpi_vi_distribute_one_frame(ot_vi_grp distribute_grp, ot_vi_pipe vi_pipe);
