 ...
 * Description: Function of isp_stt_define.h
 * Author: ISP SW
 * Create: 2012/06/28
 */
...
typedef struct {
    ...
    volatile U_ISP_AE_HIST          ISP_AE_HIST[1024]                 ; /* 0x1c~0x1018, ae hist size: 1024 */
    volatile U_ISP_AE_AVER_R_GR     ISP_AE_AVER_R_GR[256]             ; /* 0x101c~0x1418, ae aver size: 256 */
    volatile U_ISP_AE_AVER_GB_B     ISP_AE_AVER_GB_B[256]             ; /* 0x141c~0x1818, ae aver size: 256 */
    ...
    volatile U_ISP_AF_STAT          ISP_AF_STAT[1020]                 ; /* 0x382c~0x4818, awb stat lut size: 1020 */
    volatile U_ISP_LA_AVER          ISP_LA_AVER[256]                  ; /* 0x481c~0x4c18, la aver size: 256 */
    ...
    volatile U_ISP_FLICK_GMEAN      ISP_FLICK_GMEAN[512]           ; /* 0x4c2c~0x5428, flicker gmean lut size: 512 */
    volatile U_ISP_GE_MEM_AVER0_RSTT   ISP_GE_MEM_AVER0_RSTT[256]     ; /* 0x542c~0x5828, ge aver stat size: 256 */
    volatile U_ISP_GE_MEM_AVER1_RSTT   ISP_GE_MEM_AVER1_RSTT[256]     ; /* 0x582c~0x5c28, ge aver stat size: 256 */
    ...
    volatile U_ISP_DPC_BPT_RSTT     ISP_DPC_BPT_RSTT[2048]            ; /* 0x5c3c~0x7c38, dpfect pixel number: 2048 */
    volatile U_ISP_LDCI_GROBAL_MAP_RSTT   ISP_LDCI_GROBAL_MAP_RSTT    ; /* 0x7c3c */
    volatile U_ISP_LDCI_LPF_MAP_RSTT   ISP_LDCI_LPF_MAP_RSTT[1024]    ; /* 0x7c40~0x8c3c, ldci lpf map size:1024 */
    volatile U_ISP_DRC_PPDTC_SUM_RSTT   ISP_DRC_PPDTC_SUM_RSTT        ; /* 0x8c40 */
    volatile U_ISP_DEHAZE_MINSTAT   ISP_DEHAZE_MINSTAT[512]           ; /* 0x8c44~0x9440, dehaze min stat size: 512 */
    volatile U_ISP_DEHAZE_MAXSTAT   ISP_DEHAZE_MAXSTAT[1024]          ; /* 0x9444~0xa440, dehaze max stat size: 1024 */
...
typedef struct {
    ...
    volatile U_ISP_AWB_AVG_B_RSTT   ISP_AWB_AVG_B_RSTT                ; /* 0x1824 */
    volatile U_ISP_AWB_CNT_ALL_RSTT   ISP_AWB_CNT_ALL_RSTT            ; /* 0x1828 */
    volatile U_ISP_AWB_STAT         ISP_AWB_STAT[2048]                ; /* 0x182c~0x3828, awb stat size: 2048 */
    volatile U_ISP_AF_STAT          ISP_AF_STAT[1020]                 ; /* 0x382c~0x4818, af stat size: 1020 */
...
typedef struct {
    ...
    volatile unsigned int            reserved_4[4]                 ; /* 0x27f0~0x27fc, reserved 4 * 4 bytes */
    ...
    volatile U_ISP_FLICK_GMEAN       ISP_FLICK_GMEAN[512]          ; /* 0x7400~0x7bfc , flicker gmean lut size: 512 */
