...
#define ISP_VICAP_CH_REG_BASE(id) \
	(VICAP_CH_REG_BASE + VICAP_CH_REG_SIZE_ALIGN * (id))
...
#define ISP_AE_HIST_ADDR_OFFSET \
	(ISP_OFFSETOF(S_ISP_ONLINE_STT_REGS_TYPE, ISP_AE_HIST))
#define ISP_AE_AVER_R_GR_ADDR_OFFSET \
	(ISP_OFFSETOF(S_ISP_ONLINE_STT_REGS_TYPE, ISP_AE_AVER_R_GR))
#define ISP_AE_AVER_GB_B_ADDR_OFFSET \
	(ISP_OFFSETOF(S_ISP_ONLINE_STT_REGS_TYPE, ISP_AE_AVER_GB_B))
#define ISP_AF_STAT_ADDR_OFFSET \
	(ISP_OFFSETOF(S_ISP_ONLINE_STT_REGS_TYPE, ISP_AF_STAT))
#define ISP_AWB_STAT_ADDR_OFFSET \
	(ISP_OFFSETOF(S_ISP_ONLINE_STT_REGS_TYPE, ISP_AWB_STAT))
#define ISP_LA_AVER_ADDR_OFFSET \
	(ISP_OFFSETOF(S_ISP_ONLINE_STT_REGS_TYPE, ISP_LA_AVER))
#define ISP_DEHAZE_MIN_ADDR_OFFSET \
	(ISP_OFFSETOF(S_ISP_ONLINE_STT_REGS_TYPE, ISP_DEHAZE_MINSTAT))
#define ISP_DEHAZE_MAX_ADDR_OFFSET \
	(ISP_OFFSETOF(S_ISP_ONLINE_STT_REGS_TYPE, ISP_DEHAZE_MAXSTAT))
#define ISP_LDCI_LPF_MAP_ADDR_OFFSET \
	(ISP_OFFSETOF(S_ISP_ONLINE_STT_REGS_TYPE, ISP_LDCI_LPF_MAP_RSTT))

#define ISP_DEHAZE_LUT_WSTT_OFFSET \
	(ISP_OFFSETOF(S_ISP_LUT_WSTT_TYPE, ISP_DEHAZE_LUT_WSTT))
#define ISP_GAMMA_LUT_WSTT_OFFSET \
	(ISP_OFFSETOF(S_ISP_LUT_WSTT_TYPE, ISP_GAMMA_LUT_WSTT))
#define ISP_SHARPEN_LUT_WSTT_OFFSET \
	(ISP_OFFSETOF(S_ISP_LUT_WSTT_TYPE, ISP_SHARPEN_LUT_WSTT))
#define ISP_LSC_LUT_WSTT_OFFSET \
	(ISP_OFFSETOF(S_ISP_LUT_WSTT_TYPE, ISP_MLSC_LUT_WSTT))
#define ISP_CA_LUT_WSTT_OFFSET \
	(ISP_OFFSETOF(S_ISP_LUT_WSTT_TYPE, ISP_CA_LUT_WSTT))
#define ISP_LDCI_LUT_WSTT_OFFSET \
	(ISP_OFFSETOF(S_ISP_LUT_WSTT_TYPE, ISP_LDCI_LUT_WSTT))
#define ISP_BNR_LUT_WSTT_OFFSET \
	(ISP_OFFSETOF(S_ISP_LUT_WSTT_TYPE, ISP_BNR_LUT_WSTT))
...
#define ISP_CHECK_REG_BASE(u32BaseAddr, u32Min, u32Max) \
	(((u32BaseAddr) >= (u32Min)) && ((u32BaseAddr) <= (u32Max)))
...
#define ISP_GET_FE_ID(u32BaseAddr) \
	((GET_ISP_REG_BASE(u32BaseAddr) - FE_REG_BASE) >> 17)
#define ISP_GET_BE_ID(u32BaseAddr) \
	((GET_ISP_REG_BASE(u32BaseAddr) - BE_REG_BASE) >> 18)
#define ISP_GET_VIPROC_ID(u32BaseAddr) \
	((GET_VIPROC_REG_BASE(u32BaseAddr) - VIPROC_REG_BASE) >> 18)

#define ISP_GET_HDR_ID(u32BaseAddr) \
	((GET_ISP_REG_BASE(u32BaseAddr) - HDR_REG_BASE) >> 18)

/* Addr = BaseAddr + Offset * (id) */
#define ISP_GET_VREG_ID(u32BaseAddr) \
	(((u32BaseAddr - ISP_VREG_BASE) >> 16) & 0xF) // 64KB
#define ISP_GET_AE_ID(u32BaseAddr) (((u32BaseAddr - AE_VREG_BASE) >> 13) & 0xF)
#define ISP_GET_AWB_ID(u32BaseAddr) \
	(((u32BaseAddr - AWB_VREG_BASE) >> 12) & 0xF)
...
#define IOWR_32DIRECT(BASE, DATA) \
	IO_WRITE32(__IO_CALC_ADDRESS_DYNAMIC(BASE), (DATA))
#define IOWR_16DIRECT(BASE, DATA) \
	IO_WRITE16(__IO_CALC_ADDRESS_DYNAMIC(BASE), (DATA))
#define IOWR_8DIRECT(BASE, DATA) \
	IO_WRITE8(__IO_CALC_ADDRESS_DYNAMIC(BASE), (DATA))
