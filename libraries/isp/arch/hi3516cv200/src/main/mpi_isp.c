...
HI_S32 HI_MPI_ISP_SetPubAttr(ISP_DEV IspDev, const ISP_PUB_ATTR_S *pstPubAttr)
{
    ...
    hi_isp_ae_width_write(pstPubAttr->stWndRect.u32Width-1);
    hi_isp_ae_height_write(pstPubAttr->stWndRect.u32Height-1);

    hi_isp_awb_hsize_write(pstPubAttr->stWndRect.u32Width-1);
    hi_isp_awb_vsize_write(pstPubAttr->stWndRect.u32Height-1);

    hi_isp_af_hsize_write(pstPubAttr->stWndRect.u32Width-1);
    hi_isp_af_vsize_write(pstPubAttr->stWndRect.u32Height-1);

    hi_isp_uvnr_vsize_write(pstPubAttr->stWndRect.u32Height-1);
    hi_isp_uvnr_hsize_write(pstPubAttr->stWndRect.u32Width-1);

    hi_isp_demosaic_width_write(pstPubAttr->stWndRect.u32Width-1);
    hi_isp_demosaic_height_write(pstPubAttr->stWndRect.u32Height-1);

    hi_isp_dp_width_write(pstPubAttr->stWndRect.u32Width-1);
    hi_isp_dp_height_write(pstPubAttr->stWndRect.u32Height-1);

    hi_isp_drc_width_write(pstPubAttr->stWndRect.u32Width-1);
    hi_isp_drc_height_write(pstPubAttr->stWndRect.u32Height-1);

    hi_isp_fpn_width_write(pstPubAttr->stWndRect.u32Width-1);
    hi_isp_fpn_height_write(pstPubAttr->stWndRect.u32Height-1);

    hi_isp_ge_width_write(pstPubAttr->stWndRect.u32Width-1);
    hi_isp_ge_height_write(pstPubAttr->stWndRect.u32Height-1);

    hi_isp_sharpen_width_write(pstPubAttr->stWndRect.u32Width-1);
    hi_isp_sharpen_height_write(pstPubAttr->stWndRect.u32Height-1);

    hi_isp_dehaze_width_write(pstPubAttr->stWndRect.u32Width-1);
    hi_isp_dehaze_height_write(pstPubAttr->stWndRect.u32Height-1);

    hi_isp_2dnr_width_write(pstPubAttr->stWndRect.u32Width-1);
    hi_isp_2dnr_height_write(pstPubAttr->stWndRect.u32Height-1);

    hi_isp_rgbir_width_write(pstPubAttr->stWndRect.u32Width-1);
    hi_isp_rgbir_height_write(pstPubAttr->stWndRect.u32Height-1);
